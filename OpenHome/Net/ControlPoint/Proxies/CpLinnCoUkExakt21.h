#ifndef HEADER_LINNCOUKEXAKT21
#define HEADER_LINNCOUKEXAKT21
...
class PropertyUint;
class CpProxy;
class ICpProxyLinnCoUkExakt21 : public ICpProxy
{
public:
    virtual ~ICpProxyLinnCoUkExakt21() {}
 ...
 * @ingroup Proxies
 */
class CpProxyLinnCoUkExakt21 : public ICpProxyLinnCoUkExakt21
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyLinnCoUkExakt21(CpDevice& aDevice);
    /**
     * Destructor.
