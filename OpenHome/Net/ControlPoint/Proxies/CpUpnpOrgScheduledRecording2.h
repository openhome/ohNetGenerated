#ifndef HEADER_UPNPORGSCHEDULEDRECORDING2
#define HEADER_UPNPORGSCHEDULEDRECORDING2
...
class PropertyUint;
class CpProxy;
class ICpProxyUpnpOrgScheduledRecording2 : public ICpProxy
{
public:
    virtual ~ICpProxyUpnpOrgScheduledRecording2() {}
 ...
 * @ingroup Proxies
 */
class CpProxyUpnpOrgScheduledRecording2 : public ICpProxyUpnpOrgScheduledRecording2
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyUpnpOrgScheduledRecording2(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_UPNPORGSCHEDULEDRECORDING2
