...
void CpProxyLinnCoUkCloud1::SyncSetAssociated(const Brx& aTokenEncrypted, TBool aAssociated)
{
...
void CpProxyLinnCoUkCloud1::BeginSetAssociated(const Brx& aTokenEncrypted, TBool aAssociated, FunctorAsync& aFunctor)
{
