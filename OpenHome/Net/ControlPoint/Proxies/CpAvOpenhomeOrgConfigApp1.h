#ifndef HEADER_AVOPENHOMEORGCONFIGAPP1
#define HEADER_AVOPENHOMEORGCONFIGAPP1
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgConfigApp1 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgConfigApp1() {}
    virtual void SyncGetKeys(Brh& aKeys) = 0;
    virtual void BeginGetKeys(FunctorAsync& aFunctor) = 0;
    virtual void EndGetKeys(IAsync& aAsync, Brh& aKeys) = 0;
    virtual void SyncSetValue(const Brx& aKey, const Brx& aValue) = 0;
    virtual void BeginSetValue(const Brx& aKey, const Brx& aValue, FunctorAsync& aFunctor) = 0;
    virtual void EndSetValue(IAsync& aAsync) = 0;
    virtual void SyncGetValue(const Brx& aKey, Brh& aValue) = 0;
    virtual void BeginGetValue(const Brx& aKey, FunctorAsync& aFunctor) = 0;
    virtual void EndGetValue(IAsync& aAsync, Brh& aValue) = 0;
    ...
    virtual void PropertyKeys(Brhz& aKeys) const = 0;
};
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgConfigApp1 : public ICpProxyAvOpenhomeOrgConfigApp1
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgConfigApp1(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGCONFIGAPP1
