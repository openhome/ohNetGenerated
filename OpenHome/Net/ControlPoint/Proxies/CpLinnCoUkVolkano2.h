#ifndef HEADER_LINNCOUKVOLKANO2
#define HEADER_LINNCOUKVOLKANO2
...
class PropertyUint;
class CpProxy;
class ICpProxyLinnCoUkVolkano2 : public ICpProxy
{
public:
    virtual ~ICpProxyLinnCoUkVolkano2() {}
 ...
 * @ingroup Proxies
 */
class CpProxyLinnCoUkVolkano2 : public ICpProxyLinnCoUkVolkano2
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyLinnCoUkVolkano2(CpDevice& aDevice);
    /**
     * Destructor.
