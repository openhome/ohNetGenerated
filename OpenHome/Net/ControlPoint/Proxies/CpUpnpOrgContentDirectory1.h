...
class PropertyUint;
class CpProxy;
class ICpProxyUpnpOrgContentDirectory1 : public ICpProxy
{
public:
    virtual ~ICpProxyUpnpOrgContentDirectory1() {}
 ...
 * @ingroup Proxies
 */
class CpProxyUpnpOrgContentDirectory1 : public ICpProxyUpnpOrgContentDirectory1
{
public:
    /**
     * Constructor.
