#ifndef HEADER_AVOPENHOMEORGVOLUME3
#define HEADER_AVOPENHOMEORGVOLUME3
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgVolume3 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgVolume3() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgVolume3 : public ICpProxyAvOpenhomeOrgVolume3
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgVolume3(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGVOLUME3
