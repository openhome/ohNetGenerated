#ifndef HEADER_AVOPENHOMEORGEXAKT3
#define HEADER_AVOPENHOMEORGEXAKT3
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgExakt3 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgExakt3() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgExakt3 : public ICpProxyAvOpenhomeOrgExakt3
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgExakt3(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGEXAKT3
