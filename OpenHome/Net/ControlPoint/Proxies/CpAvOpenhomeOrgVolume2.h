#ifndef HEADER_AVOPENHOMEORGVOLUME2
#define HEADER_AVOPENHOMEORGVOLUME2
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgVolume2 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgVolume2() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgVolume2 : public ICpProxyAvOpenhomeOrgVolume2
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgVolume2(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGVOLUME2
