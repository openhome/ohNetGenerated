#ifndef HEADER_AVOPENHOMEORGRADIO2
#define HEADER_AVOPENHOMEORGRADIO2
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgRadio2 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgRadio2() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgRadio2 : public ICpProxyAvOpenhomeOrgRadio2
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgRadio2(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGRADIO2
