#ifndef HEADER_OPENHOMEORGOAUTH1
#define HEADER_OPENHOMEORGOAUTH1
...
class PropertyUint;
class CpProxy;
class ICpProxyOpenhomeOrgOAuth1 : public ICpProxy
{
public:
    virtual ~ICpProxyOpenhomeOrgOAuth1() {}
 ...
 * @ingroup Proxies
 */
class CpProxyOpenhomeOrgOAuth1 : public ICpProxyOpenhomeOrgOAuth1
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyOpenhomeOrgOAuth1(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_OPENHOMEORGOAUTH1
