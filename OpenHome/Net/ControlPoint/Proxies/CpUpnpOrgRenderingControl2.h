...
class PropertyUint;
class CpProxy;
class ICpProxyUpnpOrgRenderingControl2 : public ICpProxy
{
public:
    virtual ~ICpProxyUpnpOrgRenderingControl2() {}
    ...
    virtual void SyncSetStateVariables(TUint aInstanceID, const Brx& aRenderingControlUDN, const Brx& aServiceType, const Brx& aServiceId, const Brx& aStateVariableValuePairs, Brh& aStateVariableList) = 0;
    virtual void BeginSetStateVariables(TUint aInstanceID, const Brx& aRenderingControlUDN, const Brx& aServiceType, const Brx& aServiceId, const Brx& aStateVariableValuePairs, FunctorAsync& aFunctor) = 0;
 ...
 * @ingroup Proxies
 */
class CpProxyUpnpOrgRenderingControl2 : public ICpProxyUpnpOrgRenderingControl2
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyUpnpOrgRenderingControl2(CpDevice& aDevice);
    /**
     * Destructor.
