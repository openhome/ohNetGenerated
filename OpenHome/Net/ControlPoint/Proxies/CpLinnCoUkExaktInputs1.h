#ifndef HEADER_LINNCOUKEXAKTINPUTS1
#define HEADER_LINNCOUKEXAKTINPUTS1
...
class PropertyUint;
class CpProxy;
class ICpProxyLinnCoUkExaktInputs1 : public ICpProxy
{
public:
    virtual ~ICpProxyLinnCoUkExaktInputs1() {}
    virtual void SyncGetAssociation(TUint aInputIndex, Brh& aDeviceId) = 0;
    virtual void BeginGetAssociation(TUint aInputIndex, FunctorAsync& aFunctor) = 0;
    virtual void EndGetAssociation(IAsync& aAsync, Brh& aDeviceId) = 0;
    virtual void SyncSetAssociation(TUint aInputIndex, const Brx& aDeviceId) = 0;
    virtual void BeginSetAssociation(TUint aInputIndex, const Brx& aDeviceId, FunctorAsync& aFunctor) = 0;
    virtual void EndSetAssociation(IAsync& aAsync) = 0;
    virtual void SyncClearAssociation(TUint aInputIndex) = 0;
    virtual void BeginClearAssociation(TUint aInputIndex, FunctorAsync& aFunctor) = 0;
    virtual void EndClearAssociation(IAsync& aAsync) = 0;
    virtual void SyncInputCount(TUint& aInputCount) = 0;
    virtual void BeginInputCount(FunctorAsync& aFunctor) = 0;
    virtual void EndInputCount(IAsync& aAsync, TUint& aInputCount) = 0;
    virtual void SetPropertyAssociationsChanged(Functor& aAssociationsChanged) = 0;
    virtual void PropertyAssociations(Brhz& aAssociations) const = 0;
};
 ...
 * @ingroup Proxies
 */
class CpProxyLinnCoUkExaktInputs1 : public ICpProxyLinnCoUkExaktInputs1
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyLinnCoUkExaktInputs1(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_LINNCOUKEXAKTINPUTS1
