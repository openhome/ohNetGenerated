#ifndef HEADER_AVOPENHOMEORGEXAKT5
#define HEADER_AVOPENHOMEORGEXAKT5
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgExakt5 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgExakt5() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgExakt5 : public ICpProxyAvOpenhomeOrgExakt5
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgExakt5(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGEXAKT5
