#ifndef HEADER_UPNPORGCONTENTDIRECTORY2
#define HEADER_UPNPORGCONTENTDIRECTORY2
...
class PropertyUint;
class CpProxy;
class ICpProxyUpnpOrgContentDirectory2 : public ICpProxy
{
public:
    virtual ~ICpProxyUpnpOrgContentDirectory2() {}
 ...
 * @ingroup Proxies
 */
class CpProxyUpnpOrgContentDirectory2 : public ICpProxyUpnpOrgContentDirectory2
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyUpnpOrgContentDirectory2(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_UPNPORGCONTENTDIRECTORY2
