#ifndef HEADER_AVOPENHOMEORGPRODUCT2
#define HEADER_AVOPENHOMEORGPRODUCT2
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgProduct2 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgProduct2() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgProduct2 : public ICpProxyAvOpenhomeOrgProduct2
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgProduct2(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGPRODUCT2
