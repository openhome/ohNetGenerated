#ifndef HEADER_AVOPENHOMEORGPRODUCT4
#define HEADER_AVOPENHOMEORGPRODUCT4
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgProduct4 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgProduct4() {}
    ...
    virtual void SyncProduct(Brh& aRoom, Brh& aName, Brh& aInfo, Brh& aUrl, Brh& aImageUri, Brh& aImageHiresUri) = 0;
    virtual void BeginProduct(FunctorAsync& aFunctor) = 0;
    virtual void EndProduct(IAsync& aAsync, Brh& aRoom, Brh& aName, Brh& aInfo, Brh& aUrl, Brh& aImageUri, Brh& aImageHiresUri) = 0;
    ...
    virtual void SyncStandbyTransitioning(TBool& aValue) = 0;
    virtual void BeginStandbyTransitioning(FunctorAsync& aFunctor) = 0;
    virtual void EndStandbyTransitioning(IAsync& aAsync, TBool& aValue) = 0;
    ...
    virtual void SyncSetSourceBySystemName(const Brx& aValue) = 0;
    virtual void BeginSetSourceBySystemName(const Brx& aValue, FunctorAsync& aFunctor) = 0;
    ...
    virtual void SyncGetImageUri(const Brx& aResolution, Brh& aImageUri) = 0;
    virtual void BeginGetImageUri(const Brx& aResolution, FunctorAsync& aFunctor) = 0;
    virtual void EndGetImageUri(IAsync& aAsync, Brh& aImageUri) = 0;
    ...
    virtual void PropertyProductImageHiresUri(Brhz& aProductImageHiresUri) const = 0;
    ...
    virtual void PropertyStandbyTransitioning(TBool& aStandbyTransitioning) const = 0;
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgProduct4 : public ICpProxyAvOpenhomeOrgProduct4
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgProduct4(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGPRODUCT4
