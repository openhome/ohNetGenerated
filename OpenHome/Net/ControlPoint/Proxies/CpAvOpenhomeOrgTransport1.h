...
public:
    ...
    virtual void SyncModeInfo(TBool& aNextAvailable, TBool& aPrevAvailable) = 0;
    virtual void BeginModeInfo(FunctorAsync& aFunctor) = 0;
    virtual void EndModeInfo(IAsync& aAsync, TBool& aNextAvailable, TBool& aPrevAvailable) = 0;
