#ifndef HEADER_AVOPENHOMEORGVOLUME4
#define HEADER_AVOPENHOMEORGVOLUME4
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgVolume4 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgVolume4() {}
    ...
    virtual void SyncSetVolumeNoUnmute(TUint aValue) = 0;
    virtual void BeginSetVolumeNoUnmute(TUint aValue, FunctorAsync& aFunctor) = 0;
    ...
    virtual void SyncUnityGain(TBool& aValue) = 0;
    virtual void BeginUnityGain(FunctorAsync& aFunctor) = 0;
    virtual void EndUnityGain(IAsync& aAsync, TBool& aValue) = 0;
    virtual void SyncVolumeOffset(const Brx& aChannel, TInt& aVolumeOffsetBinaryMilliDb) = 0;
    virtual void BeginVolumeOffset(const Brx& aChannel, FunctorAsync& aFunctor) = 0;
    virtual void EndVolumeOffset(IAsync& aAsync, TInt& aVolumeOffsetBinaryMilliDb) = 0;
    ...
    virtual void PropertyUnityGain(TBool& aUnityGain) const = 0;
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgVolume4 : public ICpProxyAvOpenhomeOrgVolume4
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgVolume4(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGVOLUME4
