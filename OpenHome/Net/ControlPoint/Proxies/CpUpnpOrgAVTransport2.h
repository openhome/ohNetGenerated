...
class PropertyUint;
class CpProxy;
class ICpProxyUpnpOrgAVTransport2 : public ICpProxy
{
public:
    virtual ~ICpProxyUpnpOrgAVTransport2() {}
 ...
 * @ingroup Proxies
 */
class CpProxyUpnpOrgAVTransport2 : public ICpProxyUpnpOrgAVTransport2
{
public:
    /**
     * Constructor.
