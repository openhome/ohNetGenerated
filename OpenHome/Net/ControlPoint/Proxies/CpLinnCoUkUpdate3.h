#ifndef HEADER_LINNCOUKUPDATE3
#define HEADER_LINNCOUKUPDATE3
...
class PropertyUint;
class CpProxy;
class ICpProxyLinnCoUkUpdate3 : public ICpProxy
{
public:
    virtual ~ICpProxyLinnCoUkUpdate3() {}
 ...
 * @ingroup Proxies
 */
class CpProxyLinnCoUkUpdate3 : public ICpProxyLinnCoUkUpdate3
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyLinnCoUkUpdate3(CpDevice& aDevice);
    /**
     * Destructor.
