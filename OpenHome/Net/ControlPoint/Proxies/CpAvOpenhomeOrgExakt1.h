#ifndef HEADER_AVOPENHOMEORGEXAKT1
#define HEADER_AVOPENHOMEORGEXAKT1
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgExakt1 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgExakt1() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgExakt1 : public ICpProxyAvOpenhomeOrgExakt1
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgExakt1(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGEXAKT1
