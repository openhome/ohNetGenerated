#ifndef HEADER_LINNCOUKUPDATE4
#define HEADER_LINNCOUKUPDATE4
...
class PropertyUint;
class CpProxy;
class ICpProxyLinnCoUkUpdate4 : public ICpProxy
{
public:
    virtual ~ICpProxyLinnCoUkUpdate4() {}
    ...
    virtual void SyncRecoverKeepStore() = 0;
    virtual void BeginRecoverKeepStore(FunctorAsync& aFunctor) = 0;
    virtual void EndRecoverKeepStore(IAsync& aAsync) = 0;
    virtual void SyncRecoverKeepStore2(TUint& aId) = 0;
    virtual void BeginRecoverKeepStore2(FunctorAsync& aFunctor) = 0;
    virtual void EndRecoverKeepStore2(IAsync& aAsync, TUint& aId) = 0;
    virtual void SyncCheckNow() = 0;
    virtual void BeginCheckNow(FunctorAsync& aFunctor) = 0;
    virtual void EndCheckNow(IAsync& aAsync) = 0;
    virtual void SyncGetRecoverSupported(TBool& aRecoverSupported) = 0;
    virtual void BeginGetRecoverSupported(FunctorAsync& aFunctor) = 0;
    virtual void EndGetRecoverSupported(IAsync& aAsync, TBool& aRecoverSupported) = 0;
    ...
    virtual void PropertyRecoverSupported(TBool& aRecoverSupported) const = 0;
};

/**
 * Proxy for linn.co.uk:Update:4
 * @ingroup Proxies
 */
class CpProxyLinnCoUkUpdate4 : public ICpProxyLinnCoUkUpdate4
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyLinnCoUkUpdate4(CpDevice& aDevice);
    /**
     * Destructor.
