#ifndef HEADER_AVOPENHOMEORGPRODUCT3
#define HEADER_AVOPENHOMEORGPRODUCT3
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgProduct3 : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgProduct3() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgProduct3 : public ICpProxyAvOpenhomeOrgProduct3
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgProduct3(CpDevice& aDevice);
    /**
     * Destructor.
...
#endif // HEADER_AVOPENHOMEORGPRODUCT3
