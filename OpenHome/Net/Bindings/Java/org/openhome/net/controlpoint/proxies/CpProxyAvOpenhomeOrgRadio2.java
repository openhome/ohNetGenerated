...
import org.openhome.net.controlpoint.proxies.CpProxyAvOpenhomeOrgRadio2.*;
import org.openhome.net.core.*;

    
interface ICpProxyAvOpenhomeOrgRadio2 extends ICpProxy
{
    ...
    public void beginRefreshPresets(ICpProxyListener aCallback);
    public void endRefreshPresets(long aAsyncHandle);
...
class SyncPlayAvOpenhomeOrgRadio2 extends SyncProxyAction
{
...
class SyncPauseAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
...
class SyncStopAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
...
class SyncSeekSecondAbsoluteAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
...
class SyncSeekSecondRelativeAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
...
class SyncChannelAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
    private String iUri;
...
class SyncSetChannelAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
...
class SyncTransportStateAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
...
class SyncIdAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
    private long iValue;
...
class SyncSetIdAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
...
class SyncReadAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
    private String iMetadata;
...
class SyncReadListAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
...
class SyncIdArrayAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
    private long iToken;
    private byte[] iArray;
...
class SyncIdArrayChangedAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
...
class SyncChannelsMaxAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
    private long iValue;
...
class SyncRefreshPresetsAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
...
class SyncProtocolInfoAvOpenhomeOrgRadio2 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgRadio2 iService;
    private String iValue;
 ...
 */
public class CpProxyAvOpenhomeOrgRadio2 extends CpProxy implements ICpProxyAvOpenhomeOrgRadio2
{
    ...
    private Action iActionRefreshPresets;
    ...
    public CpProxyAvOpenhomeOrgRadio2(CpDevice aDevice)
    {
        super("av-openhome-org", "Radio", 2, aDevice);
        Parameter param;
    ...
    public void syncRefreshPresets()
    {
        ...
        beginRefreshPresets(sync.getListener());
        sync.waitToComplete();
        sync.reportError();
    }
     ...
     * Returns immediately and will run the client-specified callback when the
     * action later completes.  Any output arguments can then be retrieved by
     * calling {@link #endRefreshPresets}.
     * 
     * @param aCallback listener to call back when action completes.
     *                  This is guaranteed to be run but may indicate an error.
     */
    public void beginRefreshPresets(ICpProxyListener aCallback)
    {
        Invocation invocation = iService.getInvocation(iActionRefreshPresets, aCallback);
        iService.invokeAction(invocation);
    }
     ...
     * Retrieve the output arguments from an asynchronously invoked action.
     * This may only be called from the callback set in the
     * {@link #beginRefreshPresets} method.
     *
     * @param aAsyncHandle  argument passed to the delegate set in the
     *          {@link #beginRefreshPresets} method.
     */
     ...
     * CpProxyAvOpenhomeOrgRadio2 instance will not overlap.
     *
