...
import org.openhome.net.controlpoint.proxies.CpProxyAvOpenhomeOrgProduct4.*;
import org.openhome.net.core.*;

    
interface ICpProxyAvOpenhomeOrgProduct4 extends ICpProxy
{
    ...
    public boolean syncStandbyTransitioning();
    public void beginStandbyTransitioning(ICpProxyListener aCallback);
    public boolean endStandbyTransitioning(long aAsyncHandle);
    ...
    public void beginSetSourceBySystemName(String aValue, ICpProxyListener aCallback);
    public void endSetSourceBySystemName(long aAsyncHandle);
    ...
    public String syncGetImageUri(String aResolution);
    public void beginGetImageUri(String aResolution, ICpProxyListener aCallback);
    public String endGetImageUri(long aAsyncHandle);
    ...
    public void setPropertyProductImageHiresUriChanged(IPropertyChangeListener aProductImageHiresUriChanged);
    public String getPropertyProductImageHiresUri();
    public void setPropertyStandbyChanged(IPropertyChangeListener aStandbyChanged);
    public boolean getPropertyStandby();
    public void setPropertyStandbyTransitioningChanged(IPropertyChangeListener aStandbyTransitioningChanged);
    public boolean getPropertyStandbyTransitioning();
...
class SyncManufacturerAvOpenhomeOrgProduct4 extends SyncProxyAction
{
...
class SyncModelAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
    private String iName;
    private String iInfo;
...
class SyncProductAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
    ...
    public String getImageHiresUri()
    {
    ...
    protected void completeRequest(long aAsyncHandle)
    {
        ...
        iUrl = result.getUrl();
        iImageUri = result.getImageUri();
        iImageHiresUri = result.getImageHiresUri();
    }
}

class SyncStandbyAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
...
class SyncStandbyTransitioningAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
    private boolean iValue;
    ...
    protected void completeRequest(long aAsyncHandle)
    {
        boolean result = iService.endStandbyTransitioning(aAsyncHandle);
        
        iValue = result;
    }
}

class SyncSetStandbyAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
...
class SyncSourceCountAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
    private long iValue;
...
class SyncSourceXmlAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
...
class SyncSourceIndexAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
    private long iValue;
...
class SyncSetSourceIndexAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
...
class SyncSetSourceIndexByNameAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
...
class SyncSetSourceBySystemNameAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
...
class SyncSourceAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
...
class SyncAttributesAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
    private String iValue;
...
class SyncSourceXmlChangeCountAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
    private long iValue;
...
class SyncGetImageUriAvOpenhomeOrgProduct4 extends SyncProxyAction
{
    private CpProxyAvOpenhomeOrgProduct4 iService;
    private String iImageUri;
    ...
    protected void completeRequest(long aAsyncHandle)
    {
        String result = iService.endGetImageUri(aAsyncHandle);
 ...
 */
public class CpProxyAvOpenhomeOrgProduct4 extends CpProxy implements ICpProxyAvOpenhomeOrgProduct4
{
    ...
    private Action iActionStandbyTransitioning;
    ...
    private IPropertyChangeListener iProductImageHiresUriChanged;
    private IPropertyChangeListener iStandbyChanged;
    private IPropertyChangeListener iStandbyTransitioningChanged;
    ...
    public CpProxyAvOpenhomeOrgProduct4(CpDevice aDevice)
    {
        super("av-openhome-org", "Product", 4, aDevice);
        Parameter param;
        ...
        iProductImageHiresUriChanged = new PropertyChangeListener();
        iProductImageHiresUri = new PropertyString("ProductImageHiresUri",
            new PropertyChangeListener() {
                public void notifyChange() {
                    productImageHiresUriPropertyChanged();
                }
            }
        );
        ...
        iStandbyTransitioningChanged = new PropertyChangeListener();
        iStandbyTransitioning = new PropertyBool("StandbyTransitioning",
            new PropertyChangeListener() {
                public void notifyChange() {
                    standbyTransitioningPropertyChanged();
                }
            }
        );
    ...
    public Product endProduct(long aAsyncHandle)
    {
        ...
        String url = Invocation.getOutputString(aAsyncHandle, index++);
        String imageUri = Invocation.getOutputString(aAsyncHandle, index++);
        String imageHiresUri = Invocation.getOutputString(aAsyncHandle, index++);
        return new Product(
            room,
            name,
            info,
    ...
    public boolean syncStandbyTransitioning()
    {
        ...
        beginStandbyTransitioning(sync.getListener());
        sync.waitToComplete();
        sync.reportError();
     ...
     * Returns immediately and will run the client-specified callback when the
     * action later completes.  Any output arguments can then be retrieved by
     * calling {@link #endStandbyTransitioning}.
     * 
     * @param aCallback listener to call back when action completes.
     *                  This is guaranteed to be run but may indicate an error.
     */
    public void beginStandbyTransitioning(ICpProxyListener aCallback)
    {
        Invocation invocation = iService.getInvocation(iActionStandbyTransitioning, aCallback);
        int outIndex = 0;
        invocation.addOutput(new ArgumentBool((ParameterBool)iActionStandbyTransitioning.getOutputParameter(outIndex++)));
        iService.invokeAction(invocation);
    }
     ...
     * Retrieve the output arguments from an asynchronously invoked action.
     * This may only be called from the callback set in the
     * {@link #beginStandbyTransitioning} method.
     *
     * @param aAsyncHandle  argument passed to the delegate set in the
     *          {@link #beginStandbyTransitioning} method.
     * @return the result of the previously invoked action.
    ...
    public void syncSetSourceBySystemName(String aValue)
    {
        ...
        beginSetSourceBySystemName(aValue, sync.getListener());
        sync.waitToComplete();
        sync.reportError();
    }
     ...
     * Returns immediately and will run the client-specified callback when the
     * action later completes.  Any output arguments can then be retrieved by
     * calling {@link #endSetSourceBySystemName}.
     * 
     * @param aValue
     * @param aCallback listener to call back when action completes.
     *                  This is guaranteed to be run but may indicate an error.
    ...
    public void beginSetSourceBySystemName(String aValue, ICpProxyListener aCallback)
    {
        Invocation invocation = iService.getInvocation(iActionSetSourceBySystemName, aCallback);
        int inIndex = 0;
        invocation.addInput(new ArgumentString((ParameterString)iActionSetSourceBySystemName.getInputParameter(inIndex++), aValue));
        iService.invokeAction(invocation);
    }
     ...
     * Retrieve the output arguments from an asynchronously invoked action.
     * This may only be called from the callback set in the
     * {@link #beginSetSourceBySystemName} method.
     *
     * @param aAsyncHandle  argument passed to the delegate set in the
     *          {@link #beginSetSourceBySystemName} method.
     */
    ...
    public String syncGetImageUri(String aResolution)
    {
        ...
        beginGetImageUri(aResolution, sync.getListener());
        sync.waitToComplete();
        sync.reportError();

        return sync.getImageUri();
    }
    ...
    public void beginGetImageUri(String aResolution, ICpProxyListener aCallback)
    {
        Invocation invocation = iService.getInvocation(iActionGetImageUri, aCallback);
        int inIndex = 0;
        invocation.addInput(new ArgumentString((ParameterString)iActionGetImageUri.getInputParameter(inIndex++), aResolution));
        int outIndex = 0;
        invocation.addOutput(new ArgumentString((ParameterString)iActionGetImageUri.getOutputParameter(outIndex++)));
        iService.invokeAction(invocation);
    }
     ...
     * CpProxyAvOpenhomeOrgProduct4 instance will not overlap.
     *
     ...
     * CpProxyAvOpenhomeOrgProduct4 instance will not overlap.
     *
     * @param aProductImageHiresUriChanged   the listener to call back when the state
     *          variable changes.
     */
    public void setPropertyProductImageHiresUriChanged(IPropertyChangeListener aProductImageHiresUriChanged)
    {
     ...
     * CpProxyAvOpenhomeOrgProduct4 instance will not overlap.
     *
     * @param aStandbyTransitioningChanged   the listener to call back when the state
     *          variable changes.
     */
    public void setPropertyStandbyTransitioningChanged(IPropertyChangeListener aStandbyTransitioningChanged)
    {
     ...
     * more recently than any call to {@link #unsubscribe}.
     *
     * @return  value of the ProductImageHiresUri property.
     */
    public String getPropertyProductImageHiresUri()
    {
        propertyReadLock();
        String val = iProductImageHiresUri.getValue();
        propertyReadUnlock();
        return val;
    }
     ...
     * more recently than any call to {@link #unsubscribe}.
     *
     * @return  value of the StandbyTransitioning property.
     */
    public boolean getPropertyStandbyTransitioning()
    {
        propertyReadLock();
        boolean val = iStandbyTransitioning.getValue();
        propertyReadUnlock();
        return val;
    }
    ...
    public void dispose()
    {
        synchronized (this)
        {
            ...
            iActionStandbyTransitioning.destroy();
            ...
            iProductImageHiresUri.destroy();
            iStandby.destroy();
            iStandbyTransitioning.destroy();
