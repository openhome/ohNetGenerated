...
interface IDvProviderLinnCoUkVolkano2
{
 ...
 */
public class DvProviderLinnCoUkVolkano2 extends DvProvider implements IDvProviderLinnCoUkVolkano2
{
    ...
    {
        super(aDevice, "linn.co.uk", "Volkano", 2);
    }
    ...
    {
        Action action = new Action("IpAddress");        List<String> allowedValues = new LinkedList<String>();
