...
interface IDvProviderAvOpenhomeOrgRadio2
{
 ...
 */
public class DvProviderAvOpenhomeOrgRadio2 extends DvProvider implements IDvProviderAvOpenhomeOrgRadio2
{
    ...
    private IDvInvocationListener iDelegateRefreshPresets;
    ...
    {
        super(aDevice, "av.openhome.org", "Radio", 2);
    }
     ...
     *
     * <p>The action's availability will be published in the device's service.xml.
     * RefreshPresets must be overridden if this is called.
     */      
    protected void enableActionRefreshPresets()
    {
        Action action = new Action("RefreshPresets");
        iDelegateRefreshPresets = new DoRefreshPresets();
        enableAction(action, iDelegateRefreshPresets);
    }
     ...
     *
     * <p>Must be implemented iff {@link #enableActionRefreshPresets} was called.</remarks>
     *
     * @param aInvocation   Interface allowing querying of aspects of this particular action invocation.</param>
     */
    protected void refreshPresets(IDvInvocation aInvocation)
    {
        throw (new ActionDisabledError());
    }
    ...
    private class DoRefreshPresets implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            {
                invocation.reportActionError(ae, "RefreshPresets");
                return;
            }
            catch (PropertyUpdateError pue)
            {
