...
interface IDvProviderLinnCoUkCloud2
{
     ...
     *
     */
    public boolean setPropertyAccountId(String aValue);
 ...
 */
public class DvProviderLinnCoUkCloud2 extends DvProvider implements IDvProviderLinnCoUkCloud2
{
    ...
    private IDvInvocationListener iDelegateGetAccountId;
    ...
    {
        super(aDevice, "linn.co.uk", "Cloud", 2);
    }
    ...
    public String getPropertyAccountId()
    {
        return iPropertyAccountId.getValue();
    }
    ...
    {
        Action action = new Action("GetAccountId");
        action.addOutputParameter(new ParameterRelated("AccountId", iPropertyAccountId));
        iDelegateGetAccountId = new DoGetAccountId();
        enableAction(action, iDelegateGetAccountId);
    }
     ...
     *
     * <p>Must be implemented iff {@link #enableActionGetAccountId} was called.</remarks>
     *
     * @param aInvocation   Interface allowing querying of aspects of this particular action invocation.</param>
     */
    protected String getAccountId(IDvInvocation aInvocation)
    {
        throw (new ActionDisabledError());
    }
    ...
    private class DoGetAccountId implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            try
            {
                invocation.readStart();
                invocation.readEnd();
                 accountId = getAccountId(invocation);
            }
            catch (ActionError ae)
            {
                invocation.reportActionError(ae, "GetAccountId");
                return;
            }
            catch (PropertyUpdateError pue)
            {
