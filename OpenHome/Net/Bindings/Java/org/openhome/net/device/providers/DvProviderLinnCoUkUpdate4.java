...
interface IDvProviderLinnCoUkUpdate4
{
 ...
 */
public class DvProviderLinnCoUkUpdate4 extends DvProvider implements IDvProviderLinnCoUkUpdate4
{
    ...
    private IDvInvocationListener iDelegateRecoverKeepStore;
    private IDvInvocationListener iDelegateRecoverKeepStore2;
    ...
    {
        super(aDevice, "linn.co.uk", "Update", 4);
    }
     ...
     *
     * <p>The action's availability will be published in the device's service.xml.
     * RecoverKeepStore must be overridden if this is called.
     */      
    protected void enableActionRecoverKeepStore()
    {
        Action action = new Action("RecoverKeepStore");
        iDelegateRecoverKeepStore = new DoRecoverKeepStore();
        enableAction(action, iDelegateRecoverKeepStore);
    }
     ...
     *
     * <p>The action's availability will be published in the device's service.xml.
     * RecoverKeepStore2 must be overridden if this is called.
     */      
    protected void enableActionRecoverKeepStore2()
    {
        Action action = new Action("RecoverKeepStore2");
        action.addOutputParameter(new ParameterUint("Id"));
        iDelegateRecoverKeepStore2 = new DoRecoverKeepStore2();
        enableAction(action, iDelegateRecoverKeepStore2);
    }
     ...
     *
     * <p>Must be implemented iff {@link #enableActionRecoverKeepStore} was called.</remarks>
     *
     * @param aInvocation   Interface allowing querying of aspects of this particular action invocation.</param>
     */
    protected void recoverKeepStore(IDvInvocation aInvocation)
    {
        throw (new ActionDisabledError());
    }
     ...
     *
     * <p>Must be implemented iff {@link #enableActionRecoverKeepStore2} was called.</remarks>
     *
     * @param aInvocation   Interface allowing querying of aspects of this particular action invocation.</param>
     */
    protected long recoverKeepStore2(IDvInvocation aInvocation)
    {
        throw (new ActionDisabledError());
    }
    ...
    private class DoRecoverKeepStore implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            {
                invocation.reportActionError(ae, "RecoverKeepStore");
                return;
            }
            catch (PropertyUpdateError pue)
            {
    ...
    private class DoRecoverKeepStore2 implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            try
            {
                invocation.readStart();
                invocation.readEnd();
                 id = recoverKeepStore2(invocation);
            }
            catch (ActionError ae)
            {
                invocation.reportActionError(ae, "RecoverKeepStore2");
                return;
            }
            catch (PropertyUpdateError pue)
            {
