...
interface IDvProviderAvOpenhomeOrgSender2
{
     ...
     *
     */
    public boolean setPropertyStatus2(String aValue);
     ...
     *
     */
    public boolean setPropertyEnabled(boolean aValue);
 ...
 */
public class DvProviderAvOpenhomeOrgSender2 extends DvProvider implements IDvProviderAvOpenhomeOrgSender2
{
    ...
    private IDvInvocationListener iDelegateStatus2;
    private IDvInvocationListener iDelegateEnabled;
    ...
    {
        super(aDevice, "av.openhome.org", "Sender", 2);
    }
    ...
    public String getPropertyStatus2()
    {
        return iPropertyStatus2.getValue();
    }
    ...
    public boolean getPropertyEnabled()
    {
        return iPropertyEnabled.getValue();
    }
    ...
    {
        Action action = new Action("Status2");
        action.addOutputParameter(new ParameterRelated("Value", iPropertyStatus2));
        iDelegateStatus2 = new DoStatus2();
        enableAction(action, iDelegateStatus2);
    }
    ...
    {
        Action action = new Action("Enabled");
        action.addOutputParameter(new ParameterRelated("Value", iPropertyEnabled));
        iDelegateEnabled = new DoEnabled();
        enableAction(action, iDelegateEnabled);
    }
     ...
     *
     * <p>Must be implemented iff {@link #enableActionStatus2} was called.</remarks>
     *
     * @param aInvocation   Interface allowing querying of aspects of this particular action invocation.</param>
     */
    protected String status2(IDvInvocation aInvocation)
    {
        throw (new ActionDisabledError());
    }
     ...
     *
     * <p>Must be implemented iff {@link #enableActionEnabled} was called.</remarks>
     *
     * @param aInvocation   Interface allowing querying of aspects of this particular action invocation.</param>
     */
    protected boolean enabled(IDvInvocation aInvocation)
    {
        throw (new ActionDisabledError());
    }
    ...
    private class DoStatus2 implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            try
            {
                invocation.readStart();
                invocation.readEnd();
                 value = status2(invocation);
            }
            catch (ActionError ae)
            {
                invocation.reportActionError(ae, "Status2");
                return;
            }
            catch (PropertyUpdateError pue)
            {
    ...
    private class DoEnabled implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            try
            {
                invocation.readStart();
                invocation.readEnd();
                 value = enabled(invocation);
            }
            catch (ActionError ae)
            {
                invocation.reportActionError(ae, "Enabled");
                return;
            }
            catch (PropertyUpdateError pue)
            {
