...
interface IDvProviderAvOpenhomeOrgProduct4
{
     ...
     *
     */
    public boolean setPropertyProductImageHiresUri(String aValue);
     ...
     *
     */
    public boolean setPropertyStandbyTransitioning(boolean aValue);
 ...
 */
public class DvProviderAvOpenhomeOrgProduct4 extends DvProvider implements IDvProviderAvOpenhomeOrgProduct4
{
    ...
    private IDvInvocationListener iDelegateStandbyTransitioning;
    ...
    private IDvInvocationListener iDelegateSetSourceBySystemName;
    ...
    private IDvInvocationListener iDelegateGetImageUri;
    ...
    {
        super(aDevice, "av.openhome.org", "Product", 4);
    }
    ...
    public String getPropertyProductRoom()
    {
        return iPropertyProductRoom.getValue();
    }
    ...
    public String getPropertyProductImageHiresUri()
    {
        return iPropertyProductImageHiresUri.getValue();
    }
    ...
    public boolean getPropertyStandby()
    {
        return iPropertyStandby.getValue();
    }
    ...
    public boolean getPropertyStandbyTransitioning()
    {
        return iPropertyStandbyTransitioning.getValue();
    }
    ...
    public long getPropertySourceIndex()
    {
        return iPropertySourceIndex.getValue();
    }
    ...
    public long getPropertySourceCount()
    {
        return iPropertySourceCount.getValue();
    }
    ...
    public String getPropertySourceXml()
    {
        return iPropertySourceXml.getValue();
    }
    ...
    protected void enableActionStandby()
    {
        ...
        iDelegateStandby = new DoStandby();
        enableAction(action, iDelegateStandby);
    }
    ...
    {
        Action action = new Action("StandbyTransitioning");
        action.addOutputParameter(new ParameterRelated("Value", iPropertyStandbyTransitioning));
        iDelegateStandbyTransitioning = new DoStandbyTransitioning();
        enableAction(action, iDelegateStandbyTransitioning);
    }
    ...
    protected void enableActionSetStandby()
    {
        ...
        iDelegateSetStandby = new DoSetStandby();
        enableAction(action, iDelegateSetStandby);
    }
    ...
    protected void enableActionSourceCount()
    {
        ...
        iDelegateSourceCount = new DoSourceCount();
        enableAction(action, iDelegateSourceCount);
    }
    ...
    protected void enableActionSourceXml()
    {
        ...
        iDelegateSourceXml = new DoSourceXml();
        enableAction(action, iDelegateSourceXml);
    }
    ...
    protected void enableActionSourceIndex()
    {
        ...
        iDelegateSourceIndex = new DoSourceIndex();
        enableAction(action, iDelegateSourceIndex);
    }
    ...
    protected void enableActionSetSourceIndex()
    {
        ...
        iDelegateSetSourceIndex = new DoSetSourceIndex();
        enableAction(action, iDelegateSetSourceIndex);
    }
    ...
    protected void enableActionSetSourceIndexByName()
    {
        ...
        iDelegateSetSourceIndexByName = new DoSetSourceIndexByName();
        enableAction(action, iDelegateSetSourceIndexByName);
    }
    ...
    {
        Action action = new Action("SetSourceBySystemName");        List<String> allowedValues = new LinkedList<String>();
        action.addInputParameter(new ParameterString("Value", allowedValues));
        iDelegateSetSourceBySystemName = new DoSetSourceBySystemName();
        enableAction(action, iDelegateSetSourceBySystemName);
    }
    ...
    protected void enableActionSource()
    {
        ...
        iDelegateSource = new DoSource();
        enableAction(action, iDelegateSource);
    }
    ...
    protected void enableActionSourceXmlChangeCount()
    {
        ...
        iDelegateSourceXmlChangeCount = new DoSourceXmlChangeCount();
        enableAction(action, iDelegateSourceXmlChangeCount);
    }
    ...
    {
        Action action = new Action("GetImageUri");        List<String> allowedValues = new LinkedList<String>();
        allowedValues.add("Low");
        allowedValues.add("High");
        action.addInputParameter(new ParameterString("Resolution", allowedValues));
        allowedValues.clear();
        action.addOutputParameter(new ParameterRelated("ImageUri", iPropertyProductImageUri));
        iDelegateGetImageUri = new DoGetImageUri();
        enableAction(action, iDelegateGetImageUri);
    }
     ...
     *
     * <p>Must be implemented iff {@link #enableActionStandbyTransitioning} was called.</remarks>
     *
     * @param aInvocation   Interface allowing querying of aspects of this particular action invocation.</param>
     */
    protected boolean standbyTransitioning(IDvInvocation aInvocation)
    {
        throw (new ActionDisabledError());
    }
     ...
     *
     * <p>Must be implemented iff {@link #enableActionSetSourceBySystemName} was called.</remarks>
     *
     * @param aInvocation   Interface allowing querying of aspects of this particular action invocation.</param>
     * @param aValue
     */
    protected void setSourceBySystemName(IDvInvocation aInvocation, String aValue)
    {
        throw (new ActionDisabledError());
    }
     ...
     *
     * <p>Must be implemented iff {@link #enableActionGetImageUri} was called.</remarks>
     *
     * @param aInvocation   Interface allowing querying of aspects of this particular action invocation.</param>
     * @param aResolution
     */
    protected String getImageUri(IDvInvocation aInvocation, String aResolution)
    {
        throw (new ActionDisabledError());
    }
    ...
    private class DoProduct implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            ...
            url = outArgs.getUrl();
            imageUri = outArgs.getImageUri();
            imageHiresUri = outArgs.getImageHiresUri();
            }
            catch (ActionError ae)
            {
    ...
    private class DoStandbyTransitioning implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            try
            {
                invocation.readStart();
                invocation.readEnd();
                 value = standbyTransitioning(invocation);
            }
            catch (ActionError ae)
            {
                invocation.reportActionError(ae, "StandbyTransitioning");
                return;
            }
            catch (PropertyUpdateError pue)
            {
    ...
    private class DoSetSourceBySystemName implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            {
                invocation.reportActionError(ae, "SetSourceBySystemName");
                return;
            }
            catch (PropertyUpdateError pue)
            {
    ...
    private class DoGetImageUri implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            try
            {
                ...
                invocation.readEnd();
                 imageUri = getImageUri(invocation, resolution);
            }
            catch (ActionError ae)
            {
                invocation.reportActionError(ae, "GetImageUri");
                return;
            }
            catch (PropertyUpdateError pue)
            {
