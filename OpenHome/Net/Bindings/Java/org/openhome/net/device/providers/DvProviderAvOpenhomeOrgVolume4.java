...
interface IDvProviderAvOpenhomeOrgVolume4
{
 ...
 */
public class DvProviderAvOpenhomeOrgVolume4 extends DvProvider implements IDvProviderAvOpenhomeOrgVolume4
{
    ...
    private IDvInvocationListener iDelegateSetVolumeNoUnmute;
    private IDvInvocationListener iDelegateVolumeIncNoUnmute;
    private IDvInvocationListener iDelegateVolumeDecNoUnmute;
    ...
    {
        super(aDevice, "av.openhome.org", "Volume", 4);
    }
    ...
    {
        Action action = new Action("SetVolumeNoUnmute");
        action.addInputParameter(new ParameterRelated("Value", iPropertyVolume));
        iDelegateSetVolumeNoUnmute = new DoSetVolumeNoUnmute();
        enableAction(action, iDelegateSetVolumeNoUnmute);
    }
    ...
    {
        Action action = new Action("VolumeIncNoUnmute");
        iDelegateVolumeIncNoUnmute = new DoVolumeIncNoUnmute();
        enableAction(action, iDelegateVolumeIncNoUnmute);
    }
    ...
    {
        Action action = new Action("VolumeDecNoUnmute");
        iDelegateVolumeDecNoUnmute = new DoVolumeDecNoUnmute();
        enableAction(action, iDelegateVolumeDecNoUnmute);
    }
     ...
     *
     * <p>Must be implemented iff {@link #enableActionSetVolumeNoUnmute} was called.</remarks>
     *
     * @param aInvocation   Interface allowing querying of aspects of this particular action invocation.</param>
     * @param aValue
     */
    protected void setVolumeNoUnmute(IDvInvocation aInvocation, long aValue)
    {
        throw (new ActionDisabledError());
    }
     ...
     *
     * <p>Must be implemented iff {@link #enableActionVolumeIncNoUnmute} was called.</remarks>
     *
     * @param aInvocation   Interface allowing querying of aspects of this particular action invocation.</param>
     */
    protected void volumeIncNoUnmute(IDvInvocation aInvocation)
    {
        throw (new ActionDisabledError());
    }
     ...
     *
     * <p>Must be implemented iff {@link #enableActionVolumeDecNoUnmute} was called.</remarks>
     *
     * @param aInvocation   Interface allowing querying of aspects of this particular action invocation.</param>
     */
    protected void volumeDecNoUnmute(IDvInvocation aInvocation)
    {
        throw (new ActionDisabledError());
    }
    ...
    private class DoSetVolumeNoUnmute implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            {
                invocation.reportActionError(ae, "SetVolumeNoUnmute");
                return;
            }
            catch (PropertyUpdateError pue)
            {
    ...
    private class DoVolumeIncNoUnmute implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            {
                invocation.reportActionError(ae, "VolumeIncNoUnmute");
                return;
            }
            catch (PropertyUpdateError pue)
            {
    ...
    private class DoVolumeDecNoUnmute implements IDvInvocationListener
    {
        public void actionInvoked(long aInvocation)
        {
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            {
                invocation.reportActionError(ae, "VolumeDecNoUnmute");
                return;
            }
            catch (PropertyUpdateError pue)
            {
