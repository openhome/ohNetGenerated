...
bool DvProviderAvOpenhomeOrgExakt4Cpp::SetPropertyDeviceList(const std::string& aValue)
{
...
void DvProviderAvOpenhomeOrgExakt4Cpp::GetPropertyDeviceList(std::string& aValue)
{
    ASSERT(iPropertyDeviceList != NULL);
...
bool DvProviderAvOpenhomeOrgExakt4Cpp::SetPropertyConnectionStatus(const std::string& aValue)
{
...
void DvProviderAvOpenhomeOrgExakt4Cpp::GetPropertyConnectionStatus(std::string& aValue)
{
    ASSERT(iPropertyConnectionStatus != NULL);
...
bool DvProviderAvOpenhomeOrgExakt4Cpp::SetPropertyChannelMap(const std::string& aValue)
{
...
void DvProviderAvOpenhomeOrgExakt4Cpp::GetPropertyChannelMap(std::string& aValue)
{
    ASSERT(iPropertyChannelMap != NULL);
...
bool DvProviderAvOpenhomeOrgExakt4Cpp::SetPropertyAudioChannels(const std::string& aValue)
{
...
void DvProviderAvOpenhomeOrgExakt4Cpp::GetPropertyAudioChannels(std::string& aValue)
{
    ASSERT(iPropertyAudioChannels != NULL);
...
bool DvProviderAvOpenhomeOrgExakt4Cpp::SetPropertyVersion(const std::string& aValue)
{
...
void DvProviderAvOpenhomeOrgExakt4Cpp::GetPropertyVersion(std::string& aValue)
{
    ASSERT(iPropertyVersion != NULL);
...
bool DvProviderAvOpenhomeOrgExakt4Cpp::SetPropertyIntegratedDevicesPresent(bool aValue)
{
    ASSERT(iPropertyIntegratedDevicesPresent != NULL);
    return SetPropertyBool(*iPropertyIntegratedDevicesPresent, aValue);
}

void DvProviderAvOpenhomeOrgExakt4Cpp::GetPropertyIntegratedDevicesPresent(bool& aValue)
{
    ASSERT(iPropertyIntegratedDevicesPresent != NULL);
    aValue = iPropertyIntegratedDevicesPresent->Value();
}

DvProviderAvOpenhomeOrgExakt4Cpp::DvProviderAvOpenhomeOrgExakt4Cpp(DvDeviceStd& aDevice)
...
void DvProviderAvOpenhomeOrgExakt4Cpp::EnablePropertyDeviceList()
{
...
void DvProviderAvOpenhomeOrgExakt4Cpp::EnablePropertyConnectionStatus()
{
...
void DvProviderAvOpenhomeOrgExakt4Cpp::EnablePropertyChannelMap()
{
...
void DvProviderAvOpenhomeOrgExakt4Cpp::EnablePropertyAudioChannels()
{
...
void DvProviderAvOpenhomeOrgExakt4Cpp::EnablePropertyVersion()
{
    iPropertyVersion = new PropertyString(new ParameterString("Version"));
    iService->AddProperty(iPropertyVersion); // passes ownership
}

void DvProviderAvOpenhomeOrgExakt4Cpp::EnablePropertyIntegratedDevicesPresent()
{
...
void DvProviderAvOpenhomeOrgExakt4Cpp::EnableActionDeviceList()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgExakt4Cpp::DoDeviceList);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgExakt4Cpp::EnableActionDeviceSettings()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgExakt4Cpp::DoDeviceSettings);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgExakt4Cpp::EnableActionConnectionStatus()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgExakt4Cpp::DoConnectionStatus);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgExakt4Cpp::EnableActionSet()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgExakt4Cpp::DoSet);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgExakt4Cpp::EnableActionReprogram()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("Reprogram");
    action->AddInputParameter(new ParameterString("DeviceId"));
    action->AddInputParameter(new ParameterString("FileUri"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgExakt4Cpp::DoReprogram);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgExakt4Cpp::EnableActionReprogramFallback()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("ReprogramFallback");
    action->AddInputParameter(new ParameterString("DeviceId"));
    action->AddInputParameter(new ParameterString("FileUri"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgExakt4Cpp::DoReprogramFallback);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgExakt4Cpp::EnableActionChannelMap()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgExakt4Cpp::DoChannelMap);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgExakt4Cpp::EnableActionSetChannelMap()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgExakt4Cpp::DoSetChannelMap);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgExakt4Cpp::EnableActionAudioChannels()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgExakt4Cpp::DoAudioChannels);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgExakt4Cpp::EnableActionSetAudioChannels()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgExakt4Cpp::DoSetAudioChannels);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgExakt4Cpp::EnableActionVersion()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgExakt4Cpp::DoVersion);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgExakt4Cpp::EnableActionGetIntegratedDevicesPresent()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgExakt4Cpp::DoGetIntegratedDevicesPresent);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgExakt4Cpp::EnableActionBootIntegratedDevicesToFallback()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("BootIntegratedDevicesToFallback");
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgExakt4Cpp::DoBootIntegratedDevicesToFallback);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgExakt4Cpp::DoDeviceList(IDviInvocation& aInvocation)
{
...
void DvProviderAvOpenhomeOrgExakt4Cpp::DoDeviceSettings(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    Brhz buf_DeviceId;
...
void DvProviderAvOpenhomeOrgExakt4Cpp::DoConnectionStatus(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderAvOpenhomeOrgExakt4Cpp::DoSet(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    Brhz buf_DeviceId;
    aInvocation.InvocationReadString("DeviceId", buf_DeviceId);
...
void DvProviderAvOpenhomeOrgExakt4Cpp::DoReprogram(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    Brhz buf_DeviceId;
    aInvocation.InvocationReadString("DeviceId", buf_DeviceId);
...
void DvProviderAvOpenhomeOrgExakt4Cpp::DoReprogramFallback(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    Brhz buf_DeviceId;
    aInvocation.InvocationReadString("DeviceId", buf_DeviceId);
...
void DvProviderAvOpenhomeOrgExakt4Cpp::DoChannelMap(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderAvOpenhomeOrgExakt4Cpp::DoSetChannelMap(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    Brhz buf_ChannelMap;
...
void DvProviderAvOpenhomeOrgExakt4Cpp::DoAudioChannels(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderAvOpenhomeOrgExakt4Cpp::DoSetAudioChannels(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
...
void DvProviderAvOpenhomeOrgExakt4Cpp::DoVersion(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderAvOpenhomeOrgExakt4Cpp::DoGetIntegratedDevicesPresent(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderAvOpenhomeOrgExakt4Cpp::DoBootIntegratedDevicesToFallback(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
    DvInvocationStd invocation(aInvocation);
...
void DvProviderAvOpenhomeOrgExakt4Cpp::DeviceList(IDvInvocationStd& /*aInvocation*/, std::string& /*aList*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgExakt4Cpp::DeviceSettings(IDvInvocationStd& /*aInvocation*/, const std::string& /*aDeviceId*/, std::string& /*aSettings*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgExakt4Cpp::ConnectionStatus(IDvInvocationStd& /*aInvocation*/, std::string& /*aConnectionStatus*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgExakt4Cpp::Set(IDvInvocationStd& /*aInvocation*/, const std::string& /*aDeviceId*/, uint32_t /*aBankId*/, const std::string& /*aFileUri*/, bool /*aMute*/, bool /*aPersist*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgExakt4Cpp::Reprogram(IDvInvocationStd& /*aInvocation*/, const std::string& /*aDeviceId*/, const std::string& /*aFileUri*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgExakt4Cpp::ReprogramFallback(IDvInvocationStd& /*aInvocation*/, const std::string& /*aDeviceId*/, const std::string& /*aFileUri*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgExakt4Cpp::ChannelMap(IDvInvocationStd& /*aInvocation*/, std::string& /*aChannelMap*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgExakt4Cpp::SetChannelMap(IDvInvocationStd& /*aInvocation*/, const std::string& /*aChannelMap*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgExakt4Cpp::AudioChannels(IDvInvocationStd& /*aInvocation*/, std::string& /*aAudioChannels*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgExakt4Cpp::SetAudioChannels(IDvInvocationStd& /*aInvocation*/, const std::string& /*aAudioChannels*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgExakt4Cpp::Version(IDvInvocationStd& /*aInvocation*/, std::string& /*aVersion*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgExakt4Cpp::GetIntegratedDevicesPresent(IDvInvocationStd& /*aInvocation*/, bool& /*aIntegratedDevicesPresent*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgExakt4Cpp::BootIntegratedDevicesToFallback(IDvInvocationStd& /*aInvocation*/)
{
    ASSERTS();
}
