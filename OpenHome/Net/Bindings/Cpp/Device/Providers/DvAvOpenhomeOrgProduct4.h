#ifndef HEADER_DVAVOPENHOMEORGPRODUCT4CPP
#define HEADER_DVAVOPENHOMEORGPRODUCT4CPP
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgProduct4Cpp : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgProduct4Cpp() {}
    /**
     ...
     * @return  true if the value has been updated; false if aValue was the same as the previous value
     */
    bool SetPropertyProductImageHiresUri(const std::string& aValue);
    /**
     * Get a copy of the value of the ProductImageHiresUri property
     *
     * Can only be called if EnablePropertyProductImageHiresUri has previously been called.
     */
    void GetPropertyProductImageHiresUri(std::string& aValue);
    /**
     ...
     * Can only be called if EnablePropertyStandbyTransitioning has previously been called.
     */
    void GetPropertyStandbyTransitioning(bool& aValue);
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgProduct4Cpp(DvDeviceStd& aDevice);
    /**
...
private:
     ...
     */
    virtual void Product(IDvInvocationStd& aInvocation, std::string& aRoom, std::string& aName, std::string& aInfo, std::string& aUrl, std::string& aImageUri, std::string& aImageHiresUri);
    /**
     * Standby action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void StandbyTransitioning(IDvInvocationStd& aInvocation, bool& aValue);
    /**
     * SetStandby action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void SetSourceBySystemName(IDvInvocationStd& aInvocation, const std::string& aValue);
    /**
     * Source action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void GetImageUri(IDvInvocationStd& aInvocation, const std::string& aResolution, std::string& aImageUri);
private:
    DvProviderAvOpenhomeOrgProduct4Cpp();
...
#endif // HEADER_DVAVOPENHOMEORGPRODUCT4CPP
