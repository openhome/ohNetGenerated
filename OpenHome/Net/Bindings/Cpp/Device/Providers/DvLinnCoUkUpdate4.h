#ifndef HEADER_DVLINNCOUKUPDATE4CPP
#define HEADER_DVLINNCOUKUPDATE4CPP
 ...
 * @ingroup Providers
 */
class DvProviderLinnCoUkUpdate4Cpp : public DvProvider
{
public:
    virtual ~DvProviderLinnCoUkUpdate4Cpp() {}
    /**
...
protected:
     ...
     */
    DvProviderLinnCoUkUpdate4Cpp(DvDeviceStd& aDevice);
    /**
...
private:
     ...
     */
    virtual void RecoverKeepStore(IDvInvocationStd& aInvocation);
    /**
     ...
     */
    virtual void RecoverKeepStore2(IDvInvocationStd& aInvocation, uint32_t& aId);
    /**
     * CheckNow action.
     *
     * Will be called when the device stack receives an invocation of the
...
#endif // HEADER_DVLINNCOUKUPDATE4CPP
