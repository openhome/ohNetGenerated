#ifndef HEADER_DVLINNCOUKEXAKT22CPP
#define HEADER_DVLINNCOUKEXAKT22CPP
 ...
 * @ingroup Providers
 */
class DvProviderLinnCoUkExakt22Cpp : public DvProvider
{
public:
    virtual ~DvProviderLinnCoUkExakt22Cpp() {}
    /**
     ...
     *
     * Can only be called if EnablePropertyTestTrackPlaying has previously been called.
     *
     * @return  true if the value has been updated; false if aValue was the same as the previous value
     */
     ...
     * Can only be called if EnablePropertyTestTrackPlaying has previously been called.
     */
    void GetPropertyTestTrackPlaying(bool& aValue);
protected:
    /**
     * Constructor
     *
     ...
     */
    DvProviderLinnCoUkExakt22Cpp(DvDeviceStd& aDevice);
    /**
     ...
     */
    void EnableActionGetTestTrackPlaying();
private:
    /**
     ...
     * Must be implemented iff EnableActionGetTestTrackPlaying was called.
     */
    virtual void GetTestTrackPlaying(IDvInvocationStd& aInvocation, bool& aTestTrackPlaying);
private:
    DvProviderLinnCoUkExakt22Cpp();
...
#endif // HEADER_DVLINNCOUKEXAKT22CPP
