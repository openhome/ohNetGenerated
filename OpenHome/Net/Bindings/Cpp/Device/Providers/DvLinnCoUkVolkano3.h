#ifndef HEADER_DVLINNCOUKVOLKANO3CPP
#define HEADER_DVLINNCOUKVOLKANO3CPP
 ...
 * @ingroup Providers
 */
class DvProviderLinnCoUkVolkano3Cpp : public DvProvider
{
public:
    virtual ~DvProviderLinnCoUkVolkano3Cpp() {}
    /**
...
protected:
     ...
     */
    DvProviderLinnCoUkVolkano3Cpp(DvDeviceStd& aDevice);
    /**
...
#endif // HEADER_DVLINNCOUKVOLKANO3CPP
