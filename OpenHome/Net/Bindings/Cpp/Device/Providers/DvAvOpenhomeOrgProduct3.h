#ifndef HEADER_DVAVOPENHOMEORGPRODUCT3CPP
#define HEADER_DVAVOPENHOMEORGPRODUCT3CPP
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgProduct3Cpp : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgProduct3Cpp() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgProduct3Cpp(DvDeviceStd& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgProduct3Cpp();
...
#endif // HEADER_DVAVOPENHOMEORGPRODUCT3CPP
