#ifndef HEADER_DVAVOPENHOMEORGVOLUME2CPP
#define HEADER_DVAVOPENHOMEORGVOLUME2CPP
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgVolume2Cpp : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgVolume2Cpp() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgVolume2Cpp(DvDeviceStd& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgVolume2Cpp();
...
#endif // HEADER_DVAVOPENHOMEORGVOLUME2CPP
