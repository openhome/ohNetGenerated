...
bool DvProviderLinnCoUkCloud2Cpp::SetPropertyAssociationStatus(const std::string& aValue)
{
...
void DvProviderLinnCoUkCloud2Cpp::GetPropertyAssociationStatus(std::string& aValue)
{
    ASSERT(iPropertyAssociationStatus != NULL);
...
bool DvProviderLinnCoUkCloud2Cpp::SetPropertyConnected(bool aValue)
{
    ASSERT(iPropertyConnected != NULL);
    return SetPropertyBool(*iPropertyConnected, aValue);
}

void DvProviderLinnCoUkCloud2Cpp::GetPropertyConnected(bool& aValue)
{
    ASSERT(iPropertyConnected != NULL);
    aValue = iPropertyConnected->Value();
}

bool DvProviderLinnCoUkCloud2Cpp::SetPropertyAccountId(const std::string& aValue)
{
    ASSERT(iPropertyAccountId != NULL);
    Brn buf((const TByte*)aValue.c_str(), (TUint)aValue.length());
    return SetPropertyString(*iPropertyAccountId, buf);
}

void DvProviderLinnCoUkCloud2Cpp::GetPropertyAccountId(std::string& aValue)
{
    ASSERT(iPropertyAccountId != NULL);
    const Brx& val = iPropertyAccountId->Value();
    aValue.assign((const char*)val.Ptr(), val.Bytes());
}

bool DvProviderLinnCoUkCloud2Cpp::SetPropertyPublicKey(const std::string& aValue)
{
...
void DvProviderLinnCoUkCloud2Cpp::GetPropertyPublicKey(std::string& aValue)
{
    ASSERT(iPropertyPublicKey != NULL);
...
DvProviderLinnCoUkCloud2Cpp::DvProviderLinnCoUkCloud2Cpp(DvDeviceStd& aDevice)
...
void DvProviderLinnCoUkCloud2Cpp::EnablePropertyAssociationStatus()
{
    TChar** allowedValues;
    TUint index = 0;
...
void DvProviderLinnCoUkCloud2Cpp::EnablePropertyPublicKey()
{
...
void DvProviderLinnCoUkCloud2Cpp::EnableActionGetChallengeResponse()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkCloud2Cpp::DoGetChallengeResponse);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkCloud2Cpp::EnableActionSetAssociated()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkCloud2Cpp::DoSetAssociated);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkCloud2Cpp::EnableActionGetConnected()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkCloud2Cpp::DoGetConnected);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkCloud2Cpp::EnableActionGetAccountId()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkCloud2Cpp::DoGetAccountId);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkCloud2Cpp::EnableActionGetPublicKey()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkCloud2Cpp::DoGetPublicKey);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkCloud2Cpp::DoGetChallengeResponse(IDviInvocation& aInvocation)
{
...
void DvProviderLinnCoUkCloud2Cpp::DoSetAssociated(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
...
void DvProviderLinnCoUkCloud2Cpp::DoGetConnected(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
    bool respConnected;
...
void DvProviderLinnCoUkCloud2Cpp::DoGetAccountId(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
    std::string respAccountId;
    DvInvocationStd invocation(aInvocation);
    GetAccountId(invocation, respAccountId);
    aInvocation.InvocationWriteStart();
    DviInvocationResponseString respWriterAccountId(aInvocation, "AccountId");
    Brn buf_AccountId((const TByte*)respAccountId.c_str(), (TUint)respAccountId.length());
    respWriterAccountId.Write(buf_AccountId);
    aInvocation.InvocationWriteStringEnd("AccountId");
    aInvocation.InvocationWriteEnd();
}

void DvProviderLinnCoUkCloud2Cpp::DoGetPublicKey(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderLinnCoUkCloud2Cpp::GetChallengeResponse(IDvInvocationStd& /*aInvocation*/, const std::string& /*aChallenge*/, std::string& /*aResponse*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkCloud2Cpp::SetAssociated(IDvInvocationStd& /*aInvocation*/, const std::string& /*aAesKeyRsaEncrypted*/, const std::string& /*aInitVectorRsaEncrypted*/, const std::string& /*aTokenAesEncrypted*/, bool /*aAssociated*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkCloud2Cpp::GetConnected(IDvInvocationStd& /*aInvocation*/, bool& /*aConnected*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkCloud2Cpp::GetAccountId(IDvInvocationStd& /*aInvocation*/, std::string& /*aAccountId*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkCloud2Cpp::GetPublicKey(IDvInvocationStd& /*aInvocation*/, std::string& /*aPublicKey*/)
{
    ASSERTS();
}
