#ifndef HEADER_DVAVOPENHOMEORGEXAKT3CPP
#define HEADER_DVAVOPENHOMEORGEXAKT3CPP
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgExakt3Cpp : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgExakt3Cpp() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgExakt3Cpp(DvDeviceStd& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgExakt3Cpp();
...
#endif // HEADER_DVAVOPENHOMEORGEXAKT3CPP
