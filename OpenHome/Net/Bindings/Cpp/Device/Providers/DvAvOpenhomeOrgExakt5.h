#ifndef HEADER_DVAVOPENHOMEORGEXAKT5CPP
#define HEADER_DVAVOPENHOMEORGEXAKT5CPP
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgExakt5Cpp : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgExakt5Cpp() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgExakt5Cpp(DvDeviceStd& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgExakt5Cpp();
...
#endif // HEADER_DVAVOPENHOMEORGEXAKT5CPP
