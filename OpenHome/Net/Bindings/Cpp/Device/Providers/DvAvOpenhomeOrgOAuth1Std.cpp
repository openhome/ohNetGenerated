...
bool DvProviderAvOpenhomeOrgOAuth1Cpp::SetPropertyPublicKey(const std::string& aValue)
{
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::GetPropertyPublicKey(std::string& aValue)
{
    ASSERT(iPropertyPublicKey != NULL);
...
bool DvProviderAvOpenhomeOrgOAuth1Cpp::SetPropertyUpdateId(uint32_t aValue)
{
    ASSERT(iPropertyUpdateId != NULL);
    return SetPropertyUint(*iPropertyUpdateId, aValue);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::GetPropertyUpdateId(uint32_t& aValue)
{
    ASSERT(iPropertyUpdateId != NULL);
    aValue = iPropertyUpdateId->Value();
}

bool DvProviderAvOpenhomeOrgOAuth1Cpp::SetPropertyJobUpdateId(uint32_t aValue)
{
    ASSERT(iPropertyJobUpdateId != NULL);
    return SetPropertyUint(*iPropertyJobUpdateId, aValue);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::GetPropertyJobUpdateId(uint32_t& aValue)
{
    ASSERT(iPropertyJobUpdateId != NULL);
    aValue = iPropertyJobUpdateId->Value();
}

bool DvProviderAvOpenhomeOrgOAuth1Cpp::SetPropertySupportedServices(const std::string& aValue)
{
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::GetPropertySupportedServices(std::string& aValue)
{
    ASSERT(iPropertySupportedServices != NULL);
...
DvProviderAvOpenhomeOrgOAuth1Cpp::DvProviderAvOpenhomeOrgOAuth1Cpp(DvDeviceStd& aDevice)
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::EnablePropertyPublicKey()
{
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::EnablePropertyUpdateId()
{
    iPropertyUpdateId = new PropertyUint(new ParameterUint("UpdateId"));
    iService->AddProperty(iPropertyUpdateId); // passes ownership
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::EnablePropertyJobUpdateId()
{
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::EnablePropertySupportedServices()
{
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::EnableActionSetToken()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgOAuth1Cpp::DoSetToken);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::EnableActionGetPublicKey()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgOAuth1Cpp::DoGetPublicKey);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::EnableActionClearToken()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("ClearToken");
    action->AddInputParameter(new ParameterString("ServiceId"));
    action->AddInputParameter(new ParameterString("TokenId"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgOAuth1Cpp::DoClearToken);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::EnableActionClearShortLivedToken()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("ClearShortLivedToken");
    action->AddInputParameter(new ParameterString("ServiceId"));
    action->AddInputParameter(new ParameterString("TokenId"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgOAuth1Cpp::DoClearShortLivedToken);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::EnableActionClearLongLivedToken()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("ClearLongLivedToken");
    action->AddInputParameter(new ParameterString("ServiceId"));
    action->AddInputParameter(new ParameterString("TokenId"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgOAuth1Cpp::DoClearLongLivedToken);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::EnableActionClearShortLivedTokens()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("ClearShortLivedTokens");
    action->AddInputParameter(new ParameterString("ServiceId"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgOAuth1Cpp::DoClearShortLivedTokens);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::EnableActionClearLongLivedTokens()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("ClearLongLivedTokens");
    action->AddInputParameter(new ParameterString("ServiceId"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgOAuth1Cpp::DoClearLongLivedTokens);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::EnableActionClearAllTokens()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("ClearAllTokens");
    action->AddInputParameter(new ParameterString("ServiceId"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgOAuth1Cpp::DoClearAllTokens);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::EnableActionGetUpdateId()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgOAuth1Cpp::DoGetUpdateId);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::EnableActionGetServiceStatus()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgOAuth1Cpp::DoGetServiceStatus);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::EnableActionGetJobUpdateId()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgOAuth1Cpp::DoGetJobUpdateId);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::EnableActionGetJobStatus()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgOAuth1Cpp::DoGetJobStatus);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::EnableActionGetSupportedServices()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgOAuth1Cpp::DoGetSupportedServices);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::EnableActionBeginLimitedInputFlow()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderAvOpenhomeOrgOAuth1Cpp::DoBeginLimitedInputFlow);
    iService->AddAction(action, functor);
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::DoSetToken(IDviInvocation& aInvocation)
{
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::DoGetPublicKey(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::DoClearToken(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    Brhz buf_ServiceId;
    aInvocation.InvocationReadString("ServiceId", buf_ServiceId);
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::DoClearShortLivedToken(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    Brhz buf_ServiceId;
    aInvocation.InvocationReadString("ServiceId", buf_ServiceId);
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::DoClearLongLivedToken(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    Brhz buf_ServiceId;
    aInvocation.InvocationReadString("ServiceId", buf_ServiceId);
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::DoClearShortLivedTokens(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    Brhz buf_ServiceId;
    aInvocation.InvocationReadString("ServiceId", buf_ServiceId);
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::DoClearLongLivedTokens(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    Brhz buf_ServiceId;
    aInvocation.InvocationReadString("ServiceId", buf_ServiceId);
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::DoClearAllTokens(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    Brhz buf_ServiceId;
    aInvocation.InvocationReadString("ServiceId", buf_ServiceId);
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::DoGetUpdateId(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::DoGetServiceStatus(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::DoGetJobUpdateId(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::DoGetJobStatus(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::DoGetSupportedServices(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::DoBeginLimitedInputFlow(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    Brhz buf_ServiceId;
    aInvocation.InvocationReadString("ServiceId", buf_ServiceId);
...
void DvProviderAvOpenhomeOrgOAuth1Cpp::SetToken(IDvInvocationStd& /*aInvocation*/, const std::string& /*aServiceId*/, const std::string& /*aTokenId*/, const std::string& /*aAesKeyRsaEncrypted*/, const std::string& /*aInitVectorRsaEncrypted*/, const std::string& /*aTokenAesEncrypted*/, bool /*aIsLongLived*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::GetPublicKey(IDvInvocationStd& /*aInvocation*/, std::string& /*aPublicKey*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::ClearToken(IDvInvocationStd& /*aInvocation*/, const std::string& /*aServiceId*/, const std::string& /*aTokenId*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::ClearShortLivedToken(IDvInvocationStd& /*aInvocation*/, const std::string& /*aServiceId*/, const std::string& /*aTokenId*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::ClearLongLivedToken(IDvInvocationStd& /*aInvocation*/, const std::string& /*aServiceId*/, const std::string& /*aTokenId*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::ClearShortLivedTokens(IDvInvocationStd& /*aInvocation*/, const std::string& /*aServiceId*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::ClearLongLivedTokens(IDvInvocationStd& /*aInvocation*/, const std::string& /*aServiceId*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::ClearAllTokens(IDvInvocationStd& /*aInvocation*/, const std::string& /*aServiceId*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::GetUpdateId(IDvInvocationStd& /*aInvocation*/, uint32_t& /*aUpdateId*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::GetServiceStatus(IDvInvocationStd& /*aInvocation*/, std::string& /*aServiceStatusJson*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::GetJobUpdateId(IDvInvocationStd& /*aInvocation*/, uint32_t& /*aJobUpdateId*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::GetJobStatus(IDvInvocationStd& /*aInvocation*/, std::string& /*aJobStatusJson*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::GetSupportedServices(IDvInvocationStd& /*aInvocation*/, std::string& /*aSupportedServiceListJson*/)
{
    ASSERTS();
}

void DvProviderAvOpenhomeOrgOAuth1Cpp::BeginLimitedInputFlow(IDvInvocationStd& /*aInvocation*/, const std::string& /*aServiceId*/, std::string& /*aJobId*/, std::string& /*aLoginUrl*/, std::string& /*aUserCode*/)
{
    ASSERTS();
}
