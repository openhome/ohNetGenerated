#ifndef HEADER_DVAVOPENHOMEORGRADIO2CPP
#define HEADER_DVAVOPENHOMEORGRADIO2CPP
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgRadio2Cpp : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgRadio2Cpp() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgRadio2Cpp(DvDeviceStd& aDevice);
    /**
...
private:
     ...
     */
    virtual void RefreshPresets(IDvInvocationStd& aInvocation);
    /**
     * ProtocolInfo action.
     *
     * Will be called when the device stack receives an invocation of the
...
private:
    DvProviderAvOpenhomeOrgRadio2Cpp();
...
#endif // HEADER_DVAVOPENHOMEORGRADIO2CPP
