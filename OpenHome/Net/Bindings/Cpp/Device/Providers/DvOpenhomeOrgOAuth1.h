#ifndef HEADER_DVOPENHOMEORGOAUTH1CPP
#define HEADER_DVOPENHOMEORGOAUTH1CPP
 ...
 * @ingroup Providers
 */
class DvProviderOpenhomeOrgOAuth1Cpp : public DvProvider
{
public:
    virtual ~DvProviderOpenhomeOrgOAuth1Cpp() {}
    /**
...
protected:
     ...
     */
    DvProviderOpenhomeOrgOAuth1Cpp(DvDeviceStd& aDevice);
    /**
...
private:
    DvProviderOpenhomeOrgOAuth1Cpp();
...
#endif // HEADER_DVOPENHOMEORGOAUTH1CPP
