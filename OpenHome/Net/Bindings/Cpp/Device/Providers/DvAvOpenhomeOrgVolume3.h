#ifndef HEADER_DVAVOPENHOMEORGVOLUME3CPP
#define HEADER_DVAVOPENHOMEORGVOLUME3CPP
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgVolume3Cpp : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgVolume3Cpp() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgVolume3Cpp(DvDeviceStd& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgVolume3Cpp();
...
#endif // HEADER_DVAVOPENHOMEORGVOLUME3CPP
