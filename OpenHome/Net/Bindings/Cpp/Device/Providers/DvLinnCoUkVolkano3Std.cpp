...
bool DvProviderLinnCoUkVolkano3Cpp::SetPropertyDeviceInfo(const std::string& aValue)
{
...
void DvProviderLinnCoUkVolkano3Cpp::GetPropertyDeviceInfo(std::string& aValue)
{
    ASSERT(iPropertyDeviceInfo != NULL);
...
bool DvProviderLinnCoUkVolkano3Cpp::SetPropertyIpAddress(const std::string& aValue)
{
...
void DvProviderLinnCoUkVolkano3Cpp::GetPropertyIpAddress(std::string& aValue)
{
    ASSERT(iPropertyIpAddress != NULL);
...
bool DvProviderLinnCoUkVolkano3Cpp::SetPropertyIpAddressList(const std::string& aValue)
{
...
void DvProviderLinnCoUkVolkano3Cpp::GetPropertyIpAddressList(std::string& aValue)
{
    ASSERT(iPropertyIpAddressList != NULL);
...
bool DvProviderLinnCoUkVolkano3Cpp::SetPropertyMacAddressList(const std::string& aValue)
{
...
void DvProviderLinnCoUkVolkano3Cpp::GetPropertyMacAddressList(std::string& aValue)
{
    ASSERT(iPropertyMacAddressList != NULL);
...
bool DvProviderLinnCoUkVolkano3Cpp::SetPropertyCoreBoardId(const std::string& aValue)
{
...
void DvProviderLinnCoUkVolkano3Cpp::GetPropertyCoreBoardId(std::string& aValue)
{
    ASSERT(iPropertyCoreBoardId != NULL);
...
DvProviderLinnCoUkVolkano3Cpp::DvProviderLinnCoUkVolkano3Cpp(DvDeviceStd& aDevice)
...
void DvProviderLinnCoUkVolkano3Cpp::EnablePropertyDeviceInfo()
{
...
void DvProviderLinnCoUkVolkano3Cpp::EnablePropertyIpAddress()
{
...
void DvProviderLinnCoUkVolkano3Cpp::EnablePropertyIpAddressList()
{
...
void DvProviderLinnCoUkVolkano3Cpp::EnablePropertyMacAddressList()
{
...
void DvProviderLinnCoUkVolkano3Cpp::EnablePropertyCoreBoardId()
{
...
void DvProviderLinnCoUkVolkano3Cpp::EnableActionReboot()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("Reboot");
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoReboot);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionBootMode()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoBootMode);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionSetBootMode()
{
    ...
    delete[] allowedValues;
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoSetBootMode);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionBspType()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("BspType");
    action->AddOutputParameter(new ParameterString("aBspType"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoBspType);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionUglyName()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("UglyName");
    action->AddOutputParameter(new ParameterString("aUglyName"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoUglyName);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionIpAddress()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoIpAddress);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionIpAddressList()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoIpAddressList);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionMacAddress()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("MacAddress");
    action->AddOutputParameter(new ParameterString("aMacAddress"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoMacAddress);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionMacAddressList()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoMacAddressList);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionProductId()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("ProductId");
    action->AddOutputParameter(new ParameterString("aProductNumber"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoProductId);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionBoardId()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoBoardId);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionBoardType()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("BoardType");
    action->AddInputParameter(new ParameterUint("aIndex"));
    action->AddOutputParameter(new ParameterString("aBoardNumber"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoBoardType);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionMaxBoards()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("MaxBoards");
    action->AddOutputParameter(new ParameterUint("aMaxBoards"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoMaxBoards);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionSoftwareVersion()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoSoftwareVersion);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionSoftwareUpdate()
{
    OpenHome::Net::Action* action = new OpenHome::Net::Action("SoftwareUpdate");
    action->AddOutputParameter(new ParameterBool("aAvailable"));
    action->AddOutputParameter(new ParameterString("aSoftwareVersion"));
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoSoftwareUpdate);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionDeviceInfo()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoDeviceInfo);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::EnableActionCoreBoardId()
{
    ...
    FunctorDviInvocation functor = MakeFunctorDviInvocation(*this, &DvProviderLinnCoUkVolkano3Cpp::DoCoreBoardId);
    iService->AddAction(action, functor);
}

void DvProviderLinnCoUkVolkano3Cpp::DoReboot(IDviInvocation& aInvocation)
{
...
void DvProviderLinnCoUkVolkano3Cpp::DoBootMode(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderLinnCoUkVolkano3Cpp::DoSetBootMode(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    Brhz buf_aMode;
...
void DvProviderLinnCoUkVolkano3Cpp::DoBspType(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderLinnCoUkVolkano3Cpp::DoUglyName(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderLinnCoUkVolkano3Cpp::DoIpAddress(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderLinnCoUkVolkano3Cpp::DoIpAddressList(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderLinnCoUkVolkano3Cpp::DoMacAddress(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderLinnCoUkVolkano3Cpp::DoMacAddressList(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderLinnCoUkVolkano3Cpp::DoProductId(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderLinnCoUkVolkano3Cpp::DoBoardId(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
...
void DvProviderLinnCoUkVolkano3Cpp::DoBoardType(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    uint32_t aIndex = aInvocation.InvocationReadUint("aIndex");
    aInvocation.InvocationReadEnd();
...
void DvProviderLinnCoUkVolkano3Cpp::DoMaxBoards(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderLinnCoUkVolkano3Cpp::DoSoftwareVersion(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderLinnCoUkVolkano3Cpp::DoSoftwareUpdate(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
    bool respaAvailable;
...
void DvProviderLinnCoUkVolkano3Cpp::DoDeviceInfo(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderLinnCoUkVolkano3Cpp::DoCoreBoardId(IDviInvocation& aInvocation)
{
    aInvocation.InvocationReadStart();
    aInvocation.InvocationReadEnd();
...
void DvProviderLinnCoUkVolkano3Cpp::Reboot(IDvInvocationStd& /*aInvocation*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::BootMode(IDvInvocationStd& /*aInvocation*/, std::string& /*aaMode*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::SetBootMode(IDvInvocationStd& /*aInvocation*/, const std::string& /*aaMode*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::BspType(IDvInvocationStd& /*aInvocation*/, std::string& /*aaBspType*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::UglyName(IDvInvocationStd& /*aInvocation*/, std::string& /*aaUglyName*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::IpAddress(IDvInvocationStd& /*aInvocation*/, std::string& /*aaIpAddress*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::IpAddressList(IDvInvocationStd& /*aInvocation*/, std::string& /*aaIpAddressList*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::MacAddress(IDvInvocationStd& /*aInvocation*/, std::string& /*aaMacAddress*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::MacAddressList(IDvInvocationStd& /*aInvocation*/, std::string& /*aaMacAddressList*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::ProductId(IDvInvocationStd& /*aInvocation*/, std::string& /*aaProductNumber*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::BoardId(IDvInvocationStd& /*aInvocation*/, uint32_t /*aaIndex*/, std::string& /*aaBoardNumber*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::BoardType(IDvInvocationStd& /*aInvocation*/, uint32_t /*aaIndex*/, std::string& /*aaBoardNumber*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::MaxBoards(IDvInvocationStd& /*aInvocation*/, uint32_t& /*aaMaxBoards*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::SoftwareVersion(IDvInvocationStd& /*aInvocation*/, std::string& /*aaSoftwareVersion*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::SoftwareUpdate(IDvInvocationStd& /*aInvocation*/, bool& /*aaAvailable*/, std::string& /*aaSoftwareVersion*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::DeviceInfo(IDvInvocationStd& /*aInvocation*/, std::string& /*aaDeviceInfoXml*/)
{
    ASSERTS();
}

void DvProviderLinnCoUkVolkano3Cpp::CoreBoardId(IDvInvocationStd& /*aInvocation*/, std::string& /*aaCoreBoardId*/)
{
    ASSERTS();
}
