#ifndef HEADER_AVOPENHOMEORGRADIO2CPP
#define HEADER_AVOPENHOMEORGRADIO2CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgRadio2Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgRadio2Cpp() {}
    ...
    virtual void SyncRefreshPresets() = 0;
    virtual void BeginRefreshPresets(FunctorAsync& aFunctor) = 0;
    virtual void EndRefreshPresets(IAsync& aAsync) = 0;
...
/**
 * Proxy for av.openhome.org:Radio:2
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgRadio2Cpp : public ICpProxyAvOpenhomeOrgRadio2Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgRadio2Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     * CpProxyAvOpenhomeOrgRadio2Cpp instance will not overlap.
     *
...
#endif // HEADER_AVOPENHOMEORGRADIO2CPP
