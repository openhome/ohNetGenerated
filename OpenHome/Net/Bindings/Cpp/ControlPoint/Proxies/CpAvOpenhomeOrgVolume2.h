#ifndef HEADER_AVOPENHOMEORGVOLUME2CPP
#define HEADER_AVOPENHOMEORGVOLUME2CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgVolume2Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgVolume2Cpp() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgVolume2Cpp : public ICpProxyAvOpenhomeOrgVolume2Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgVolume2Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    ~CpProxyAvOpenhomeOrgVolume2Cpp();
     ...
     * CpProxyAvOpenhomeOrgVolume2Cpp instance will not overlap.
     *
...
#endif // HEADER_AVOPENHOMEORGVOLUME2CPP
