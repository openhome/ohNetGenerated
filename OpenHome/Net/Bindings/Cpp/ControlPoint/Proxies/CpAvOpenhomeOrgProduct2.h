#ifndef HEADER_AVOPENHOMEORGPRODUCT2CPP
#define HEADER_AVOPENHOMEORGPRODUCT2CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgProduct2Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgProduct2Cpp() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgProduct2Cpp : public ICpProxyAvOpenhomeOrgProduct2Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgProduct2Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    ~CpProxyAvOpenhomeOrgProduct2Cpp();
     ...
     * CpProxyAvOpenhomeOrgProduct2Cpp instance will not overlap.
     *
...
#endif // HEADER_AVOPENHOMEORGPRODUCT2CPP
