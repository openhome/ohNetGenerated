#ifndef HEADER_AVOPENHOMEORGPRODUCT3CPP
#define HEADER_AVOPENHOMEORGPRODUCT3CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgProduct3Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgProduct3Cpp() {}
...
/**
 * Proxy for av.openhome.org:Product:3
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgProduct3Cpp : public ICpProxyAvOpenhomeOrgProduct3Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgProduct3Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    ~CpProxyAvOpenhomeOrgProduct3Cpp();
     ...
     * CpProxyAvOpenhomeOrgProduct3Cpp instance will not overlap.
     *
...
#endif // HEADER_AVOPENHOMEORGPRODUCT3CPP
