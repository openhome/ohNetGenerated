#ifndef HEADER_LINNCOUKUPDATE2CPP
#define HEADER_LINNCOUKUPDATE2CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyLinnCoUkUpdate2Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyLinnCoUkUpdate2Cpp() {}
 ...
 * @ingroup Proxies
 */
class CpProxyLinnCoUkUpdate2Cpp : public ICpProxyLinnCoUkUpdate2Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyLinnCoUkUpdate2Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     * CpProxyLinnCoUkUpdate2Cpp instance will not overlap.
     *
...
#endif // HEADER_LINNCOUKUPDATE2CPP
