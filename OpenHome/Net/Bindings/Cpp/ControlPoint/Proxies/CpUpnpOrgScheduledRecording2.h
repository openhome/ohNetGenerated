...
class PropertyUint;
class CpProxy;
class ICpProxyUpnpOrgScheduledRecording2Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyUpnpOrgScheduledRecording2Cpp() {}
 ...
 * @ingroup Proxies
 */
class CpProxyUpnpOrgScheduledRecording2Cpp : public ICpProxyUpnpOrgScheduledRecording2Cpp
{
public:
    /**
     * Constructor.
