...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgExakt2Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgExakt2Cpp() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgExakt2Cpp : public ICpProxyAvOpenhomeOrgExakt2Cpp
{
public:
    /**
     * Constructor.
