#ifndef HEADER_LINNCOUKUPDATE4CPP
#define HEADER_LINNCOUKUPDATE4CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyLinnCoUkUpdate4Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyLinnCoUkUpdate4Cpp() {}
    ...
    virtual void SyncRecoverKeepStore2(uint32_t& aId) = 0;
    virtual void BeginRecoverKeepStore2(FunctorAsync& aFunctor) = 0;
    virtual void EndRecoverKeepStore2(IAsync& aAsync, uint32_t& aId) = 0;
 ...
 * @ingroup Proxies
 */
class CpProxyLinnCoUkUpdate4Cpp : public ICpProxyLinnCoUkUpdate4Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyLinnCoUkUpdate4Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     * @param[out] aId
     */
    void SyncRecoverKeepStore2(uint32_t& aId);
    /**
     * Invoke the action asynchronously.
     * Returns immediately and will run the client-specified callback when the action
     * later completes.  Any output arguments can then be retrieved by calling
     ...
     * @param[out] aId
     */
    void EndRecoverKeepStore2(IAsync& aAsync, uint32_t& aId);
     ...
     * CpProxyLinnCoUkUpdate4Cpp instance will not overlap.
     *
...
#endif // HEADER_LINNCOUKUPDATE4CPP
