#ifndef HEADER_OPENHOMEORGOAUTH1CPP
#define HEADER_OPENHOMEORGOAUTH1CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyOpenhomeOrgOAuth1Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyOpenhomeOrgOAuth1Cpp() {}
 ...
 * @ingroup Proxies
 */
class CpProxyOpenhomeOrgOAuth1Cpp : public ICpProxyOpenhomeOrgOAuth1Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyOpenhomeOrgOAuth1Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     * CpProxyOpenhomeOrgOAuth1Cpp instance will not overlap.
     *
...
#endif // HEADER_OPENHOMEORGOAUTH1CPP
