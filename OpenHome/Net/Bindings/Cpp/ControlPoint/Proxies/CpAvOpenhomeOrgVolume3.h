#ifndef HEADER_AVOPENHOMEORGVOLUME3CPP
#define HEADER_AVOPENHOMEORGVOLUME3CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgVolume3Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgVolume3Cpp() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgVolume3Cpp : public ICpProxyAvOpenhomeOrgVolume3Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgVolume3Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    ~CpProxyAvOpenhomeOrgVolume3Cpp();
...
#endif // HEADER_AVOPENHOMEORGVOLUME3CPP
