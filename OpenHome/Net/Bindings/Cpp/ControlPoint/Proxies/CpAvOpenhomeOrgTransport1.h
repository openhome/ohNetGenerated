...
public:
    ...
    virtual void SyncModeInfo(bool& aNextAvailable, bool& aPrevAvailable) = 0;
    virtual void BeginModeInfo(FunctorAsync& aFunctor) = 0;
    virtual void EndModeInfo(IAsync& aAsync, bool& aNextAvailable, bool& aPrevAvailable) = 0;
...
public:
     ...
     */
    void SyncModeInfo(bool& aNextAvailable, bool& aPrevAvailable);
    /**
     * Invoke the action asynchronously.
     * Returns immediately and will run the client-specified callback when the action
     * later completes.  Any output arguments can then be retrieved by calling
     ...
     * @param[out] aPrevAvailable
     */
    void EndModeInfo(IAsync& aAsync, bool& aNextAvailable, bool& aPrevAvailable);
