#ifndef HEADER_AVOPENHOMEORGDEBUG2CPP
#define HEADER_AVOPENHOMEORGDEBUG2CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgDebug2Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgDebug2Cpp() {}
    ...
    virtual void SyncGetRecentMSearches(std::string& aJsonArray) = 0;
    virtual void BeginGetRecentMSearches(FunctorAsync& aFunctor) = 0;
    virtual void EndGetRecentMSearches(IAsync& aAsync, std::string& aJsonArray) = 0;
};
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgDebug2Cpp : public ICpProxyAvOpenhomeOrgDebug2Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgDebug2Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    void SyncGetRecentMSearches(std::string& aJsonArray);
    /**
     * Invoke the action asynchronously.
     * Returns immediately and will run the client-specified callback when the action
     * later completes.  Any output arguments can then be retrieved by calling
     ...
     * @param[out] aJsonArray
     */
    void EndGetRecentMSearches(IAsync& aAsync, std::string& aJsonArray);
...
#endif // HEADER_AVOPENHOMEORGDEBUG2CPP
