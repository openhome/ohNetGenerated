#ifndef HEADER_AVOPENHOMEORGPRODUCT4CPP
#define HEADER_AVOPENHOMEORGPRODUCT4CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgProduct4Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgProduct4Cpp() {}
    ...
    virtual void SyncProduct(std::string& aRoom, std::string& aName, std::string& aInfo, std::string& aUrl, std::string& aImageUri, std::string& aImageHiresUri) = 0;
    virtual void BeginProduct(FunctorAsync& aFunctor) = 0;
    virtual void EndProduct(IAsync& aAsync, std::string& aRoom, std::string& aName, std::string& aInfo, std::string& aUrl, std::string& aImageUri, std::string& aImageHiresUri) = 0;
    ...
    virtual void SyncStandbyTransitioning(bool& aValue) = 0;
    virtual void BeginStandbyTransitioning(FunctorAsync& aFunctor) = 0;
    virtual void EndStandbyTransitioning(IAsync& aAsync, bool& aValue) = 0;
    ...
    virtual void SyncSetSourceBySystemName(const std::string& aValue) = 0;
    virtual void BeginSetSourceBySystemName(const std::string& aValue, FunctorAsync& aFunctor) = 0;
    virtual void EndSetSourceBySystemName(IAsync& aAsync) = 0;
    ...
    virtual void SyncGetImageUri(const std::string& aResolution, std::string& aImageUri) = 0;
    virtual void BeginGetImageUri(const std::string& aResolution, FunctorAsync& aFunctor) = 0;
    virtual void EndGetImageUri(IAsync& aAsync, std::string& aImageUri) = 0;
    ...
    virtual void SetPropertyProductImageHiresUriChanged(Functor& aProductImageHiresUriChanged) = 0;
    virtual void PropertyProductImageHiresUri(std::string& aProductImageHiresUri) const = 0;
    virtual void SetPropertyStandbyChanged(Functor& aStandbyChanged) = 0;
    virtual void PropertyStandby(bool& aStandby) const = 0;
    virtual void SetPropertyStandbyTransitioningChanged(Functor& aStandbyTransitioningChanged) = 0;
    virtual void PropertyStandbyTransitioning(bool& aStandbyTransitioning) const = 0;
...
/**
 * Proxy for av.openhome.org:Product:4
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgProduct4Cpp : public ICpProxyAvOpenhomeOrgProduct4Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgProduct4Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    ~CpProxyAvOpenhomeOrgProduct4Cpp();
     ...
     */
    void SyncProduct(std::string& aRoom, std::string& aName, std::string& aInfo, std::string& aUrl, std::string& aImageUri, std::string& aImageHiresUri);
    /**
     * Invoke the action asynchronously.
     * Returns immediately and will run the client-specified callback when the action
     * later completes.  Any output arguments can then be retrieved by calling
     ...
     * @param[out] aImageHiresUri
     */
    void EndProduct(IAsync& aAsync, std::string& aRoom, std::string& aName, std::string& aInfo, std::string& aUrl, std::string& aImageUri, std::string& aImageHiresUri);
     ...
     * @param[out] aValue
     */
    void SyncStandbyTransitioning(bool& aValue);
    /**
     * Invoke the action asynchronously.
     * Returns immediately and will run the client-specified callback when the action
     * later completes.  Any output arguments can then be retrieved by calling
     * EndStandbyTransitioning().
     *
     * @param[in] aFunctor   Callback to run when the action completes.
     *                       This is guaranteed to be run but may indicate an error
     */
     ...
     * @param[out] aValue
     */
    void EndStandbyTransitioning(IAsync& aAsync, bool& aValue);
     ...
     * @param[in]  aValue
     */
    void SyncSetSourceBySystemName(const std::string& aValue);
    /**
     * Invoke the action asynchronously.
     * Returns immediately and will run the client-specified callback when the action
     * later completes.  Any output arguments can then be retrieved by calling
     * EndSetSourceBySystemName().
     *
     * @param[in] aValue
     * @param[in] aFunctor   Callback to run when the action completes.
     *                       This is guaranteed to be run but may indicate an error
     */
    void BeginSetSourceBySystemName(const std::string& aValue, FunctorAsync& aFunctor);
    /**
     * Retrieve the output arguments from an asynchronously invoked action.
     * This may only be called from the callback set in the above Begin function.
     *
     ...
     * @param[out] aImageUri
     */
    void SyncGetImageUri(const std::string& aResolution, std::string& aImageUri);
    /**
     * Invoke the action asynchronously.
     * Returns immediately and will run the client-specified callback when the action
     * later completes.  Any output arguments can then be retrieved by calling
     ...
     *                       This is guaranteed to be run but may indicate an error
     */
    void BeginGetImageUri(const std::string& aResolution, FunctorAsync& aFunctor);
    /**
     * Retrieve the output arguments from an asynchronously invoked action.
     * This may only be called from the callback set in the above Begin function.
     *
     ...
     * @param[out] aImageUri
     */
    void EndGetImageUri(IAsync& aAsync, std::string& aImageUri);

    /**
     * Set a callback to be run when the ManufacturerName state variable changes.
     *
     * Callbacks may be run in different threads but callbacks for a
     * CpProxyAvOpenhomeOrgProduct4Cpp instance will not overlap.
     *
    ...
    /**
     * Set a callback to be run when the ProductImageHiresUri state variable changes.
     *
     * Callbacks may be run in different threads but callbacks for a
     * CpProxyAvOpenhomeOrgProduct4Cpp instance will not overlap.
     *
    ...
    /**
     * Set a callback to be run when the StandbyTransitioning state variable changes.
     *
     * Callbacks may be run in different threads but callbacks for a
     * CpProxyAvOpenhomeOrgProduct4Cpp instance will not overlap.
     *
     ...
     * to Unsubscribe().
     *
     * @param[out] aProductImageHiresUri
     */
    void PropertyProductImageHiresUri(std::string& aProductImageHiresUri) const;
    /**
     ...
     * to Unsubscribe().
     *
     * @param[out] aStandbyTransitioning
     */
    void PropertyStandbyTransitioning(bool& aStandbyTransitioning) const;
    /**
...
#endif // HEADER_AVOPENHOMEORGPRODUCT4CPP
