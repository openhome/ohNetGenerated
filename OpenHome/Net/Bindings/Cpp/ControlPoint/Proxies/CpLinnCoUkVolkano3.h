#ifndef HEADER_LINNCOUKVOLKANO3CPP
#define HEADER_LINNCOUKVOLKANO3CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyLinnCoUkVolkano3Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyLinnCoUkVolkano3Cpp() {}
 ...
 * @ingroup Proxies
 */
class CpProxyLinnCoUkVolkano3Cpp : public ICpProxyLinnCoUkVolkano3Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyLinnCoUkVolkano3Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     * CpProxyLinnCoUkVolkano3Cpp instance will not overlap.
     *
...
#endif // HEADER_LINNCOUKVOLKANO3CPP
