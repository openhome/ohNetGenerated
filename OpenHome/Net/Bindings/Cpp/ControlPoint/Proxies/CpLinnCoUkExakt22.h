#ifndef HEADER_LINNCOUKEXAKT22CPP
#define HEADER_LINNCOUKEXAKT22CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyLinnCoUkExakt22Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyLinnCoUkExakt22Cpp() {}
    ...
    virtual void SyncGetTestTrackPlaying(bool& aTestTrackPlaying) = 0;
    virtual void BeginGetTestTrackPlaying(FunctorAsync& aFunctor) = 0;
    virtual void EndGetTestTrackPlaying(IAsync& aAsync, bool& aTestTrackPlaying) = 0;
    ...
    virtual void PropertyTestTrackPlaying(bool& aTestTrackPlaying) const = 0;
};
 ...
 * @ingroup Proxies
 */
class CpProxyLinnCoUkExakt22Cpp : public ICpProxyLinnCoUkExakt22Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyLinnCoUkExakt22Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     */
    void SyncGetTestTrackPlaying(bool& aTestTrackPlaying);
    /**
     * Invoke the action asynchronously.
     * Returns immediately and will run the client-specified callback when the action
     * later completes.  Any output arguments can then be retrieved by calling
     ...
     * @param[out] aTestTrackPlaying
     */
    void EndGetTestTrackPlaying(IAsync& aAsync, bool& aTestTrackPlaying);

    /**
     * Set a callback to be run when the DeviceList state variable changes.
     *
     * Callbacks may be run in different threads but callbacks for a
     * CpProxyLinnCoUkExakt22Cpp instance will not overlap.
     *
     ...
     * @param[out] aTestTrackPlaying
     */
    void PropertyTestTrackPlaying(bool& aTestTrackPlaying) const;
    /**
...
#endif // HEADER_LINNCOUKEXAKT22CPP
