#ifndef HEADER_AVOPENHOMEORGEXAKT4CPP
#define HEADER_AVOPENHOMEORGEXAKT4CPP
...
class PropertyUint;
class CpProxy;
class ICpProxyAvOpenhomeOrgExakt4Cpp : public ICpProxy
{
public:
    virtual ~ICpProxyAvOpenhomeOrgExakt4Cpp() {}
 ...
 * @ingroup Proxies
 */
class CpProxyAvOpenhomeOrgExakt4Cpp : public ICpProxyAvOpenhomeOrgExakt4Cpp
{
public:
    /**
     * Constructor.
     ...
     */
    CpProxyAvOpenhomeOrgExakt4Cpp(CpDeviceCpp& aDevice);
    /**
     * Destructor.
     ...
     * CpProxyAvOpenhomeOrgExakt4Cpp instance will not overlap.
     *
...
#endif // HEADER_AVOPENHOMEORGEXAKT4CPP
