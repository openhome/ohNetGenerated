...
{
    public interface IDvProviderAvOpenhomeOrgRadio2 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderAvOpenhomeOrgRadio2 : DvProvider, IDisposable, IDvProviderAvOpenhomeOrgRadio2
    {
        ...
        private ActionDelegate iDelegateRefreshPresets;
        ...
        protected DvProviderAvOpenhomeOrgRadio2(DvDevice aDevice)
            : base(aDevice, "av.openhome.org", "Radio", 2)
        {
        ...
        /// <summary>
        /// Signal that the action RefreshPresets is supported.
        /// </summary>
        /// <remarks>The action's availability will be published in the device's service.xml.
        /// RefreshPresets must be overridden if this is called.</remarks>
        protected void EnableActionRefreshPresets()
        {
            OpenHome.Net.Core.Action action = new OpenHome.Net.Core.Action("RefreshPresets");
            iDelegateRefreshPresets = new ActionDelegate(DoRefreshPresets);
            EnableAction(action, iDelegateRefreshPresets, GCHandle.ToIntPtr(iGch));
        }
        ...
        /// <summary>
        /// RefreshPresets action.
        /// </summary>
        /// <remarks>Will be called when the device stack receives an invocation of the
        /// RefreshPresets action for the owning device.
        ///
        /// Must be implemented iff EnableActionRefreshPresets was called.</remarks>
        /// <param name="aInvocation">Interface allowing querying of aspects of this particular action invocation.</param>
        protected virtual void RefreshPresets(IDvInvocation aInvocation)
        {
            throw (new ActionDisabledError());
        }
        ...
        private static int DoPlay(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderAvOpenhomeOrgRadio2 self = (DvProviderAvOpenhomeOrgRadio2)gch.Target;
        ...
        private static int DoChannel(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "Channel" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "Channel" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
        ...
        private static int DoSetChannel(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "SetChannel" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "SetChannel" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
        ...
        private static int DoId(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "Id" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "Id" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
        ...
        private static int DoSetId(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "SetId" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "SetId" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
        ...
        private static int DoIdArray(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "IdArray" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "IdArray" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
        ...
        private static int DoIdArrayChanged(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "IdArrayChanged" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "IdArrayChanged" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
        ...
        private static int DoChannelsMax(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "ChannelsMax" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "ChannelsMax" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
        ...
        private static int DoRefreshPresets(IntPtr aPtr, IntPtr aInvocation)
        {
            GCHandle gch = GCHandle.FromIntPtr(aPtr);
            DvProviderAvOpenhomeOrgRadio2 self = (DvProviderAvOpenhomeOrgRadio2)gch.Target;
            DvInvocation invocation = new DvInvocation(aInvocation);
            try
            {
                invocation.ReadStart();
                invocation.ReadEnd();
                self.RefreshPresets(invocation);
            }
            catch (ActionError e)
            {
                invocation.ReportActionError(e, "RefreshPresets");
                return -1;
            }
            catch (PropertyUpdateError)
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "RefreshPresets" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "RefreshPresets" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
        ...
        private static int DoProtocolInfo(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "ProtocolInfo" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "ProtocolInfo" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
