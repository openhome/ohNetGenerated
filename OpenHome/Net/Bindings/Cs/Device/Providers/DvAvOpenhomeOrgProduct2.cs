...
{
    public interface IDvProviderAvOpenhomeOrgProduct2 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderAvOpenhomeOrgProduct2 : DvProvider, IDisposable, IDvProviderAvOpenhomeOrgProduct2
    {
        ...
        protected DvProviderAvOpenhomeOrgProduct2(DvDevice aDevice)
            : base(aDevice, "av.openhome.org", "Product", 2)
        {
        ...
        private static int DoManufacturer(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderAvOpenhomeOrgProduct2 self = (DvProviderAvOpenhomeOrgProduct2)gch.Target;
