...
{
    public interface IDvProviderOpenhomeOrgOAuth1 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderOpenhomeOrgOAuth1 : DvProvider, IDisposable, IDvProviderOpenhomeOrgOAuth1
    {
        ...
        protected DvProviderOpenhomeOrgOAuth1(DvDevice aDevice)
            : base(aDevice, "openhome.org", "OAuth", 1)
        {
        ...
        private static int DoSetToken(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderOpenhomeOrgOAuth1 self = (DvProviderOpenhomeOrgOAuth1)gch.Target;
