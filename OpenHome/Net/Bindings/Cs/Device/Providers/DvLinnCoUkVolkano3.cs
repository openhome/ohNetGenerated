...
{
    public interface IDvProviderLinnCoUkVolkano3 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderLinnCoUkVolkano3 : DvProvider, IDisposable, IDvProviderLinnCoUkVolkano3
    {
        ...
        protected DvProviderLinnCoUkVolkano3(DvDevice aDevice)
            : base(aDevice, "linn.co.uk", "Volkano", 3)
        {
        ...
        private static int DoReboot(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderLinnCoUkVolkano3 self = (DvProviderLinnCoUkVolkano3)gch.Target;
