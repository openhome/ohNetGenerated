...
{
    public interface IDvProviderLinnCoUkExakt21 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderLinnCoUkExakt21 : DvProvider, IDisposable, IDvProviderLinnCoUkExakt21
    {
        ...
        protected DvProviderLinnCoUkExakt21(DvDevice aDevice)
            : base(aDevice, "linn.co.uk", "Exakt2", 1)
        {
        ...
        private static int DoGetDeviceList(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderLinnCoUkExakt21 self = (DvProviderLinnCoUkExakt21)gch.Target;
