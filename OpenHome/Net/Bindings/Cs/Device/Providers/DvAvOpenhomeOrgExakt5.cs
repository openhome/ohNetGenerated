...
{
    public interface IDvProviderAvOpenhomeOrgExakt5 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderAvOpenhomeOrgExakt5 : DvProvider, IDisposable, IDvProviderAvOpenhomeOrgExakt5
    {
        ...
        protected DvProviderAvOpenhomeOrgExakt5(DvDevice aDevice)
            : base(aDevice, "av.openhome.org", "Exakt", 5)
        {
        ...
        private static int DoDeviceList(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderAvOpenhomeOrgExakt5 self = (DvProviderAvOpenhomeOrgExakt5)gch.Target;
