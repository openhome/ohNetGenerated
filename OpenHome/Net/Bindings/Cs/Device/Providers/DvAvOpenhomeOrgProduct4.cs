...
{
    public interface IDvProviderAvOpenhomeOrgProduct4 : IDisposable
    {
        ...
        /// <param name="aValue">New value for the property</param>
        /// <returns>true if the value has been updated; false if aValue was the same as the previous value</returns>
        bool SetPropertyProductImageHiresUri(string aValue);

        /// <summary>
        /// Get a copy of the value of the ProductImageHiresUri property
        /// </summary>
        /// <returns>Value of the ProductImageHiresUri property.</param>
        ...
        /// <param name="aValue">New value for the property</param>
        /// <returns>true if the value has been updated; false if aValue was the same as the previous value</returns>
        bool SetPropertyStandbyTransitioning(bool aValue);

        /// <summary>
        /// Get a copy of the value of the StandbyTransitioning property
        /// </summary>
        /// <returns>Value of the StandbyTransitioning property.</param>
    ...
    /// </summary>
    public class DvProviderAvOpenhomeOrgProduct4 : DvProvider, IDisposable, IDvProviderAvOpenhomeOrgProduct4
    {
        ...
        private ActionDelegate iDelegateStandbyTransitioning;
        ...
        private ActionDelegate iDelegateSetSourceBySystemName;
        ...
        private ActionDelegate iDelegateGetImageUri;
        ...
        private PropertyString iPropertyProductImageHiresUri;
        private PropertyBool iPropertyStandby;
        private PropertyBool iPropertyStandbyTransitioning;
        ...
        protected DvProviderAvOpenhomeOrgProduct4(DvDevice aDevice)
            : base(aDevice, "av.openhome.org", "Product", 4)
        {
        ...
        /// </summary>
        public void EnablePropertyProductImageHiresUri()
        {
            List<String> allowedValues = new List<String>();
            iPropertyProductImageHiresUri = new PropertyString(new ParameterString("ProductImageHiresUri", allowedValues));
            AddProperty(iPropertyProductImageHiresUri);
        }
        ...
        /// </summary>
        public void EnablePropertyStandbyTransitioning()
        {
            iPropertyStandbyTransitioning = new PropertyBool(new ParameterBool("StandbyTransitioning"));
            AddProperty(iPropertyStandbyTransitioning);
        }
        ...
        /// Set the value of the ProductImageHiresUri property
        /// </summary>
        /// <remarks>Can only be called if EnablePropertyProductImageHiresUri has previously been called.</remarks>
        /// <param name="aValue">New value for the property</param>
        /// <returns>true if the value has been updated; false if aValue was the same as the previous value</returns>
        public bool SetPropertyProductImageHiresUri(string aValue)
        {
            if (iPropertyProductImageHiresUri == null)
                throw new PropertyDisabledError();
        ...
        public string PropertyProductImageHiresUri()
        {
            if (iPropertyProductImageHiresUri == null)
                throw new PropertyDisabledError();
            return iPropertyProductImageHiresUri.Value();
        }
        ...
        /// Set the value of the StandbyTransitioning property
        /// </summary>
        /// <remarks>Can only be called if EnablePropertyStandbyTransitioning has previously been called.</remarks>
        /// <param name="aValue">New value for the property</param>
        /// <returns>true if the value has been updated; false if aValue was the same as the previous value</returns>
        public bool SetPropertyStandbyTransitioning(bool aValue)
        {
            if (iPropertyStandbyTransitioning == null)
                throw new PropertyDisabledError();
        ...
        public bool PropertyStandbyTransitioning()
        {
            if (iPropertyStandbyTransitioning == null)
                throw new PropertyDisabledError();
            return iPropertyStandbyTransitioning.Value();
        }
        ...
        /// </summary>
        /// <remarks>The action's availability will be published in the device's service.xml.
        /// StandbyTransitioning must be overridden if this is called.</remarks>
        protected void EnableActionStandbyTransitioning()
        {
            OpenHome.Net.Core.Action action = new OpenHome.Net.Core.Action("StandbyTransitioning");
            action.AddOutputParameter(new ParameterRelated("Value", iPropertyStandbyTransitioning));
            iDelegateStandbyTransitioning = new ActionDelegate(DoStandbyTransitioning);
            EnableAction(action, iDelegateStandbyTransitioning, GCHandle.ToIntPtr(iGch));
        }
        ...
        /// </summary>
        /// <remarks>The action's availability will be published in the device's service.xml.
        /// SetSourceBySystemName must be overridden if this is called.</remarks>
        protected void EnableActionSetSourceBySystemName()
        {
            OpenHome.Net.Core.Action action = new OpenHome.Net.Core.Action("SetSourceBySystemName");
            List<String> allowedValues = new List<String>();
            action.AddInputParameter(new ParameterString("Value", allowedValues));
            iDelegateSetSourceBySystemName = new ActionDelegate(DoSetSourceBySystemName);
            EnableAction(action, iDelegateSetSourceBySystemName, GCHandle.ToIntPtr(iGch));
        }
        ...
        /// </summary>
        /// <remarks>The action's availability will be published in the device's service.xml.
        /// GetImageUri must be overridden if this is called.</remarks>
        protected void EnableActionGetImageUri()
        {
            OpenHome.Net.Core.Action action = new OpenHome.Net.Core.Action("GetImageUri");
            List<String> allowedValues = new List<String>();
            allowedValues.Add("Low");
            allowedValues.Add("High");
            action.AddInputParameter(new ParameterString("Resolution", allowedValues));
            allowedValues.Clear();
            action.AddOutputParameter(new ParameterRelated("ImageUri", iPropertyProductImageUri));
            iDelegateGetImageUri = new ActionDelegate(DoGetImageUri);
            EnableAction(action, iDelegateGetImageUri, GCHandle.ToIntPtr(iGch));
        }
        ...
        protected virtual void Product(IDvInvocation aInvocation, out string aRoom, out string aName, out string aInfo, out string aUrl, out string aImageUri, out string aImageHiresUri)
        {
            throw (new ActionDisabledError());
        }
        ...
        ///
        /// Must be implemented iff EnableActionStandbyTransitioning was called.</remarks>
        /// <param name="aInvocation">Interface allowing querying of aspects of this particular action invocation.</param>
        /// <param name="aValue"></param>
        protected virtual void StandbyTransitioning(IDvInvocation aInvocation, out bool aValue)
        {
            throw (new ActionDisabledError());
        }
        ...
        ///
        /// Must be implemented iff EnableActionSetSourceBySystemName was called.</remarks>
        /// <param name="aInvocation">Interface allowing querying of aspects of this particular action invocation.</param>
        /// <param name="aValue"></param>
        protected virtual void SetSourceBySystemName(IDvInvocation aInvocation, string aValue)
        {
            throw (new ActionDisabledError());
        }
        ...
        ///
        /// Must be implemented iff EnableActionGetImageUri was called.</remarks>
        /// <param name="aInvocation">Interface allowing querying of aspects of this particular action invocation.</param>
        /// <param name="aResolution"></param>
        /// <param name="aImageUri"></param>
        protected virtual void GetImageUri(IDvInvocation aInvocation, string aResolution, out string aImageUri)
        {
            throw (new ActionDisabledError());
        }
        ...
        private static int DoManufacturer(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderAvOpenhomeOrgProduct4 self = (DvProviderAvOpenhomeOrgProduct4)gch.Target;
        ...
        private static int DoProduct(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            string url;
            string imageUri;
            string imageHiresUri;
            try
            {
                invocation.ReadStart();
                invocation.ReadEnd();
                self.Product(invocation, out room, out name, out info, out url, out imageUri, out imageHiresUri);
            }
            catch (ActionError e)
            {
            ...
            try
            {
                ...
                invocation.WriteString("Url", url);
                invocation.WriteString("ImageUri", imageUri);
                invocation.WriteString("ImageHiresUri", imageHiresUri);
                invocation.WriteEnd();
            }
            catch (ActionError)
            {
        ...
        private static int DoStandbyTransitioning(IntPtr aPtr, IntPtr aInvocation)
        {
            GCHandle gch = GCHandle.FromIntPtr(aPtr);
            DvProviderAvOpenhomeOrgProduct4 self = (DvProviderAvOpenhomeOrgProduct4)gch.Target;
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            try
            {
                invocation.ReadStart();
                invocation.ReadEnd();
                self.StandbyTransitioning(invocation, out value);
            }
            catch (ActionError e)
            {
                invocation.ReportActionError(e, "StandbyTransitioning");
                return -1;
            }
            catch (PropertyUpdateError)
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "StandbyTransitioning" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "StandbyTransitioning" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
        ...
        private static int DoSetSourceBySystemName(IntPtr aPtr, IntPtr aInvocation)
        {
            GCHandle gch = GCHandle.FromIntPtr(aPtr);
            DvProviderAvOpenhomeOrgProduct4 self = (DvProviderAvOpenhomeOrgProduct4)gch.Target;
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            try
            {
                ...
                value = invocation.ReadString("Value");
                invocation.ReadEnd();
                self.SetSourceBySystemName(invocation, value);
            }
            catch (ActionError e)
            {
                invocation.ReportActionError(e, "SetSourceBySystemName");
                return -1;
            }
            catch (PropertyUpdateError)
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "SetSourceBySystemName" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "SetSourceBySystemName" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
        ...
        private static int DoGetImageUri(IntPtr aPtr, IntPtr aInvocation)
        {
            GCHandle gch = GCHandle.FromIntPtr(aPtr);
            DvProviderAvOpenhomeOrgProduct4 self = (DvProviderAvOpenhomeOrgProduct4)gch.Target;
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            {
                invocation.ReadStart();
                resolution = invocation.ReadString("Resolution");
                invocation.ReadEnd();
                self.GetImageUri(invocation, resolution, out imageUri);
            }
            catch (ActionError e)
            {
                invocation.ReportActionError(e, "GetImageUri");
                return -1;
            }
            catch (PropertyUpdateError)
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "GetImageUri" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "GetImageUri" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
