...
{
    public interface IDvProviderAvOpenhomeOrgExakt3 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderAvOpenhomeOrgExakt3 : DvProvider, IDisposable, IDvProviderAvOpenhomeOrgExakt3
    {
        ...
        protected DvProviderAvOpenhomeOrgExakt3(DvDevice aDevice)
            : base(aDevice, "av.openhome.org", "Exakt", 3)
        {
