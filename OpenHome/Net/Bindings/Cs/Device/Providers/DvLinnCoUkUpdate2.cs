...
{
    public interface IDvProviderLinnCoUkUpdate2 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderLinnCoUkUpdate2 : DvProvider, IDisposable, IDvProviderLinnCoUkUpdate2
    {
        ...
        protected DvProviderLinnCoUkUpdate2(DvDevice aDevice)
            : base(aDevice, "linn.co.uk", "Update", 2)
        {
        ...
        private static int DoPushManifest(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderLinnCoUkUpdate2 self = (DvProviderLinnCoUkUpdate2)gch.Target;
