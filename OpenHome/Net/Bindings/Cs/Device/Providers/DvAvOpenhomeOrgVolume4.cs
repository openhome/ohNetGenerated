...
{
    public interface IDvProviderAvOpenhomeOrgVolume4 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderAvOpenhomeOrgVolume4 : DvProvider, IDisposable, IDvProviderAvOpenhomeOrgVolume4
    {
        ...
        private ActionDelegate iDelegateSetVolumeNoUnmute;
        private ActionDelegate iDelegateVolumeIncNoUnmute;
        private ActionDelegate iDelegateVolumeDecNoUnmute;
        ...
        protected DvProviderAvOpenhomeOrgVolume4(DvDevice aDevice)
            : base(aDevice, "av.openhome.org", "Volume", 4)
        {
        ...
        /// </summary>
        /// <remarks>The action's availability will be published in the device's service.xml.
        /// SetVolumeNoUnmute must be overridden if this is called.</remarks>
        protected void EnableActionSetVolumeNoUnmute()
        {
            OpenHome.Net.Core.Action action = new OpenHome.Net.Core.Action("SetVolumeNoUnmute");
            action.AddInputParameter(new ParameterRelated("Value", iPropertyVolume));
            iDelegateSetVolumeNoUnmute = new ActionDelegate(DoSetVolumeNoUnmute);
            EnableAction(action, iDelegateSetVolumeNoUnmute, GCHandle.ToIntPtr(iGch));
        }
        ...
        /// </summary>
        /// <remarks>The action's availability will be published in the device's service.xml.
        /// VolumeIncNoUnmute must be overridden if this is called.</remarks>
        protected void EnableActionVolumeIncNoUnmute()
        {
            OpenHome.Net.Core.Action action = new OpenHome.Net.Core.Action("VolumeIncNoUnmute");
            iDelegateVolumeIncNoUnmute = new ActionDelegate(DoVolumeIncNoUnmute);
            EnableAction(action, iDelegateVolumeIncNoUnmute, GCHandle.ToIntPtr(iGch));
        }
        ...
        /// </summary>
        /// <remarks>The action's availability will be published in the device's service.xml.
        /// VolumeDecNoUnmute must be overridden if this is called.</remarks>
        protected void EnableActionVolumeDecNoUnmute()
        {
            OpenHome.Net.Core.Action action = new OpenHome.Net.Core.Action("VolumeDecNoUnmute");
            iDelegateVolumeDecNoUnmute = new ActionDelegate(DoVolumeDecNoUnmute);
            EnableAction(action, iDelegateVolumeDecNoUnmute, GCHandle.ToIntPtr(iGch));
        }
        ...
        ///
        /// Must be implemented iff EnableActionSetVolumeNoUnmute was called.</remarks>
        /// <param name="aInvocation">Interface allowing querying of aspects of this particular action invocation.</param>
        /// <param name="aValue"></param>
        protected virtual void SetVolumeNoUnmute(IDvInvocation aInvocation, uint aValue)
        {
            throw (new ActionDisabledError());
        }
        ...
        ///
        /// Must be implemented iff EnableActionVolumeIncNoUnmute was called.</remarks>
        /// <param name="aInvocation">Interface allowing querying of aspects of this particular action invocation.</param>
        protected virtual void VolumeIncNoUnmute(IDvInvocation aInvocation)
        {
            throw (new ActionDisabledError());
        }
        ...
        ///
        /// Must be implemented iff EnableActionVolumeDecNoUnmute was called.</remarks>
        /// <param name="aInvocation">Interface allowing querying of aspects of this particular action invocation.</param>
        protected virtual void VolumeDecNoUnmute(IDvInvocation aInvocation)
        {
            throw (new ActionDisabledError());
        }
        ...
        private static int DoCharacteristics(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderAvOpenhomeOrgVolume4 self = (DvProviderAvOpenhomeOrgVolume4)gch.Target;
        ...
        private static int DoSetVolumeNoUnmute(IntPtr aPtr, IntPtr aInvocation)
        {
            GCHandle gch = GCHandle.FromIntPtr(aPtr);
            DvProviderAvOpenhomeOrgVolume4 self = (DvProviderAvOpenhomeOrgVolume4)gch.Target;
            DvInvocation invocation = new DvInvocation(aInvocation);
            ...
            try
            {
                ...
                value = invocation.ReadUint("Value");
                invocation.ReadEnd();
                self.SetVolumeNoUnmute(invocation, value);
            }
            catch (ActionError e)
            {
                invocation.ReportActionError(e, "SetVolumeNoUnmute");
                return -1;
            }
            catch (PropertyUpdateError)
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "SetVolumeNoUnmute" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "SetVolumeNoUnmute" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
        ...
        private static int DoVolumeIncNoUnmute(IntPtr aPtr, IntPtr aInvocation)
        {
            GCHandle gch = GCHandle.FromIntPtr(aPtr);
            DvProviderAvOpenhomeOrgVolume4 self = (DvProviderAvOpenhomeOrgVolume4)gch.Target;
            DvInvocation invocation = new DvInvocation(aInvocation);
            try
            {
                invocation.ReadStart();
                invocation.ReadEnd();
                self.VolumeIncNoUnmute(invocation);
            }
            catch (ActionError e)
            {
                invocation.ReportActionError(e, "VolumeIncNoUnmute");
                return -1;
            }
            catch (PropertyUpdateError)
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "VolumeIncNoUnmute" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "VolumeIncNoUnmute" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
        ...
        private static int DoVolumeDecNoUnmute(IntPtr aPtr, IntPtr aInvocation)
        {
            GCHandle gch = GCHandle.FromIntPtr(aPtr);
            DvProviderAvOpenhomeOrgVolume4 self = (DvProviderAvOpenhomeOrgVolume4)gch.Target;
            DvInvocation invocation = new DvInvocation(aInvocation);
            try
            {
                invocation.ReadStart();
                invocation.ReadEnd();
                self.VolumeDecNoUnmute(invocation);
            }
            catch (ActionError e)
            {
                invocation.ReportActionError(e, "VolumeDecNoUnmute");
                return -1;
            }
            catch (PropertyUpdateError)
            {
                invocation.ReportError(501, String.Format("Invalid value for property {0}", new object[] { "VolumeDecNoUnmute" }));
                return -1;
            }
            catch (Exception e)
            {
                System.Diagnostics.Debug.WriteLine("WARNING: unexpected exception {0} thrown by {1}", new object[] { e, "VolumeDecNoUnmute" });
                System.Diagnostics.Debug.WriteLine("         Only ActionError or PropertyUpdateError should be thrown by actions");
                return -1;
            }
            try
