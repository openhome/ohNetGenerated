...
{
    public interface IDvProviderLinnCoUkUpdate3 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderLinnCoUkUpdate3 : DvProvider, IDisposable, IDvProviderLinnCoUkUpdate3
    {
        ...
        protected DvProviderLinnCoUkUpdate3(DvDevice aDevice)
            : base(aDevice, "linn.co.uk", "Update", 3)
        {
        ...
        private static int DoPushManifest(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderLinnCoUkUpdate3 self = (DvProviderLinnCoUkUpdate3)gch.Target;
