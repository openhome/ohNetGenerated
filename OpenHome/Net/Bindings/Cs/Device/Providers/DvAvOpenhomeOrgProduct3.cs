...
{
    public interface IDvProviderAvOpenhomeOrgProduct3 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderAvOpenhomeOrgProduct3 : DvProvider, IDisposable, IDvProviderAvOpenhomeOrgProduct3
    {
        ...
        protected DvProviderAvOpenhomeOrgProduct3(DvDevice aDevice)
            : base(aDevice, "av.openhome.org", "Product", 3)
        {
        ...
        private static int DoManufacturer(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderAvOpenhomeOrgProduct3 self = (DvProviderAvOpenhomeOrgProduct3)gch.Target;
