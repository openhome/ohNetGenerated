...
{
    public interface IDvProviderAvOpenhomeOrgVolume2 : IDisposable
    {
    ...
    /// </summary>
    public class DvProviderAvOpenhomeOrgVolume2 : DvProvider, IDisposable, IDvProviderAvOpenhomeOrgVolume2
    {
        ...
        protected DvProviderAvOpenhomeOrgVolume2(DvDevice aDevice)
            : base(aDevice, "av.openhome.org", "Volume", 2)
        {
        ...
        private static int DoCharacteristics(IntPtr aPtr, IntPtr aInvocation)
        {
            ...
            DvProviderAvOpenhomeOrgVolume2 self = (DvProviderAvOpenhomeOrgVolume2)gch.Target;
