...
{
    public interface ICpProxyAvOpenhomeOrgVolume4 : ICpProxy, IDisposable
    {
        ...
        void SyncSetVolumeNoUnmute(uint aValue);
        void BeginSetVolumeNoUnmute(uint aValue, CpProxy.CallbackAsyncComplete aCallback);
        void EndSetVolumeNoUnmute(IntPtr aAsyncHandle);
        void SyncVolumeIncNoUnmute();
        void BeginVolumeIncNoUnmute(CpProxy.CallbackAsyncComplete aCallback);
        void EndVolumeIncNoUnmute(IntPtr aAsyncHandle);
        void SyncVolumeDecNoUnmute();
        void BeginVolumeDecNoUnmute(CpProxy.CallbackAsyncComplete aCallback);
        void EndVolumeDecNoUnmute(IntPtr aAsyncHandle);
    ...
    internal class SyncCharacteristicsAvOpenhomeOrgVolume4 : SyncProxyAction
    {
    ...
    internal class SyncSetVolumeAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncVolumeIncAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncVolumeDecAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncSetVolumeNoUnmuteAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncVolumeIncNoUnmuteAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncVolumeDecNoUnmuteAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncVolumeAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
        private uint iValue;
    ...
    internal class SyncSetBalanceAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncBalanceIncAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncBalanceDecAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncBalanceAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
        private int iValue;
    ...
    internal class SyncSetFadeAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncFadeIncAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncFadeDecAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncFadeAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
        private int iValue;
    ...
    internal class SyncSetMuteAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncMuteAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
        private bool iValue;
    ...
    internal class SyncVolumeLimitAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
        private uint iValue;
    ...
    internal class SyncUnityGainAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
        private bool iValue;
    ...
    internal class SyncVolumeOffsetAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncSetVolumeOffsetAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncTrimAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    internal class SyncSetTrimAvOpenhomeOrgVolume4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume4 iService;
    ...
    /// </summary>
    public class CpProxyAvOpenhomeOrgVolume4 : CpProxy, IDisposable, ICpProxyAvOpenhomeOrgVolume4
    {
        ...
        private OpenHome.Net.Core.Action iActionSetVolumeNoUnmute;
        private OpenHome.Net.Core.Action iActionVolumeIncNoUnmute;
        private OpenHome.Net.Core.Action iActionVolumeDecNoUnmute;
        ...
        public CpProxyAvOpenhomeOrgVolume4(ICpDevice aDevice)
            : base("av-openhome-org", "Volume", 4, aDevice)
        {
            ...
            iActionSetVolumeNoUnmute = new OpenHome.Net.Core.Action("SetVolumeNoUnmute");
            param = new ParameterUint("Value");
            iActionSetVolumeNoUnmute.AddInputParameter(param);

            iActionVolumeIncNoUnmute = new OpenHome.Net.Core.Action("VolumeIncNoUnmute");

            iActionVolumeDecNoUnmute = new OpenHome.Net.Core.Action("VolumeDecNoUnmute");
        ...
        /// <remarks>Returns immediately and will run the client-specified callback when the action
        /// later completes.  Any output arguments can then be retrieved by calling
        /// EndSetVolumeNoUnmute().</remarks>
        /// <param name="aValue"></param>
        /// <param name="aCallback">Delegate to run when the action completes.
        /// This is guaranteed to be run but may indicate an error</param>
        public void BeginSetVolumeNoUnmute(uint aValue, CallbackAsyncComplete aCallback)
        {
            Invocation invocation = iService.Invocation(iActionSetVolumeNoUnmute, aCallback);
            int inIndex = 0;
            invocation.AddInput(new ArgumentUint((ParameterUint)iActionSetVolumeNoUnmute.InputParameter(inIndex++), aValue));
            iService.InvokeAction(invocation);
        }
        ...
        /// <remarks>This may only be called from the callback set in the above Begin function.</remarks>
        /// <param name="aAsyncHandle">Argument passed to the delegate set in the above Begin function</param>
        public void EndSetVolumeNoUnmute(IntPtr aAsyncHandle)
        {
            uint code;
            string desc;
            if (Invocation.Error(aAsyncHandle, out code, out desc))
        ...
        public void SyncVolumeIncNoUnmute()
        {
            ...
            BeginVolumeIncNoUnmute(sync.AsyncComplete());
            sync.Wait();
            sync.ReportError();
        }
        ...
        /// <remarks>Returns immediately and will run the client-specified callback when the action
        /// later completes.  Any output arguments can then be retrieved by calling
        /// EndVolumeIncNoUnmute().</remarks>
        /// <param name="aCallback">Delegate to run when the action completes.
        /// This is guaranteed to be run but may indicate an error</param>
        public void BeginVolumeIncNoUnmute(CallbackAsyncComplete aCallback)
        {
            Invocation invocation = iService.Invocation(iActionVolumeIncNoUnmute, aCallback);
            iService.InvokeAction(invocation);
        }
        ...
        /// <remarks>This may only be called from the callback set in the above Begin function.</remarks>
        /// <param name="aAsyncHandle">Argument passed to the delegate set in the above Begin function</param>
        public void EndVolumeIncNoUnmute(IntPtr aAsyncHandle)
        {
            uint code;
            string desc;
            if (Invocation.Error(aAsyncHandle, out code, out desc))
        ...
        public void SyncVolumeDecNoUnmute()
        {
            ...
            BeginVolumeDecNoUnmute(sync.AsyncComplete());
            sync.Wait();
            sync.ReportError();
        }
        ...
        /// <remarks>Returns immediately and will run the client-specified callback when the action
        /// later completes.  Any output arguments can then be retrieved by calling
        /// EndVolumeDecNoUnmute().</remarks>
        /// <param name="aCallback">Delegate to run when the action completes.
        /// This is guaranteed to be run but may indicate an error</param>
        public void BeginVolumeDecNoUnmute(CallbackAsyncComplete aCallback)
        {
            Invocation invocation = iService.Invocation(iActionVolumeDecNoUnmute, aCallback);
            iService.InvokeAction(invocation);
        }
        ...
        /// <remarks>This may only be called from the callback set in the above Begin function.</remarks>
        /// <param name="aAsyncHandle">Argument passed to the delegate set in the above Begin function</param>
        public void EndVolumeDecNoUnmute(IntPtr aAsyncHandle)
        {
            uint code;
            string desc;
            if (Invocation.Error(aAsyncHandle, out code, out desc))
        ...
        /// CpProxyAvOpenhomeOrgVolume4 instance will not overlap.</remarks>
        ...
        public void Dispose()
        {
            ...
            iActionSetVolumeNoUnmute.Dispose();
            iActionVolumeIncNoUnmute.Dispose();
            iActionVolumeDecNoUnmute.Dispose();
