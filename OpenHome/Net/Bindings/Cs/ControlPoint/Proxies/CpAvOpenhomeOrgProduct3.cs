...
{
    public interface ICpProxyAvOpenhomeOrgProduct3 : ICpProxy, IDisposable
    {
    ...
    internal class SyncManufacturerAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;
        private String iName;
        private String iInfo;
        private String iUrl;
        private String iImageUri;

        public SyncManufacturerAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
        public String Name()
    ...
    internal class SyncModelAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;
        private String iName;
        private String iInfo;
        ...
        public SyncModelAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
        public String Name()
    ...
    internal class SyncProductAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;
        ...
        public SyncProductAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
        public String Room()
    ...
    internal class SyncStandbyAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;
        private bool iValue;

        public SyncStandbyAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
        public bool Value()
    ...
    internal class SyncStandbyTransitioningAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;
        private bool iValue;

        public SyncStandbyTransitioningAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
        public bool Value()
    ...
    internal class SyncSetStandbyAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;

        public SyncSetStandbyAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncSourceCountAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;
        private uint iValue;

        public SyncSourceCountAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
        public uint Value()
    ...
    internal class SyncSourceXmlAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;
        private String iValue;

        public SyncSourceXmlAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
        public String Value()
    ...
    internal class SyncSourceIndexAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;
        private uint iValue;

        public SyncSourceIndexAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
        public uint Value()
    ...
    internal class SyncSetSourceIndexAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;

        public SyncSetSourceIndexAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncSetSourceIndexByNameAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;

        public SyncSetSourceIndexByNameAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncSetSourceBySystemNameAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;

        public SyncSetSourceBySystemNameAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncSourceAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;
        ...
        public SyncSourceAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
    ...
    internal class SyncAttributesAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;
        private String iValue;

        public SyncAttributesAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
        public String Value()
    ...
    internal class SyncSourceXmlChangeCountAvOpenhomeOrgProduct3 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct3 iService;
        private uint iValue;

        public SyncSourceXmlChangeCountAvOpenhomeOrgProduct3(CpProxyAvOpenhomeOrgProduct3 aProxy)
        {
            iService = aProxy;
        }
        public uint Value()
    ...
    /// <summary>
    /// Proxy for the av.openhome.org:Product:3 UPnP service
    /// </summary>
    public class CpProxyAvOpenhomeOrgProduct3 : CpProxy, IDisposable, ICpProxyAvOpenhomeOrgProduct3
    {
        ...
        public CpProxyAvOpenhomeOrgProduct3(ICpDevice aDevice)
            : base("av-openhome-org", "Product", 3, aDevice)
        {
        ...
        {
            SyncManufacturerAvOpenhomeOrgProduct3 sync = new SyncManufacturerAvOpenhomeOrgProduct3(this);
        ...
        {
            SyncModelAvOpenhomeOrgProduct3 sync = new SyncModelAvOpenhomeOrgProduct3(this);
        ...
        {
            SyncProductAvOpenhomeOrgProduct3 sync = new SyncProductAvOpenhomeOrgProduct3(this);
        ...
        {
            SyncStandbyAvOpenhomeOrgProduct3 sync = new SyncStandbyAvOpenhomeOrgProduct3(this);
        ...
        {
            SyncStandbyTransitioningAvOpenhomeOrgProduct3 sync = new SyncStandbyTransitioningAvOpenhomeOrgProduct3(this);
        ...
        {
            SyncSetStandbyAvOpenhomeOrgProduct3 sync = new SyncSetStandbyAvOpenhomeOrgProduct3(this);
        ...
        {
            SyncSourceCountAvOpenhomeOrgProduct3 sync = new SyncSourceCountAvOpenhomeOrgProduct3(this);
        ...
        {
            SyncSourceXmlAvOpenhomeOrgProduct3 sync = new SyncSourceXmlAvOpenhomeOrgProduct3(this);
        ...
        {
            SyncSourceIndexAvOpenhomeOrgProduct3 sync = new SyncSourceIndexAvOpenhomeOrgProduct3(this);
        ...
        {
            SyncSetSourceIndexAvOpenhomeOrgProduct3 sync = new SyncSetSourceIndexAvOpenhomeOrgProduct3(this);
        ...
        {
            SyncSetSourceIndexByNameAvOpenhomeOrgProduct3 sync = new SyncSetSourceIndexByNameAvOpenhomeOrgProduct3(this);
        ...
        {
            SyncSetSourceBySystemNameAvOpenhomeOrgProduct3 sync = new SyncSetSourceBySystemNameAvOpenhomeOrgProduct3(this);
        ...
        {
            SyncSourceAvOpenhomeOrgProduct3 sync = new SyncSourceAvOpenhomeOrgProduct3(this);
        ...
        {
            SyncAttributesAvOpenhomeOrgProduct3 sync = new SyncAttributesAvOpenhomeOrgProduct3(this);
        ...
        {
            SyncSourceXmlChangeCountAvOpenhomeOrgProduct3 sync = new SyncSourceXmlChangeCountAvOpenhomeOrgProduct3(this);
        ...
        /// CpProxyAvOpenhomeOrgProduct3 instance will not overlap.</remarks>
