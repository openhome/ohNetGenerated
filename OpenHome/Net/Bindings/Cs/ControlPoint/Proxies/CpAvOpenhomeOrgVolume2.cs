...
{
    public interface ICpProxyAvOpenhomeOrgVolume2 : ICpProxy, IDisposable
    {
    ...
    internal class SyncCharacteristicsAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;
        ...
        public SyncCharacteristicsAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
    ...
    internal class SyncSetVolumeAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;

        public SyncSetVolumeAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncVolumeIncAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;

        public SyncVolumeIncAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncVolumeDecAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;

        public SyncVolumeDecAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncVolumeAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;
        private uint iValue;

        public SyncVolumeAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        public uint Value()
    ...
    internal class SyncSetBalanceAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;

        public SyncSetBalanceAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncBalanceIncAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;

        public SyncBalanceIncAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncBalanceDecAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;

        public SyncBalanceDecAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncBalanceAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;
        private int iValue;

        public SyncBalanceAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        public int Value()
    ...
    internal class SyncSetFadeAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;

        public SyncSetFadeAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncFadeIncAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;

        public SyncFadeIncAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncFadeDecAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;

        public SyncFadeDecAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncFadeAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;
        private int iValue;

        public SyncFadeAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        public int Value()
    ...
    internal class SyncSetMuteAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;

        public SyncSetMuteAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncMuteAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;
        private bool iValue;

        public SyncMuteAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        public bool Value()
    ...
    internal class SyncVolumeLimitAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;
        private uint iValue;

        public SyncVolumeLimitAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        public uint Value()
    ...
    internal class SyncUnityGainAvOpenhomeOrgVolume2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgVolume2 iService;
        private bool iValue;

        public SyncUnityGainAvOpenhomeOrgVolume2(CpProxyAvOpenhomeOrgVolume2 aProxy)
        {
            iService = aProxy;
        }
        public bool Value()
    ...
    /// <summary>
    /// Proxy for the av.openhome.org:Volume:2 UPnP service
    /// </summary>
    public class CpProxyAvOpenhomeOrgVolume2 : CpProxy, IDisposable, ICpProxyAvOpenhomeOrgVolume2
    {
        ...
        public CpProxyAvOpenhomeOrgVolume2(ICpDevice aDevice)
            : base("av-openhome-org", "Volume", 2, aDevice)
        {
        ...
        {
            SyncCharacteristicsAvOpenhomeOrgVolume2 sync = new SyncCharacteristicsAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncSetVolumeAvOpenhomeOrgVolume2 sync = new SyncSetVolumeAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncVolumeIncAvOpenhomeOrgVolume2 sync = new SyncVolumeIncAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncVolumeDecAvOpenhomeOrgVolume2 sync = new SyncVolumeDecAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncVolumeAvOpenhomeOrgVolume2 sync = new SyncVolumeAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncSetBalanceAvOpenhomeOrgVolume2 sync = new SyncSetBalanceAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncBalanceIncAvOpenhomeOrgVolume2 sync = new SyncBalanceIncAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncBalanceDecAvOpenhomeOrgVolume2 sync = new SyncBalanceDecAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncBalanceAvOpenhomeOrgVolume2 sync = new SyncBalanceAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncSetFadeAvOpenhomeOrgVolume2 sync = new SyncSetFadeAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncFadeIncAvOpenhomeOrgVolume2 sync = new SyncFadeIncAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncFadeDecAvOpenhomeOrgVolume2 sync = new SyncFadeDecAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncFadeAvOpenhomeOrgVolume2 sync = new SyncFadeAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncSetMuteAvOpenhomeOrgVolume2 sync = new SyncSetMuteAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncMuteAvOpenhomeOrgVolume2 sync = new SyncMuteAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncVolumeLimitAvOpenhomeOrgVolume2 sync = new SyncVolumeLimitAvOpenhomeOrgVolume2(this);
        ...
        {
            SyncUnityGainAvOpenhomeOrgVolume2 sync = new SyncUnityGainAvOpenhomeOrgVolume2(this);
        ...
        /// CpProxyAvOpenhomeOrgVolume2 instance will not overlap.</remarks>
