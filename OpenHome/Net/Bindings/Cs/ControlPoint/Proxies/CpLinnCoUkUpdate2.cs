...
{
    public interface ICpProxyLinnCoUkUpdate2 : ICpProxy, IDisposable
    {
    ...
    internal class SyncPushManifestLinnCoUkUpdate2 : SyncProxyAction
    {
    ...
    internal class SyncPushManifest2LinnCoUkUpdate2 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate2 iService;
        private uint iId;
    ...
    internal class SyncGetSoftwareStatusLinnCoUkUpdate2 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate2 iService;
    ...
    internal class SyncGetExecutorStatusLinnCoUkUpdate2 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate2 iService;
    ...
    internal class SyncGetJobStatusLinnCoUkUpdate2 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate2 iService;
    ...
    internal class SyncApplyLinnCoUkUpdate2 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate2 iService;
    ...
    internal class SyncApply2LinnCoUkUpdate2 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate2 iService;
        private uint iId;
    ...
    internal class SyncRecoverLinnCoUkUpdate2 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate2 iService;
    ...
    internal class SyncRecover2LinnCoUkUpdate2 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate2 iService;
        private uint iId;
    ...
    internal class SyncCheckNowLinnCoUkUpdate2 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate2 iService;
    ...
    /// </summary>
    public class CpProxyLinnCoUkUpdate2 : CpProxy, IDisposable, ICpProxyLinnCoUkUpdate2
    {
        ...
        public CpProxyLinnCoUkUpdate2(ICpDevice aDevice)
            : base("linn-co-uk", "Update", 2, aDevice)
        {
        ...
        /// CpProxyLinnCoUkUpdate2 instance will not overlap.</remarks>
