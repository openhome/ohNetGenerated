...
{
    public interface ICpProxyAvOpenhomeOrgExakt5 : ICpProxy, IDisposable
    {
    ...
    internal class SyncDeviceListAvOpenhomeOrgExakt5 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgExakt5 iService;
        private String iList;

        public SyncDeviceListAvOpenhomeOrgExakt5(CpProxyAvOpenhomeOrgExakt5 aProxy)
        {
            iService = aProxy;
        }
        public String List()
    ...
    internal class SyncDeviceSettingsAvOpenhomeOrgExakt5 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgExakt5 iService;
        private String iSettings;

        public SyncDeviceSettingsAvOpenhomeOrgExakt5(CpProxyAvOpenhomeOrgExakt5 aProxy)
        {
            iService = aProxy;
        }
    ...
    internal class SyncConnectionStatusAvOpenhomeOrgExakt5 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgExakt5 iService;
        private String iConnectionStatus;

        public SyncConnectionStatusAvOpenhomeOrgExakt5(CpProxyAvOpenhomeOrgExakt5 aProxy)
        {
            iService = aProxy;
        }
    ...
    internal class SyncSetAvOpenhomeOrgExakt5 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgExakt5 iService;

        public SyncSetAvOpenhomeOrgExakt5(CpProxyAvOpenhomeOrgExakt5 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncReprogramAvOpenhomeOrgExakt5 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgExakt5 iService;

        public SyncReprogramAvOpenhomeOrgExakt5(CpProxyAvOpenhomeOrgExakt5 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncReprogramFallbackAvOpenhomeOrgExakt5 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgExakt5 iService;

        public SyncReprogramFallbackAvOpenhomeOrgExakt5(CpProxyAvOpenhomeOrgExakt5 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncChannelMapAvOpenhomeOrgExakt5 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgExakt5 iService;
        private String iChannelMap;

        public SyncChannelMapAvOpenhomeOrgExakt5(CpProxyAvOpenhomeOrgExakt5 aProxy)
        {
            iService = aProxy;
        }
    ...
    internal class SyncSetChannelMapAvOpenhomeOrgExakt5 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgExakt5 iService;

        public SyncSetChannelMapAvOpenhomeOrgExakt5(CpProxyAvOpenhomeOrgExakt5 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncAudioChannelsAvOpenhomeOrgExakt5 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgExakt5 iService;
        private String iAudioChannels;

        public SyncAudioChannelsAvOpenhomeOrgExakt5(CpProxyAvOpenhomeOrgExakt5 aProxy)
        {
            iService = aProxy;
        }
    ...
    internal class SyncSetAudioChannelsAvOpenhomeOrgExakt5 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgExakt5 iService;

        public SyncSetAudioChannelsAvOpenhomeOrgExakt5(CpProxyAvOpenhomeOrgExakt5 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncVersionAvOpenhomeOrgExakt5 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgExakt5 iService;
        private String iVersion;

        public SyncVersionAvOpenhomeOrgExakt5(CpProxyAvOpenhomeOrgExakt5 aProxy)
        {
            iService = aProxy;
        }
    ...
    internal class SyncGetIntegratedDevicesPresentAvOpenhomeOrgExakt5 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgExakt5 iService;
        private bool iIntegratedDevicesPresent;

        public SyncGetIntegratedDevicesPresentAvOpenhomeOrgExakt5(CpProxyAvOpenhomeOrgExakt5 aProxy)
        {
            iService = aProxy;
        }
    ...
    internal class SyncBootIntegratedDevicesToFallbackAvOpenhomeOrgExakt5 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgExakt5 iService;

        public SyncBootIntegratedDevicesToFallbackAvOpenhomeOrgExakt5(CpProxyAvOpenhomeOrgExakt5 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncRebootAvOpenhomeOrgExakt5 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgExakt5 iService;

        public SyncRebootAvOpenhomeOrgExakt5(CpProxyAvOpenhomeOrgExakt5 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    /// <summary>
    /// Proxy for the av.openhome.org:Exakt:5 UPnP service
    /// </summary>
    public class CpProxyAvOpenhomeOrgExakt5 : CpProxy, IDisposable, ICpProxyAvOpenhomeOrgExakt5
    {
        ...
        public CpProxyAvOpenhomeOrgExakt5(ICpDevice aDevice)
            : base("av-openhome-org", "Exakt", 5, aDevice)
        {
        ...
        {
            SyncDeviceListAvOpenhomeOrgExakt5 sync = new SyncDeviceListAvOpenhomeOrgExakt5(this);
        ...
        {
            SyncDeviceSettingsAvOpenhomeOrgExakt5 sync = new SyncDeviceSettingsAvOpenhomeOrgExakt5(this);
        ...
        {
            SyncConnectionStatusAvOpenhomeOrgExakt5 sync = new SyncConnectionStatusAvOpenhomeOrgExakt5(this);
        ...
        {
            SyncSetAvOpenhomeOrgExakt5 sync = new SyncSetAvOpenhomeOrgExakt5(this);
        ...
        {
            SyncReprogramAvOpenhomeOrgExakt5 sync = new SyncReprogramAvOpenhomeOrgExakt5(this);
        ...
        {
            SyncReprogramFallbackAvOpenhomeOrgExakt5 sync = new SyncReprogramFallbackAvOpenhomeOrgExakt5(this);
        ...
        {
            SyncChannelMapAvOpenhomeOrgExakt5 sync = new SyncChannelMapAvOpenhomeOrgExakt5(this);
        ...
        {
            SyncSetChannelMapAvOpenhomeOrgExakt5 sync = new SyncSetChannelMapAvOpenhomeOrgExakt5(this);
        ...
        {
            SyncAudioChannelsAvOpenhomeOrgExakt5 sync = new SyncAudioChannelsAvOpenhomeOrgExakt5(this);
        ...
        {
            SyncSetAudioChannelsAvOpenhomeOrgExakt5 sync = new SyncSetAudioChannelsAvOpenhomeOrgExakt5(this);
        ...
        {
            SyncVersionAvOpenhomeOrgExakt5 sync = new SyncVersionAvOpenhomeOrgExakt5(this);
        ...
        {
            SyncGetIntegratedDevicesPresentAvOpenhomeOrgExakt5 sync = new SyncGetIntegratedDevicesPresentAvOpenhomeOrgExakt5(this);
        ...
        {
            SyncBootIntegratedDevicesToFallbackAvOpenhomeOrgExakt5 sync = new SyncBootIntegratedDevicesToFallbackAvOpenhomeOrgExakt5(this);
        ...
        {
            SyncRebootAvOpenhomeOrgExakt5 sync = new SyncRebootAvOpenhomeOrgExakt5(this);
        ...
        /// CpProxyAvOpenhomeOrgExakt5 instance will not overlap.</remarks>
