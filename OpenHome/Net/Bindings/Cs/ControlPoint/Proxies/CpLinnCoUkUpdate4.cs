...
{
    public interface ICpProxyLinnCoUkUpdate4 : ICpProxy, IDisposable
    {
        ...
        void BeginRecoverKeepStore(CpProxy.CallbackAsyncComplete aCallback);
        void EndRecoverKeepStore(IntPtr aAsyncHandle);
        void SyncRecoverKeepStore2(out uint aId);
        void BeginRecoverKeepStore2(CpProxy.CallbackAsyncComplete aCallback);
        void EndRecoverKeepStore2(IntPtr aAsyncHandle, out uint aId);
        void SyncCheckNow();
    ...
    internal class SyncPushManifestLinnCoUkUpdate4 : SyncProxyAction
    {
    ...
    internal class SyncPushManifest2LinnCoUkUpdate4 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate4 iService;
        private uint iId;
    ...
    internal class SyncGetSoftwareStatusLinnCoUkUpdate4 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate4 iService;
    ...
    internal class SyncGetExecutorStatusLinnCoUkUpdate4 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate4 iService;
    ...
    internal class SyncGetJobStatusLinnCoUkUpdate4 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate4 iService;
    ...
    internal class SyncApplyLinnCoUkUpdate4 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate4 iService;
    ...
    internal class SyncApply2LinnCoUkUpdate4 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate4 iService;
        private uint iId;
    ...
    internal class SyncRecoverLinnCoUkUpdate4 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate4 iService;
    ...
    internal class SyncRecover2LinnCoUkUpdate4 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate4 iService;
        private uint iId;
    ...
    internal class SyncRecoverKeepStoreLinnCoUkUpdate4 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate4 iService;
    ...
    internal class SyncRecoverKeepStore2LinnCoUkUpdate4 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate4 iService;
        private uint iId;
        ...
        protected override void CompleteRequest(IntPtr aAsyncHandle)
        {
            iService.EndRecoverKeepStore2(aAsyncHandle, out iId);
        }
    };

    internal class SyncCheckNowLinnCoUkUpdate4 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate4 iService;
    ...
    internal class SyncGetRecoverSupportedLinnCoUkUpdate4 : SyncProxyAction
    {
        private CpProxyLinnCoUkUpdate4 iService;
    ...
    /// </summary>
    public class CpProxyLinnCoUkUpdate4 : CpProxy, IDisposable, ICpProxyLinnCoUkUpdate4
    {
        ...
        private OpenHome.Net.Core.Action iActionRecoverKeepStore;
        private OpenHome.Net.Core.Action iActionRecoverKeepStore2;
        ...
        public CpProxyLinnCoUkUpdate4(ICpDevice aDevice)
            : base("linn-co-uk", "Update", 4, aDevice)
        {
            ...
            iActionRecoverKeepStore = new OpenHome.Net.Core.Action("RecoverKeepStore");

            iActionRecoverKeepStore2 = new OpenHome.Net.Core.Action("RecoverKeepStore2");
            param = new ParameterUint("Id");
        ...
        public void SyncRecoverKeepStore()
        {
            ...
            BeginRecoverKeepStore(sync.AsyncComplete());
            sync.Wait();
            sync.ReportError();
        }
        ...
        /// <remarks>Returns immediately and will run the client-specified callback when the action
        /// later completes.  Any output arguments can then be retrieved by calling
        /// EndRecoverKeepStore().</remarks>
        /// <param name="aCallback">Delegate to run when the action completes.
        /// This is guaranteed to be run but may indicate an error</param>
        public void BeginRecoverKeepStore(CallbackAsyncComplete aCallback)
        {
            Invocation invocation = iService.Invocation(iActionRecoverKeepStore, aCallback);
            iService.InvokeAction(invocation);
        }
        ...
        /// <remarks>This may only be called from the callback set in the above Begin function.</remarks>
        /// <param name="aAsyncHandle">Argument passed to the delegate set in the above Begin function</param>
        public void EndRecoverKeepStore(IntPtr aAsyncHandle)
        {
            uint code;
            string desc;
            if (Invocation.Error(aAsyncHandle, out code, out desc))
        ...
        /// on the device and sets any output arguments</remarks>
        /// <param name="aId"></param>
        public void SyncRecoverKeepStore2(out uint aId)
        {
            SyncRecoverKeepStore2LinnCoUkUpdate4 sync = new SyncRecoverKeepStore2LinnCoUkUpdate4(this);
            BeginRecoverKeepStore2(sync.AsyncComplete());
            sync.Wait();
            sync.ReportError();
            aId = sync.Id();
        }
        ...
        /// <remarks>Returns immediately and will run the client-specified callback when the action
        /// later completes.  Any output arguments can then be retrieved by calling
        /// EndRecoverKeepStore2().</remarks>
        /// <param name="aCallback">Delegate to run when the action completes.
        /// This is guaranteed to be run but may indicate an error</param>
        public void BeginRecoverKeepStore2(CallbackAsyncComplete aCallback)
        {
            Invocation invocation = iService.Invocation(iActionRecoverKeepStore2, aCallback);
            int outIndex = 0;
            invocation.AddOutput(new ArgumentUint((ParameterUint)iActionRecoverKeepStore2.OutputParameter(outIndex++)));
            iService.InvokeAction(invocation);
        }
        ...
        /// <param name="aAsyncHandle">Argument passed to the delegate set in the above Begin function</param>
        /// <param name="aId"></param>
        public void EndRecoverKeepStore2(IntPtr aAsyncHandle, out uint aId)
        {
            uint code;
            string desc;
            if (Invocation.Error(aAsyncHandle, out code, out desc))
        ...
        /// CpProxyLinnCoUkUpdate4 instance will not overlap.</remarks>
        ...
        public void Dispose()
        {
            ...
            iActionRecoverKeepStore.Dispose();
            iActionRecoverKeepStore2.Dispose();
