...
{
    public interface ICpProxyAvOpenhomeOrgProduct4 : ICpProxy, IDisposable
    {
        ...
        void SyncProduct(out String aRoom, out String aName, out String aInfo, out String aUrl, out String aImageUri, out String aImageHiresUri);
        void BeginProduct(CpProxy.CallbackAsyncComplete aCallback);
        void EndProduct(IntPtr aAsyncHandle, out String aRoom, out String aName, out String aInfo, out String aUrl, out String aImageUri, out String aImageHiresUri);
        ...
        void SyncStandbyTransitioning(out bool aValue);
        void BeginStandbyTransitioning(CpProxy.CallbackAsyncComplete aCallback);
        void EndStandbyTransitioning(IntPtr aAsyncHandle, out bool aValue);
        ...
        void SyncSetSourceBySystemName(String aValue);
        void BeginSetSourceBySystemName(String aValue, CpProxy.CallbackAsyncComplete aCallback);
        void EndSetSourceBySystemName(IntPtr aAsyncHandle);
        ...
        void SyncGetImageUri(String aResolution, out String aImageUri);
        void BeginGetImageUri(String aResolution, CpProxy.CallbackAsyncComplete aCallback);
        void EndGetImageUri(IntPtr aAsyncHandle, out String aImageUri);
        ...
        void SetPropertyProductImageHiresUriChanged(System.Action aProductImageHiresUriChanged);
        String PropertyProductImageHiresUri();
        void SetPropertyStandbyChanged(System.Action aStandbyChanged);
        bool PropertyStandby();
        void SetPropertyStandbyTransitioningChanged(System.Action aStandbyTransitioningChanged);
        bool PropertyStandbyTransitioning();
    ...
    internal class SyncManufacturerAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;
        private String iName;
        private String iInfo;
        private String iUrl;
        private String iImageUri;

        public SyncManufacturerAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        public String Name()
    ...
    internal class SyncModelAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;
        private String iName;
        private String iInfo;
        ...
        public SyncModelAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        public String Name()
    ...
    internal class SyncProductAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;
        ...
        private String iUrl;
        private String iImageUri;
        private String iImageHiresUri;

        public SyncProductAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        public String Room()
        ...
        public String ImageHiresUri()
        {
            return iImageHiresUri;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
        {
            iService.EndProduct(aAsyncHandle, out iRoom, out iName, out iInfo, out iUrl, out iImageUri, out iImageHiresUri);
        }
    };

    internal class SyncStandbyAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;
        private bool iValue;

        public SyncStandbyAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        public bool Value()
    ...
    internal class SyncStandbyTransitioningAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;
        private bool iValue;

        public SyncStandbyTransitioningAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        public bool Value()
        ...
        protected override void CompleteRequest(IntPtr aAsyncHandle)
        {
            iService.EndStandbyTransitioning(aAsyncHandle, out iValue);
        }
    };

    internal class SyncSetStandbyAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;

        public SyncSetStandbyAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncSourceCountAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;
        private uint iValue;

        public SyncSourceCountAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        public uint Value()
    ...
    internal class SyncSourceXmlAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;
        private String iValue;

        public SyncSourceXmlAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        public String Value()
    ...
    internal class SyncSourceIndexAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;
        private uint iValue;

        public SyncSourceIndexAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        public uint Value()
    ...
    internal class SyncSetSourceIndexAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;

        public SyncSetSourceIndexAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncSetSourceIndexByNameAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;

        public SyncSetSourceIndexByNameAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncSetSourceBySystemNameAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;

        public SyncSetSourceBySystemNameAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
        {
            iService.EndSetSourceBySystemName(aAsyncHandle);
        }
    };

    internal class SyncSourceAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;
        ...
        public SyncSourceAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
    ...
    internal class SyncAttributesAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;
        private String iValue;

        public SyncAttributesAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        public String Value()
    ...
    internal class SyncSourceXmlChangeCountAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;
        private uint iValue;

        public SyncSourceXmlChangeCountAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        public uint Value()
    ...
    internal class SyncGetImageUriAvOpenhomeOrgProduct4 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgProduct4 iService;
        private String iImageUri;

        public SyncGetImageUriAvOpenhomeOrgProduct4(CpProxyAvOpenhomeOrgProduct4 aProxy)
        {
            iService = aProxy;
        }
        public String ImageUri()
        ...
        protected override void CompleteRequest(IntPtr aAsyncHandle)
        {
            iService.EndGetImageUri(aAsyncHandle, out iImageUri);
        }
    };

    /// <summary>
    /// Proxy for the av.openhome.org:Product:4 UPnP service
    /// </summary>
    public class CpProxyAvOpenhomeOrgProduct4 : CpProxy, IDisposable, ICpProxyAvOpenhomeOrgProduct4
    {
        ...
        private OpenHome.Net.Core.Action iActionStandbyTransitioning;
        ...
        private OpenHome.Net.Core.Action iActionSetSourceBySystemName;
        ...
        private OpenHome.Net.Core.Action iActionGetImageUri;
        ...
        private PropertyString iProductImageHiresUri;
        private PropertyBool iStandby;
        private PropertyBool iStandbyTransitioning;
        ...
        private System.Action iProductImageHiresUriChanged;
        private System.Action iStandbyChanged;
        private System.Action iStandbyTransitioningChanged;
        ...
        public CpProxyAvOpenhomeOrgProduct4(ICpDevice aDevice)
            : base("av-openhome-org", "Product", 4, aDevice)
        {
            ...
            param = new ParameterString("ImageUri", allowedValues);
            iActionProduct.AddOutputParameter(param);
            param = new ParameterString("ImageHiresUri", allowedValues);
            iActionProduct.AddOutputParameter(param);
            ...
            iActionStandbyTransitioning = new OpenHome.Net.Core.Action("StandbyTransitioning");
            param = new ParameterBool("Value");
            ...
            iActionSetSourceBySystemName = new OpenHome.Net.Core.Action("SetSourceBySystemName");
            param = new ParameterString("Value", allowedValues);
            ...
            iActionGetImageUri = new OpenHome.Net.Core.Action("GetImageUri");
            allowedValues.Add("Low");
            allowedValues.Add("High");
            param = new ParameterString("Resolution", allowedValues);
            ...
            iProductImageHiresUri = new PropertyString("ProductImageHiresUri", ProductImageHiresUriPropertyChanged);
            AddProperty(iProductImageHiresUri);
            iStandby = new PropertyBool("Standby", StandbyPropertyChanged);
            AddProperty(iStandby);
            iStandbyTransitioning = new PropertyBool("StandbyTransitioning", StandbyTransitioningPropertyChanged);
        ...
        {
            SyncManufacturerAvOpenhomeOrgProduct4 sync = new SyncManufacturerAvOpenhomeOrgProduct4(this);
        ...
        {
            SyncModelAvOpenhomeOrgProduct4 sync = new SyncModelAvOpenhomeOrgProduct4(this);
        ...
        /// <param name="aUrl"></param>
        /// <param name="aImageUri"></param>
        /// <param name="aImageHiresUri"></param>
        public void SyncProduct(out String aRoom, out String aName, out String aInfo, out String aUrl, out String aImageUri, out String aImageHiresUri)
        {
            SyncProductAvOpenhomeOrgProduct4 sync = new SyncProductAvOpenhomeOrgProduct4(this);
            ...
            aUrl = sync.Url();
            aImageUri = sync.ImageUri();
            aImageHiresUri = sync.ImageHiresUri();
        }
        ...
        /// <param name="aImageUri"></param>
        /// <param name="aImageHiresUri"></param>
        public void EndProduct(IntPtr aAsyncHandle, out String aRoom, out String aName, out String aInfo, out String aUrl, out String aImageUri, out String aImageHiresUri)
        {
            uint code;
            string desc;
            if (Invocation.Error(aAsyncHandle, out code, out desc))
            ...
            aUrl = Invocation.OutputString(aAsyncHandle, index++);
            aImageUri = Invocation.OutputString(aAsyncHandle, index++);
            aImageHiresUri = Invocation.OutputString(aAsyncHandle, index++);
        }
        ...
        {
            SyncStandbyAvOpenhomeOrgProduct4 sync = new SyncStandbyAvOpenhomeOrgProduct4(this);
        ...
        /// on the device and sets any output arguments</remarks>
        /// <param name="aValue"></param>
        public void SyncStandbyTransitioning(out bool aValue)
        {
            SyncStandbyTransitioningAvOpenhomeOrgProduct4 sync = new SyncStandbyTransitioningAvOpenhomeOrgProduct4(this);
            BeginStandbyTransitioning(sync.AsyncComplete());
            sync.Wait();
            sync.ReportError();
            aValue = sync.Value();
        }
        ...
        /// <remarks>Returns immediately and will run the client-specified callback when the action
        /// later completes.  Any output arguments can then be retrieved by calling
        /// EndStandbyTransitioning().</remarks>
        /// <param name="aCallback">Delegate to run when the action completes.
        /// This is guaranteed to be run but may indicate an error</param>
        public void BeginStandbyTransitioning(CallbackAsyncComplete aCallback)
        {
            Invocation invocation = iService.Invocation(iActionStandbyTransitioning, aCallback);
            int outIndex = 0;
            invocation.AddOutput(new ArgumentBool((ParameterBool)iActionStandbyTransitioning.OutputParameter(outIndex++)));
            iService.InvokeAction(invocation);
        }
        ...
        /// <param name="aAsyncHandle">Argument passed to the delegate set in the above Begin function</param>
        /// <param name="aValue"></param>
        public void EndStandbyTransitioning(IntPtr aAsyncHandle, out bool aValue)
        {
            uint code;
            string desc;
            if (Invocation.Error(aAsyncHandle, out code, out desc))
        ...
        {
            SyncSetStandbyAvOpenhomeOrgProduct4 sync = new SyncSetStandbyAvOpenhomeOrgProduct4(this);
        ...
        {
            SyncSourceCountAvOpenhomeOrgProduct4 sync = new SyncSourceCountAvOpenhomeOrgProduct4(this);
        ...
        {
            SyncSourceXmlAvOpenhomeOrgProduct4 sync = new SyncSourceXmlAvOpenhomeOrgProduct4(this);
        ...
        {
            SyncSourceIndexAvOpenhomeOrgProduct4 sync = new SyncSourceIndexAvOpenhomeOrgProduct4(this);
        ...
        {
            SyncSetSourceIndexAvOpenhomeOrgProduct4 sync = new SyncSetSourceIndexAvOpenhomeOrgProduct4(this);
        ...
        {
            SyncSetSourceIndexByNameAvOpenhomeOrgProduct4 sync = new SyncSetSourceIndexByNameAvOpenhomeOrgProduct4(this);
        ...
        /// on the device and sets any output arguments</remarks>
        /// <param name="aValue"></param>
        public void SyncSetSourceBySystemName(String aValue)
        {
            SyncSetSourceBySystemNameAvOpenhomeOrgProduct4 sync = new SyncSetSourceBySystemNameAvOpenhomeOrgProduct4(this);
            BeginSetSourceBySystemName(aValue, sync.AsyncComplete());
            sync.Wait();
            sync.ReportError();
        }
        ...
        /// <remarks>Returns immediately and will run the client-specified callback when the action
        /// later completes.  Any output arguments can then be retrieved by calling
        /// EndSetSourceBySystemName().</remarks>
        /// <param name="aValue"></param>
        /// <param name="aCallback">Delegate to run when the action completes.
        /// This is guaranteed to be run but may indicate an error</param>
        public void BeginSetSourceBySystemName(String aValue, CallbackAsyncComplete aCallback)
        {
            Invocation invocation = iService.Invocation(iActionSetSourceBySystemName, aCallback);
            int inIndex = 0;
            invocation.AddInput(new ArgumentString((ParameterString)iActionSetSourceBySystemName.InputParameter(inIndex++), aValue));
            iService.InvokeAction(invocation);
        }
        ...
        /// <remarks>This may only be called from the callback set in the above Begin function.</remarks>
        /// <param name="aAsyncHandle">Argument passed to the delegate set in the above Begin function</param>
        public void EndSetSourceBySystemName(IntPtr aAsyncHandle)
        {
            uint code;
            string desc;
            if (Invocation.Error(aAsyncHandle, out code, out desc))
        ...
        {
            SyncSourceAvOpenhomeOrgProduct4 sync = new SyncSourceAvOpenhomeOrgProduct4(this);
        ...
        {
            SyncAttributesAvOpenhomeOrgProduct4 sync = new SyncAttributesAvOpenhomeOrgProduct4(this);
        ...
        {
            SyncSourceXmlChangeCountAvOpenhomeOrgProduct4 sync = new SyncSourceXmlChangeCountAvOpenhomeOrgProduct4(this);
        ...
        /// <param name="aImageUri"></param>
        public void SyncGetImageUri(String aResolution, out String aImageUri)
        {
            SyncGetImageUriAvOpenhomeOrgProduct4 sync = new SyncGetImageUriAvOpenhomeOrgProduct4(this);
            BeginGetImageUri(aResolution, sync.AsyncComplete());
            sync.Wait();
            sync.ReportError();
            aImageUri = sync.ImageUri();
        }
        ...
        /// <remarks>Returns immediately and will run the client-specified callback when the action
        /// later completes.  Any output arguments can then be retrieved by calling
        /// EndGetImageUri().</remarks>
        /// <param name="aResolution"></param>
        /// <param name="aCallback">Delegate to run when the action completes.
        /// This is guaranteed to be run but may indicate an error</param>
        public void BeginGetImageUri(String aResolution, CallbackAsyncComplete aCallback)
        {
            Invocation invocation = iService.Invocation(iActionGetImageUri, aCallback);
            int inIndex = 0;
            invocation.AddInput(new ArgumentString((ParameterString)iActionGetImageUri.InputParameter(inIndex++), aResolution));
            int outIndex = 0;
            invocation.AddOutput(new ArgumentString((ParameterString)iActionGetImageUri.OutputParameter(outIndex++)));
            iService.InvokeAction(invocation);
        }
        ...
        /// <param name="aAsyncHandle">Argument passed to the delegate set in the above Begin function</param>
        /// <param name="aImageUri"></param>
        public void EndGetImageUri(IntPtr aAsyncHandle, out String aImageUri)
        {
            uint code;
            string desc;
            if (Invocation.Error(aAsyncHandle, out code, out desc))
        ...
        /// CpProxyAvOpenhomeOrgProduct4 instance will not overlap.</remarks>
        ...
        /// <summary>
        /// Set a delegate to be run when the ProductImageHiresUri state variable changes.
        /// </summary>
        /// <remarks>Callbacks may be run in different threads but callbacks for a
        /// CpProxyAvOpenhomeOrgProduct4 instance will not overlap.</remarks>
        /// <param name="aProductImageHiresUriChanged">The delegate to run when the state variable changes</param>
        public void SetPropertyProductImageHiresUriChanged(System.Action aProductImageHiresUriChanged)
        {
            lock (iPropertyLock)
            {
                iProductImageHiresUriChanged = aProductImageHiresUriChanged;
            }
        }

        private void ProductImageHiresUriPropertyChanged()
        {
            lock (iPropertyLock)
            {
        ...
        /// <summary>
        /// Set a delegate to be run when the StandbyTransitioning state variable changes.
        /// </summary>
        /// <remarks>Callbacks may be run in different threads but callbacks for a
        /// CpProxyAvOpenhomeOrgProduct4 instance will not overlap.</remarks>
        /// <param name="aStandbyTransitioningChanged">The delegate to run when the state variable changes</param>
        public void SetPropertyStandbyTransitioningChanged(System.Action aStandbyTransitioningChanged)
        {
            lock (iPropertyLock)
            {
                iStandbyTransitioningChanged = aStandbyTransitioningChanged;
            }
        }

        private void StandbyTransitioningPropertyChanged()
        {
            lock (iPropertyLock)
            {
        ...
        /// <summary>
        /// Query the value of the ProductImageHiresUri property.
        /// </summary>
        /// <remarks>This function is threadsafe and can only be called if Subscribe() has been
        /// called and a first eventing callback received more recently than any call
        /// to Unsubscribe().</remarks>
        /// <returns>Value of the ProductImageHiresUri property</returns>
        public String PropertyProductImageHiresUri()
        {
            PropertyReadLock();
            String val;
            try
            {
                val = iProductImageHiresUri.Value();
            }
            finally
            {
                PropertyReadUnlock();
        ...
        /// <summary>
        /// Query the value of the StandbyTransitioning property.
        /// </summary>
        /// <remarks>This function is threadsafe and can only be called if Subscribe() has been
        /// called and a first eventing callback received more recently than any call
        /// to Unsubscribe().</remarks>
        /// <returns>Value of the StandbyTransitioning property</returns>
        public bool PropertyStandbyTransitioning()
        {
            PropertyReadLock();
            bool val;
            try
            {
                val = iStandbyTransitioning.Value();
            }
            finally
            {
                PropertyReadUnlock();
        ...
        public void Dispose()
        {
            ...
            iActionStandbyTransitioning.Dispose();
            ...
            iProductImageHiresUri.Dispose();
            iStandby.Dispose();
            iStandbyTransitioning.Dispose();
