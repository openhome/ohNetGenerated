...
{
    public interface ICpProxyAvOpenhomeOrgRadio2 : ICpProxy, IDisposable
    {
        void SyncPlay();
        ...
        void BeginRefreshPresets(CpProxy.CallbackAsyncComplete aCallback);
        void EndRefreshPresets(IntPtr aAsyncHandle);
    ...
    internal class SyncPlayAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;

        public SyncPlayAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
    ...
    internal class SyncPauseAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;

        public SyncPauseAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncStopAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;

        public SyncStopAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncSeekSecondAbsoluteAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;

        public SyncSeekSecondAbsoluteAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncSeekSecondRelativeAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;

        public SyncSeekSecondRelativeAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncChannelAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;
        private String iUri;
        private String iMetadata;

        public SyncChannelAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        public String Uri()
    ...
    internal class SyncSetChannelAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;

        public SyncSetChannelAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncTransportStateAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;
        private String iValue;

        public SyncTransportStateAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        public String Value()
    ...
    internal class SyncIdAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;
        private uint iValue;

        public SyncIdAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        public uint Value()
    ...
    internal class SyncSetIdAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;

        public SyncSetIdAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
    ...
    internal class SyncReadAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;
        private String iMetadata;

        public SyncReadAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        public String Metadata()
    ...
    internal class SyncReadListAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;
        private String iChannelList;

        public SyncReadListAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
    ...
    internal class SyncIdArrayAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;
        private uint iToken;
        private byte[] iArray;

        public SyncIdArrayAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        public uint Token()
    ...
    internal class SyncIdArrayChangedAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;
        private bool iValue;

        public SyncIdArrayChangedAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        public bool Value()
    ...
    internal class SyncChannelsMaxAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;
        private uint iValue;

        public SyncChannelsMaxAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        public uint Value()
    ...
    internal class SyncRefreshPresetsAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;

        public SyncRefreshPresetsAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        protected override void CompleteRequest(IntPtr aAsyncHandle)
        {
            iService.EndRefreshPresets(aAsyncHandle);
        }
    };

    internal class SyncProtocolInfoAvOpenhomeOrgRadio2 : SyncProxyAction
    {
        private CpProxyAvOpenhomeOrgRadio2 iService;
        private String iValue;

        public SyncProtocolInfoAvOpenhomeOrgRadio2(CpProxyAvOpenhomeOrgRadio2 aProxy)
        {
            iService = aProxy;
        }
        public String Value()
    ...
    /// <summary>
    /// Proxy for the av.openhome.org:Radio:2 UPnP service
    /// </summary>
    public class CpProxyAvOpenhomeOrgRadio2 : CpProxy, IDisposable, ICpProxyAvOpenhomeOrgRadio2
    {
        ...
        private OpenHome.Net.Core.Action iActionRefreshPresets;
        ...
        public CpProxyAvOpenhomeOrgRadio2(ICpDevice aDevice)
            : base("av-openhome-org", "Radio", 2, aDevice)
        {
            ...
            iActionRefreshPresets = new OpenHome.Net.Core.Action("RefreshPresets");
        ...
        {
            SyncPlayAvOpenhomeOrgRadio2 sync = new SyncPlayAvOpenhomeOrgRadio2(this);
        ...
        {
            SyncPauseAvOpenhomeOrgRadio2 sync = new SyncPauseAvOpenhomeOrgRadio2(this);
        ...
        {
            SyncStopAvOpenhomeOrgRadio2 sync = new SyncStopAvOpenhomeOrgRadio2(this);
        ...
        {
            SyncSeekSecondAbsoluteAvOpenhomeOrgRadio2 sync = new SyncSeekSecondAbsoluteAvOpenhomeOrgRadio2(this);
        ...
        {
            SyncSeekSecondRelativeAvOpenhomeOrgRadio2 sync = new SyncSeekSecondRelativeAvOpenhomeOrgRadio2(this);
        ...
        {
            SyncChannelAvOpenhomeOrgRadio2 sync = new SyncChannelAvOpenhomeOrgRadio2(this);
        ...
        {
            SyncSetChannelAvOpenhomeOrgRadio2 sync = new SyncSetChannelAvOpenhomeOrgRadio2(this);
        ...
        {
            SyncTransportStateAvOpenhomeOrgRadio2 sync = new SyncTransportStateAvOpenhomeOrgRadio2(this);
        ...
        {
            SyncIdAvOpenhomeOrgRadio2 sync = new SyncIdAvOpenhomeOrgRadio2(this);
        ...
        {
            SyncSetIdAvOpenhomeOrgRadio2 sync = new SyncSetIdAvOpenhomeOrgRadio2(this);
        ...
        {
            SyncReadAvOpenhomeOrgRadio2 sync = new SyncReadAvOpenhomeOrgRadio2(this);
        ...
        {
            SyncReadListAvOpenhomeOrgRadio2 sync = new SyncReadListAvOpenhomeOrgRadio2(this);
        ...
        {
            SyncIdArrayAvOpenhomeOrgRadio2 sync = new SyncIdArrayAvOpenhomeOrgRadio2(this);
        ...
        {
            SyncIdArrayChangedAvOpenhomeOrgRadio2 sync = new SyncIdArrayChangedAvOpenhomeOrgRadio2(this);
        ...
        {
            SyncChannelsMaxAvOpenhomeOrgRadio2 sync = new SyncChannelsMaxAvOpenhomeOrgRadio2(this);
        ...
        /// <remarks>Blocks until the action has been processed
        /// on the device and sets any output arguments</remarks>
        public void SyncRefreshPresets()
        {
            SyncRefreshPresetsAvOpenhomeOrgRadio2 sync = new SyncRefreshPresetsAvOpenhomeOrgRadio2(this);
            BeginRefreshPresets(sync.AsyncComplete());
            sync.Wait();
            sync.ReportError();
        }
        ...
        /// <remarks>Returns immediately and will run the client-specified callback when the action
        /// later completes.  Any output arguments can then be retrieved by calling
        /// EndRefreshPresets().</remarks>
        /// <param name="aCallback">Delegate to run when the action completes.
        /// This is guaranteed to be run but may indicate an error</param>
        public void BeginRefreshPresets(CallbackAsyncComplete aCallback)
        {
            Invocation invocation = iService.Invocation(iActionRefreshPresets, aCallback);
            iService.InvokeAction(invocation);
        }
        ...
        /// <remarks>This may only be called from the callback set in the above Begin function.</remarks>
        /// <param name="aAsyncHandle">Argument passed to the delegate set in the above Begin function</param>
        public void EndRefreshPresets(IntPtr aAsyncHandle)
        {
            uint code;
            string desc;
            if (Invocation.Error(aAsyncHandle, out code, out desc))
        ...
        {
            SyncProtocolInfoAvOpenhomeOrgRadio2 sync = new SyncProtocolInfoAvOpenhomeOrgRadio2(this);
        ...
        /// CpProxyAvOpenhomeOrgRadio2 instance will not overlap.</remarks>
