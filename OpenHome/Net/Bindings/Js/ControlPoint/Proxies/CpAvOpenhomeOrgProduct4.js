...
/**
* Service Proxy for CpProxyAvOpenhomeOrgProduct4
* @module ohnet
* @class Product
*/
    
var CpProxyAvOpenhomeOrgProduct4 = function(udn){ 

    this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/av.openhome.org-Product-4/control";  // upnp control url
    this.domain = "av-openhome-org";
    this.type = "Product";
    this.version = "4";
    this.serviceName = "av.openhome.org-Product-4";
    ...
    this.serviceProperties["ProductImageHiresUri"] = new ohnet.serviceproperty("ProductImageHiresUri","string");
    this.serviceProperties["Standby"] = new ohnet.serviceproperty("Standby","bool");
    this.serviceProperties["StandbyTransitioning"] = new ohnet.serviceproperty("StandbyTransitioning","bool");
...
*/
CpProxyAvOpenhomeOrgProduct4.prototype.subscribe = function (serviceAddedFunction) {
...
* @method Unsubscribe
*/
CpProxyAvOpenhomeOrgProduct4.prototype.unsubscribe = function () {
...
*/
CpProxyAvOpenhomeOrgProduct4.prototype.ManufacturerName_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.ManufacturerInfo_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.ManufacturerUrl_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.ManufacturerImageUri_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.ModelName_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.ModelInfo_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.ModelUrl_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.ModelImageUri_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.ProductRoom_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.ProductName_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.ProductInfo_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.ProductUrl_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.ProductImageUri_Changed = function (stateChangedFunction) {
...
/**
* Adds a listener to handle "ProductImageHiresUri" property change events
* @method ProductImageHiresUri_Changed
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.ProductImageHiresUri_Changed = function (stateChangedFunction) {
    this.serviceProperties.ProductImageHiresUri.addListener(function (state) 
    { 
        stateChangedFunction(ohnet.soaprequest.readStringParameter(state)); 
    });
}
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.Standby_Changed = function (stateChangedFunction) {
...
/**
* Adds a listener to handle "StandbyTransitioning" property change events
* @method StandbyTransitioning_Changed
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.StandbyTransitioning_Changed = function (stateChangedFunction) {
    this.serviceProperties.StandbyTransitioning.addListener(function (state) 
    { 
        stateChangedFunction(ohnet.soaprequest.readBoolParameter(state)); 
    });
}
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.SourceIndex_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.SourceCount_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.SourceXml_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct4.prototype.Attributes_Changed = function (stateChangedFunction) {
...
*/
CpProxyAvOpenhomeOrgProduct4.prototype.Manufacturer = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.Model = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.Product = function(successFunction, errorFunction){ 
    ...
    request.send(function(result){
        ...
        result["Url"] = ohnet.soaprequest.readStringParameter(result["Url"]); 
        result["ImageUri"] = ohnet.soaprequest.readStringParameter(result["ImageUri"]); 
        result["ImageHiresUri"] = ohnet.soaprequest.readStringParameter(result["ImageHiresUri"]); 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.Standby = function(successFunction, errorFunction){ 
...
/**
* A service action to StandbyTransitioning
* @method StandbyTransitioning
* @param {Function} successFunction The function that is executed when the action has completed successfully
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.StandbyTransitioning = function(successFunction, errorFunction){ 
    var request = new ohnet.soaprequest("StandbyTransitioning", this.url, this.domain, this.type, this.version);     
    request.send(function(result){
        result["Value"] = ohnet.soaprequest.readBoolParameter(result["Value"]); 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.SetStandby = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.SourceCount = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.SourceXml = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.SourceIndex = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.SetSourceIndex = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.SetSourceIndexByName = function(Value, successFunction, errorFunction){ 
...
/**
* A service action to SetSourceBySystemName
* @method SetSourceBySystemName
* @param {String} Value An action parameter
* @param {Function} successFunction The function that is executed when the action has completed successfully
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.SetSourceBySystemName = function(Value, successFunction, errorFunction){ 
    var request = new ohnet.soaprequest("SetSourceBySystemName", this.url, this.domain, this.type, this.version);     
    request.writeStringParameter("Value", Value);
    request.send(function(result){
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.Source = function(Index, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.Attributes = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.SourceXmlChangeCount = function(successFunction, errorFunction){ 
...
/**
* A service action to GetImageUri
* @method GetImageUri
* @param {String} Resolution An action parameter
* @param {Function} successFunction The function that is executed when the action has completed successfully
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct4.prototype.GetImageUri = function(Resolution, successFunction, errorFunction){ 
    var request = new ohnet.soaprequest("GetImageUri", this.url, this.domain, this.type, this.version);     
    request.writeStringParameter("Resolution", Resolution);
    request.send(function(result){
        result["ImageUri"] = ohnet.soaprequest.readStringParameter(result["ImageUri"]); 
