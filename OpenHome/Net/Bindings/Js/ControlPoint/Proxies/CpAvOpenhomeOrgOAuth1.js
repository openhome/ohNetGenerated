...
/**
* Service Proxy for CpProxyAvOpenhomeOrgOAuth1
* @module ohnet
* @class OAuth
*/
    
var CpProxyAvOpenhomeOrgOAuth1 = function(udn){ 

    this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/av.openhome.org-OAuth-1/control";  // upnp control url
    this.domain = "av-openhome-org";
    this.type = "OAuth";
    this.version = "1";
    this.serviceName = "av.openhome.org-OAuth-1";
...
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.subscribe = function (serviceAddedFunction) {
...
* @method Unsubscribe
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.unsubscribe = function () {
...
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.PublicKey_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.UpdateId_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.JobUpdateId_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.SupportedServices_Changed = function (stateChangedFunction) {
...
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.SetToken = function(ServiceId, TokenId, AesKeyRsaEncrypted, InitVectorRsaEncrypted, TokenAesEncrypted, IsLongLived, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.GetPublicKey = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.ClearToken = function(ServiceId, TokenId, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.ClearShortLivedToken = function(ServiceId, TokenId, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.ClearLongLivedToken = function(ServiceId, TokenId, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.ClearShortLivedTokens = function(ServiceId, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.ClearLongLivedTokens = function(ServiceId, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.ClearAllTokens = function(ServiceId, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.GetUpdateId = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.GetServiceStatus = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.GetJobUpdateId = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.GetJobStatus = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.GetSupportedServices = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgOAuth1.prototype.BeginLimitedInputFlow = function(ServiceId, successFunction, errorFunction){ 
