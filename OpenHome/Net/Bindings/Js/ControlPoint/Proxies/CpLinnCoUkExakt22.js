...
/**
* Service Proxy for CpProxyLinnCoUkExakt22
* @module ohnet
* @class Exakt2
*/
    
var CpProxyLinnCoUkExakt22 = function(udn){ 

    this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/linn.co.uk-Exakt2-2/control";  // upnp control url
    this.domain = "linn-co-uk";
    this.type = "Exakt2";
    this.version = "2";
    this.serviceName = "linn.co.uk-Exakt2-2";
    ...
    this.serviceProperties["TestTrackPlaying"] = new ohnet.serviceproperty("TestTrackPlaying","bool");
...
*/
CpProxyLinnCoUkExakt22.prototype.subscribe = function (serviceAddedFunction) {
...
* @method Unsubscribe
*/
CpProxyLinnCoUkExakt22.prototype.unsubscribe = function () {
...
*/
CpProxyLinnCoUkExakt22.prototype.DeviceList_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyLinnCoUkExakt22.prototype.SettingsAvailable_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyLinnCoUkExakt22.prototype.SettingsChangedSeq_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyLinnCoUkExakt22.prototype.UpdateStatus_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyLinnCoUkExakt22.prototype.ChannelMap_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyLinnCoUkExakt22.prototype.AudioChannels_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyLinnCoUkExakt22.prototype.Version_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyLinnCoUkExakt22.prototype.IntegratedDevicesPresent_Changed = function (stateChangedFunction) {
...
/**
* Adds a listener to handle "TestTrackPlaying" property change events
* @method TestTrackPlaying_Changed
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyLinnCoUkExakt22.prototype.TestTrackPlaying_Changed = function (stateChangedFunction) {
    this.serviceProperties.TestTrackPlaying.addListener(function (state) 
    { 
        stateChangedFunction(ohnet.soaprequest.readBoolParameter(state)); 
    });
}
...
*/
CpProxyLinnCoUkExakt22.prototype.GetDeviceList = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.GetDeviceSettings = function(DeviceId, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.GetSettingsAvailable = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.GetSettingsChangedSeq = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.Update = function(Manifest, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.UpdateBlocking = function(Manifest, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.GetUpdateStatus = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.GetChannelMap = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.GetAudioChannels = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.GetVersion = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.ApplyUpdate = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.PlayTestTrack = function(ChannelMap, Uri, Metadata, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.ClearTestTrack = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.GetIntegratedDevicesPresent = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.BootIntegratedDevicesToFallback = function(successFunction, errorFunction){ 
...
/**
* A service action to GetTestTrackPlaying
* @method GetTestTrackPlaying
* @param {Function} successFunction The function that is executed when the action has completed successfully
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkExakt22.prototype.GetTestTrackPlaying = function(successFunction, errorFunction){ 
    var request = new ohnet.soaprequest("GetTestTrackPlaying", this.url, this.domain, this.type, this.version);     
    request.send(function(result){
        result["TestTrackPlaying"] = ohnet.soaprequest.readBoolParameter(result["TestTrackPlaying"]); 
