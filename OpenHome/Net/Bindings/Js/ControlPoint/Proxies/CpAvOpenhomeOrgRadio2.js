...
/**
* Service Proxy for CpProxyAvOpenhomeOrgRadio2
* @module ohnet
* @class Radio
*/
    
var CpProxyAvOpenhomeOrgRadio2 = function(udn){ 

    this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/av.openhome.org-Radio-2/control";  // upnp control url
    this.domain = "av-openhome-org";
    this.type = "Radio";
    this.version = "2";
    this.serviceName = "av.openhome.org-Radio-2";
...
*/
CpProxyAvOpenhomeOrgRadio2.prototype.subscribe = function (serviceAddedFunction) {
...
* @method Unsubscribe
*/
CpProxyAvOpenhomeOrgRadio2.prototype.unsubscribe = function () {
...
*/
CpProxyAvOpenhomeOrgRadio2.prototype.Uri_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgRadio2.prototype.Metadata_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgRadio2.prototype.TransportState_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgRadio2.prototype.Id_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgRadio2.prototype.IdArray_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgRadio2.prototype.ChannelsMax_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgRadio2.prototype.ProtocolInfo_Changed = function (stateChangedFunction) {
...
*/
CpProxyAvOpenhomeOrgRadio2.prototype.Play = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.Pause = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.Stop = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.SeekSecondAbsolute = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.SeekSecondRelative = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.Channel = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.SetChannel = function(Uri, Metadata, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.TransportState = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.Id = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.SetId = function(Value, Uri, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.Read = function(Id, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.ReadList = function(IdList, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.IdArray = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.IdArrayChanged = function(Token, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.ChannelsMax = function(successFunction, errorFunction){ 
...
/**
* A service action to RefreshPresets
* @method RefreshPresets
* @param {Function} successFunction The function that is executed when the action has completed successfully
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.RefreshPresets = function(successFunction, errorFunction){ 
    var request = new ohnet.soaprequest("RefreshPresets", this.url, this.domain, this.type, this.version);     
    request.send(function(result){
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgRadio2.prototype.ProtocolInfo = function(successFunction, errorFunction){ 
