...
/**
* Service Proxy for CpProxyAvOpenhomeOrgProduct2
* @module ohnet
* @class Product
*/
    
var CpProxyAvOpenhomeOrgProduct2 = function(udn){ 

    this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/av.openhome.org-Product-2/control";  // upnp control url
    this.domain = "av-openhome-org";
    this.type = "Product";
    this.version = "2";
    this.serviceName = "av.openhome.org-Product-2";
...
*/
CpProxyAvOpenhomeOrgProduct2.prototype.subscribe = function (serviceAddedFunction) {
...
* @method Unsubscribe
*/
CpProxyAvOpenhomeOrgProduct2.prototype.unsubscribe = function () {
...
*/
CpProxyAvOpenhomeOrgProduct2.prototype.ManufacturerName_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.ManufacturerInfo_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.ManufacturerUrl_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.ManufacturerImageUri_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.ModelName_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.ModelInfo_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.ModelUrl_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.ModelImageUri_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.ProductRoom_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.ProductName_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.ProductInfo_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.ProductUrl_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.ProductImageUri_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.Standby_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.SourceIndex_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.SourceCount_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.SourceXml_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct2.prototype.Attributes_Changed = function (stateChangedFunction) {
...
*/
CpProxyAvOpenhomeOrgProduct2.prototype.Manufacturer = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct2.prototype.Model = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct2.prototype.Product = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct2.prototype.Standby = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct2.prototype.SetStandby = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct2.prototype.SourceCount = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct2.prototype.SourceXml = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct2.prototype.SourceIndex = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct2.prototype.SetSourceIndex = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct2.prototype.SetSourceIndexByName = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct2.prototype.SetSourceBySystemName = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct2.prototype.Source = function(Index, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct2.prototype.Attributes = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct2.prototype.SourceXmlChangeCount = function(successFunction, errorFunction){ 
