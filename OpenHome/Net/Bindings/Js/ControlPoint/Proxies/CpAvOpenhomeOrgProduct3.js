...
/**
* Service Proxy for CpProxyAvOpenhomeOrgProduct3
* @module ohnet
* @class Product
*/
    
var CpProxyAvOpenhomeOrgProduct3 = function(udn){ 

    this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/av.openhome.org-Product-3/control";  // upnp control url
    this.domain = "av-openhome-org";
    this.type = "Product";
    this.version = "3";
    this.serviceName = "av.openhome.org-Product-3";
...
*/
CpProxyAvOpenhomeOrgProduct3.prototype.subscribe = function (serviceAddedFunction) {
...
* @method Unsubscribe
*/
CpProxyAvOpenhomeOrgProduct3.prototype.unsubscribe = function () {
...
*/
CpProxyAvOpenhomeOrgProduct3.prototype.ManufacturerName_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.ManufacturerInfo_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.ManufacturerUrl_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.ManufacturerImageUri_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.ModelName_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.ModelInfo_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.ModelUrl_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.ModelImageUri_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.ProductRoom_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.ProductName_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.ProductInfo_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.ProductUrl_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.ProductImageUri_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.Standby_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.StandbyTransitioning_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.SourceIndex_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.SourceCount_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.SourceXml_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyAvOpenhomeOrgProduct3.prototype.Attributes_Changed = function (stateChangedFunction) {
...
*/
CpProxyAvOpenhomeOrgProduct3.prototype.Manufacturer = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct3.prototype.Model = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct3.prototype.Product = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct3.prototype.Standby = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct3.prototype.StandbyTransitioning = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct3.prototype.SetStandby = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct3.prototype.SourceCount = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct3.prototype.SourceXml = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct3.prototype.SourceIndex = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct3.prototype.SetSourceIndex = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct3.prototype.SetSourceIndexByName = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct3.prototype.SetSourceBySystemName = function(Value, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct3.prototype.Source = function(Index, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct3.prototype.Attributes = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyAvOpenhomeOrgProduct3.prototype.SourceXmlChangeCount = function(successFunction, errorFunction){ 
