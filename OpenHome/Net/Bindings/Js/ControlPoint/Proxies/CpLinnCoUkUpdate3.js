...
/**
* Service Proxy for CpProxyLinnCoUkUpdate3
* @module ohnet
* @class Update
*/
    
var CpProxyLinnCoUkUpdate3 = function(udn){ 

    this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/linn.co.uk-Update-3/control";  // upnp control url
    this.domain = "linn-co-uk";
    this.type = "Update";
    this.version = "3";
    this.serviceName = "linn.co.uk-Update-3";
...
*/
CpProxyLinnCoUkUpdate3.prototype.subscribe = function (serviceAddedFunction) {
...
* @method Unsubscribe
*/
CpProxyLinnCoUkUpdate3.prototype.unsubscribe = function () {
...
*/
CpProxyLinnCoUkUpdate3.prototype.SoftwareStatus_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyLinnCoUkUpdate3.prototype.ExecutorStatus_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyLinnCoUkUpdate3.prototype.JobStatus_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyLinnCoUkUpdate3.prototype.RecoverSupported_Changed = function (stateChangedFunction) {
...
*/
CpProxyLinnCoUkUpdate3.prototype.PushManifest = function(Uri, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkUpdate3.prototype.PushManifest2 = function(Uri, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkUpdate3.prototype.GetSoftwareStatus = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkUpdate3.prototype.GetExecutorStatus = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkUpdate3.prototype.GetJobStatus = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkUpdate3.prototype.Apply = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkUpdate3.prototype.Apply2 = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkUpdate3.prototype.Recover = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkUpdate3.prototype.Recover2 = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkUpdate3.prototype.CheckNow = function(successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkUpdate3.prototype.GetRecoverSupported = function(successFunction, errorFunction){ 
