...
/**
* Service Proxy for CpProxyLinnCoUkCloud2
* @module ohnet
* @class Cloud
*/
    
var CpProxyLinnCoUkCloud2 = function(udn){ 

    this.url = window.location.protocol + "//" + window.location.host + "/" + udn + "/linn.co.uk-Cloud-2/control";  // upnp control url
    this.domain = "linn-co-uk";
    this.type = "Cloud";
    this.version = "2";
    this.serviceName = "linn.co.uk-Cloud-2";
    ...
    this.serviceProperties["AccountId"] = new ohnet.serviceproperty("AccountId","string");
...
*/
CpProxyLinnCoUkCloud2.prototype.subscribe = function (serviceAddedFunction) {
...
* @method Unsubscribe
*/
CpProxyLinnCoUkCloud2.prototype.unsubscribe = function () {
...
*/
CpProxyLinnCoUkCloud2.prototype.AssociationStatus_Changed = function (stateChangedFunction) {
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyLinnCoUkCloud2.prototype.Connected_Changed = function (stateChangedFunction) {
...
/**
* Adds a listener to handle "AccountId" property change events
* @method AccountId_Changed
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyLinnCoUkCloud2.prototype.AccountId_Changed = function (stateChangedFunction) {
    this.serviceProperties.AccountId.addListener(function (state) 
    { 
        stateChangedFunction(ohnet.soaprequest.readStringParameter(state)); 
    });
}
...
* @param {Function} stateChangedFunction The handler for state changes
*/
CpProxyLinnCoUkCloud2.prototype.PublicKey_Changed = function (stateChangedFunction) {
...
*/
CpProxyLinnCoUkCloud2.prototype.GetChallengeResponse = function(Challenge, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkCloud2.prototype.SetAssociated = function(AesKeyRsaEncrypted, InitVectorRsaEncrypted, TokenAesEncrypted, Associated, successFunction, errorFunction){ 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkCloud2.prototype.GetConnected = function(successFunction, errorFunction){ 
...
/**
* A service action to GetAccountId
* @method GetAccountId
* @param {Function} successFunction The function that is executed when the action has completed successfully
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkCloud2.prototype.GetAccountId = function(successFunction, errorFunction){ 
    var request = new ohnet.soaprequest("GetAccountId", this.url, this.domain, this.type, this.version);     
    request.send(function(result){
        result["AccountId"] = ohnet.soaprequest.readStringParameter(result["AccountId"]); 
...
* @param {Function} errorFunction The function that is executed when the action has cause an error
*/
CpProxyLinnCoUkCloud2.prototype.GetPublicKey = function(successFunction, errorFunction){ 
