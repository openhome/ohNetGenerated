#ifndef HEADER_DVAVOPENHOMEORGEXAKT3
#define HEADER_DVAVOPENHOMEORGEXAKT3
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgExakt3 : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgExakt3() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgExakt3(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderAvOpenhomeOrgExakt3(DviDevice& aDevice);
    /**
...
#endif // HEADER_DVAVOPENHOMEORGEXAKT3
