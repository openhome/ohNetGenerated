#ifndef HEADER_DVAVOPENHOMEORGVOLUME2
#define HEADER_DVAVOPENHOMEORGVOLUME2
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgVolume2 : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgVolume2() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgVolume2(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderAvOpenhomeOrgVolume2(DviDevice& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgVolume2();
    void Construct();
...
#endif // HEADER_DVAVOPENHOMEORGVOLUME2
