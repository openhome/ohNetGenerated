#ifndef HEADER_DVLINNCOUKVOLKANO3
#define HEADER_DVLINNCOUKVOLKANO3
 ...
 * @ingroup Providers
 */
class DvProviderLinnCoUkVolkano3 : public DvProvider
{
public:
    virtual ~DvProviderLinnCoUkVolkano3() {}
    /**
...
protected:
     ...
     */
    DvProviderLinnCoUkVolkano3(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderLinnCoUkVolkano3(DviDevice& aDevice);
    /**
...
#endif // HEADER_DVLINNCOUKVOLKANO3
