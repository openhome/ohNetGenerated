#ifndef HEADER_DVLINNCOUKCLOUD2
#define HEADER_DVLINNCOUKCLOUD2
 ...
 * @ingroup Providers
 */
class DvProviderLinnCoUkCloud2 : public DvProvider
{
public:
    virtual ~DvProviderLinnCoUkCloud2() {}
    /**
...
protected:
     ...
     */
    DvProviderLinnCoUkCloud2(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderLinnCoUkCloud2(DviDevice& aDevice);
    /**
...
private:
     ...
     */
    virtual void GetAccountId(IDvInvocation& aInvocation, IDvInvocationResponseString& aAccountId);
    /**
     * GetPublicKey action.
     *
     * Will be called when the device stack receives an invocation of the
