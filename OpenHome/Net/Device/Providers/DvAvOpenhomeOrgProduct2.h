#ifndef HEADER_DVAVOPENHOMEORGPRODUCT2
#define HEADER_DVAVOPENHOMEORGPRODUCT2
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgProduct2 : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgProduct2() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgProduct2(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderAvOpenhomeOrgProduct2(DviDevice& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgProduct2();
    void Construct();
...
#endif // HEADER_DVAVOPENHOMEORGPRODUCT2
