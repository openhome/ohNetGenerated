#ifndef HEADER_DVLINNCOUKUPDATE3
#define HEADER_DVLINNCOUKUPDATE3
 ...
 * @ingroup Providers
 */
class DvProviderLinnCoUkUpdate3 : public DvProvider
{
public:
    virtual ~DvProviderLinnCoUkUpdate3() {}
    /**
...
protected:
     ...
     */
    DvProviderLinnCoUkUpdate3(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderLinnCoUkUpdate3(DviDevice& aDevice);
    /**
...
#endif // HEADER_DVLINNCOUKUPDATE3
