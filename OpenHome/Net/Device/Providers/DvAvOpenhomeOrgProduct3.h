#ifndef HEADER_DVAVOPENHOMEORGPRODUCT3
#define HEADER_DVAVOPENHOMEORGPRODUCT3
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgProduct3 : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgProduct3() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgProduct3(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderAvOpenhomeOrgProduct3(DviDevice& aDevice);
    /**
...
private:
    DvProviderAvOpenhomeOrgProduct3();
    void Construct();
...
#endif // HEADER_DVAVOPENHOMEORGPRODUCT3
