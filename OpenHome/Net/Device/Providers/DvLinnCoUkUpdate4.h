#ifndef HEADER_DVLINNCOUKUPDATE4
#define HEADER_DVLINNCOUKUPDATE4
 ...
 * @ingroup Providers
 */
class DvProviderLinnCoUkUpdate4 : public DvProvider
{
public:
    virtual ~DvProviderLinnCoUkUpdate4() {}
    /**
...
protected:
     ...
     */
    DvProviderLinnCoUkUpdate4(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderLinnCoUkUpdate4(DviDevice& aDevice);
    /**
...
private:
     ...
     * Must be implemented iff EnableActionRecoverKeepStore was called.
     */
    virtual void RecoverKeepStore(IDvInvocation& aInvocation);
    /**
     * RecoverKeepStore2 action.
     *
     * Will be called when the device stack receives an invocation of the
     * RecoverKeepStore2 action for the owning device.
     * Must be implemented iff EnableActionRecoverKeepStore2 was called.
     */
    virtual void RecoverKeepStore2(IDvInvocation& aInvocation, IDvInvocationResponseUint& aId);
    /**
     * CheckNow action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void GetRecoverSupported(IDvInvocation& aInvocation, IDvInvocationResponseBool& aRecoverSupported);
private:
    DvProviderLinnCoUkUpdate4();
    void Construct();
...
#endif // HEADER_DVLINNCOUKUPDATE4
