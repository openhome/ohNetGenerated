#ifndef HEADER_DVLINNCOUKVOLKANO2
#define HEADER_DVLINNCOUKVOLKANO2
 ...
 * @ingroup Providers
 */
class DvProviderLinnCoUkVolkano2 : public DvProvider
{
public:
    virtual ~DvProviderLinnCoUkVolkano2() {}
    /**
...
protected:
     ...
     */
    DvProviderLinnCoUkVolkano2(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderLinnCoUkVolkano2(DviDevice& aDevice);
    /**
...
private:
     ...
     */
    virtual void IpAddress(IDvInvocation& aInvocation, IDvInvocationResponseString& aaIpAddress);
    /**
     ...
     */
    virtual void IpAddressList(IDvInvocation& aInvocation, IDvInvocationResponseString& aaIpAddressList);
    /**
     * MacAddress action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void MacAddressList(IDvInvocation& aInvocation, IDvInvocationResponseString& aaMacAddressList);
    /**
     * ProductId action.
     *
     * Will be called when the device stack receives an invocation of the
     ...
     */
    virtual void CoreBoardId(IDvInvocation& aInvocation, IDvInvocationResponseString& aaCoreBoardId);
private:
    DvProviderLinnCoUkVolkano2();
    void Construct();
...
#endif // HEADER_DVLINNCOUKVOLKANO2
