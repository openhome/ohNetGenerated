#ifndef HEADER_DVAVOPENHOMEORGOAUTH1
#define HEADER_DVAVOPENHOMEORGOAUTH1
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgOAuth1 : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgOAuth1() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgOAuth1(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderAvOpenhomeOrgOAuth1(DviDevice& aDevice);
    /**
...
#endif // HEADER_DVAVOPENHOMEORGOAUTH1
