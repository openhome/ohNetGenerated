#ifndef HEADER_DVAVOPENHOMEORGRADIO2
#define HEADER_DVAVOPENHOMEORGRADIO2
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgRadio2 : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgRadio2() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgRadio2(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderAvOpenhomeOrgRadio2(DviDevice& aDevice);
    /**
     ...
     */
    void EnableActionRefreshPresets();
    /**
...
private:
     ...
     * Must be implemented iff EnableActionRefreshPresets was called.
     */
    virtual void RefreshPresets(IDvInvocation& aInvocation);
    /**
     * ProtocolInfo action.
     *
     * Will be called when the device stack receives an invocation of the
...
#endif // HEADER_DVAVOPENHOMEORGRADIO2
