#ifndef HEADER_DVLINNCOUKEXAKT22
#define HEADER_DVLINNCOUKEXAKT22
 ...
 * @ingroup Providers
 */
class DvProviderLinnCoUkExakt22 : public DvProvider
{
public:
    virtual ~DvProviderLinnCoUkExakt22() {}
    /**
...
protected:
     ...
     */
    DvProviderLinnCoUkExakt22(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderLinnCoUkExakt22(DviDevice& aDevice);
    /**
...
private:
     ...
     */
    virtual void GetTestTrackPlaying(IDvInvocation& aInvocation, IDvInvocationResponseBool& aTestTrackPlaying);
private:
    DvProviderLinnCoUkExakt22();
    void Construct();
...
#endif // HEADER_DVLINNCOUKEXAKT22
