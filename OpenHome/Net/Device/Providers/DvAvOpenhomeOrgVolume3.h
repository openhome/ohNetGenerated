#ifndef HEADER_DVAVOPENHOMEORGVOLUME3
#define HEADER_DVAVOPENHOMEORGVOLUME3
 ...
 * @ingroup Providers
 */
class DvProviderAvOpenhomeOrgVolume3 : public DvProvider
{
public:
    virtual ~DvProviderAvOpenhomeOrgVolume3() {}
    /**
...
protected:
     ...
     */
    DvProviderAvOpenhomeOrgVolume3(DvDevice& aDevice);
    /**
     * Constructor.  Not for external use.
     *
     * @param[in] aDevice  Device which owns this provider
     */
    DvProviderAvOpenhomeOrgVolume3(DviDevice& aDevice);
    /**
...
#endif // HEADER_DVAVOPENHOMEORGVOLUME3
