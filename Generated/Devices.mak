...
objects_devices = \
				  ...
				  $(objdir)DvAvOpenhomeOrgExakt1.$(objext) \
				  $(objdir)DvAvOpenhomeOrgExakt1Std.$(objext) \
				  $(objdir)DvAvOpenhomeOrgExakt1C.$(objext) \
				  $(objdir)DvAvOpenhomeOrgExakt2.$(objext) \
				  $(objdir)DvAvOpenhomeOrgExakt2Std.$(objext) \
				  $(objdir)DvAvOpenhomeOrgExakt2C.$(objext) \
				  $(objdir)DvAvOpenhomeOrgExakt3.$(objext) \
				  $(objdir)DvAvOpenhomeOrgExakt3Std.$(objext) \
				  $(objdir)DvAvOpenhomeOrgExakt3C.$(objext) \
				  ...
				  $(objdir)DvAvOpenhomeOrgVolume2.$(objext) \
				  $(objdir)DvAvOpenhomeOrgVolume2Std.$(objext) \
				  $(objdir)DvAvOpenhomeOrgVolume2C.$(objext) \
				  $(objdir)DvAvOpenhomeOrgVolume3.$(objext) \
				  $(objdir)DvAvOpenhomeOrgVolume3Std.$(objext) \
				  $(objdir)DvAvOpenhomeOrgVolume3C.$(objext) \
				  $(objdir)DvAvOpenhomeOrgVolume4.$(objext) \
				  $(objdir)DvAvOpenhomeOrgVolume4Std.$(objext) \
				  $(objdir)DvAvOpenhomeOrgVolume4C.$(objext) \
				  ...
				  $(objdir)DvAvOpenhomeOrgSender2.$(objext) \
				  $(objdir)DvAvOpenhomeOrgSender2Std.$(objext) \
				  $(objdir)DvAvOpenhomeOrgSender2C.$(objext) \
				  $(objdir)DvAvOpenhomeOrgDebug1.$(objext) \
				  $(objdir)DvAvOpenhomeOrgDebug1Std.$(objext) \
				  $(objdir)DvAvOpenhomeOrgDebug1C.$(objext) \
				  $(objdir)DvAvOpenhomeOrgDebug2.$(objext) \
				  $(objdir)DvAvOpenhomeOrgDebug2Std.$(objext) \
				  $(objdir)DvAvOpenhomeOrgDebug2C.$(objext) \
				  $(objdir)DvAvOpenhomeOrgPins1.$(objext) \
				  $(objdir)DvAvOpenhomeOrgPins1Std.$(objext) \
				  $(objdir)DvAvOpenhomeOrgPins1C.$(objext) \
				  ...
				  $(objdir)DvAvOpenhomeOrgNetworkMonitor1.$(objext) \
				  $(objdir)DvAvOpenhomeOrgNetworkMonitor1Std.$(objext) \
				  $(objdir)DvAvOpenhomeOrgNetworkMonitor1C.$(objext) \
				  ...
				  $(objdir)DvAvOpenhomeOrgOAuth1.$(objext) \
				  $(objdir)DvAvOpenhomeOrgOAuth1Std.$(objext) \
				  $(objdir)DvAvOpenhomeOrgOAuth1C.$(objext) \
				  $(objdir)DvAvOpenhomeOrgReaction1.$(objext) \
				  $(objdir)DvAvOpenhomeOrgReaction1Std.$(objext) \
				  $(objdir)DvAvOpenhomeOrgReaction1C.$(objext) \
				  ...
				  $(objdir)DvLinnCoUkZones1.$(objext) \
				  $(objdir)DvLinnCoUkZones1Std.$(objext) \
				  $(objdir)DvLinnCoUkZones1C.$(objext) \
...
device_dotnet_assemblies_with_path = \
		...
		$(objdir)DvAvOpenhomeOrgVolume2.net.dll \
		$(objdir)DvAvOpenhomeOrgVolume3.net.dll \
		$(objdir)DvAvOpenhomeOrgVolume4.net.dll \
		...
		$(objdir)DvAvOpenhomeOrgDebug2.net.dll \
		$(objdir)DvAvOpenhomeOrgPins1.net.dll \
		...
		$(objdir)DvAvOpenhomeOrgOAuth1.net.dll \
...
device_java_classes_with_path = \
		...
		$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgVolume2.class \
		$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgVolume3.class \
		$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgVolume4.class \
		...
		$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgDebug2.class \
		$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgPins1.class \
		...
		$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgOAuth1.class \
...
$(objdir)DvAvOpenhomeOrgExakt1.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgExakt1.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgExakt1.h
	$(compiler)DvAvOpenhomeOrgExakt1.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgExakt1.cpp
$(objdir)DvAvOpenhomeOrgExakt1Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgExakt1Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgExakt1.h
	$(compiler)DvAvOpenhomeOrgExakt1Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgExakt1Std.cpp
$(objdir)DvAvOpenhomeOrgExakt1C.$(objext) : $(deviceC)DvAvOpenhomeOrgExakt1C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgExakt1.h
	$(compiler)DvAvOpenhomeOrgExakt1C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgExakt1C.cpp
$(objdir)DvAvOpenhomeOrgExakt2.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgExakt2.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgExakt2.h
	$(compiler)DvAvOpenhomeOrgExakt2.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgExakt2.cpp
$(objdir)DvAvOpenhomeOrgExakt2Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgExakt2Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgExakt2.h
	$(compiler)DvAvOpenhomeOrgExakt2Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgExakt2Std.cpp
$(objdir)DvAvOpenhomeOrgExakt2C.$(objext) : $(deviceC)DvAvOpenhomeOrgExakt2C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgExakt2.h
	$(compiler)DvAvOpenhomeOrgExakt2C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgExakt2C.cpp
$(objdir)DvAvOpenhomeOrgExakt3.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgExakt3.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgExakt3.h
	$(compiler)DvAvOpenhomeOrgExakt3.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgExakt3.cpp
$(objdir)DvAvOpenhomeOrgExakt3Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgExakt3Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgExakt3.h
	$(compiler)DvAvOpenhomeOrgExakt3Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgExakt3Std.cpp
$(objdir)DvAvOpenhomeOrgExakt3C.$(objext) : $(deviceC)DvAvOpenhomeOrgExakt3C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgExakt3.h
	$(compiler)DvAvOpenhomeOrgExakt3C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgExakt3C.cpp
$(objdir)DvAvOpenhomeOrgExakt4.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgExakt4.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgExakt4.h
	$(compiler)DvAvOpenhomeOrgExakt4.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgExakt4.cpp
$(objdir)DvAvOpenhomeOrgExakt4Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgExakt4Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgExakt4.h
...
$(objdir)DvAvOpenhomeOrgVolume2.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgVolume2.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgVolume2.h
	$(compiler)DvAvOpenhomeOrgVolume2.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgVolume2.cpp
$(objdir)DvAvOpenhomeOrgVolume2Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgVolume2Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgVolume2.h
	$(compiler)DvAvOpenhomeOrgVolume2Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgVolume2Std.cpp
$(objdir)DvAvOpenhomeOrgVolume2C.$(objext) : $(deviceC)DvAvOpenhomeOrgVolume2C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgVolume2.h
	$(compiler)DvAvOpenhomeOrgVolume2C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgVolume2C.cpp
$(objdir)DvAvOpenhomeOrgVolume3.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgVolume3.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgVolume3.h
	$(compiler)DvAvOpenhomeOrgVolume3.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgVolume3.cpp
$(objdir)DvAvOpenhomeOrgVolume3Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgVolume3Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgVolume3.h
	$(compiler)DvAvOpenhomeOrgVolume3Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgVolume3Std.cpp
$(objdir)DvAvOpenhomeOrgVolume3C.$(objext) : $(deviceC)DvAvOpenhomeOrgVolume3C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgVolume3.h
	$(compiler)DvAvOpenhomeOrgVolume3C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgVolume3C.cpp
$(objdir)DvAvOpenhomeOrgVolume4.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgVolume4.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgVolume4.h
	$(compiler)DvAvOpenhomeOrgVolume4.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgVolume4.cpp
$(objdir)DvAvOpenhomeOrgVolume4Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgVolume4Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgVolume4.h
	$(compiler)DvAvOpenhomeOrgVolume4Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgVolume4Std.cpp
$(objdir)DvAvOpenhomeOrgVolume4C.$(objext) : $(deviceC)DvAvOpenhomeOrgVolume4C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgVolume4.h
	$(compiler)DvAvOpenhomeOrgVolume4C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgVolume4C.cpp
...
$(objdir)DvAvOpenhomeOrgProduct2.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgProduct2.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgProduct2.h
	$(compiler)DvAvOpenhomeOrgProduct2.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgProduct2.cpp
$(objdir)DvAvOpenhomeOrgProduct2Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgProduct2Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgProduct2.h
...
$(objdir)DvAvOpenhomeOrgProduct3.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgProduct3.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgProduct3.h
	$(compiler)DvAvOpenhomeOrgProduct3.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgProduct3.cpp
$(objdir)DvAvOpenhomeOrgProduct3Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgProduct3Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgProduct3.h
...
$(objdir)DvAvOpenhomeOrgSender2.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgSender2.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgSender2.h
	$(compiler)DvAvOpenhomeOrgSender2.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgSender2.cpp
$(objdir)DvAvOpenhomeOrgSender2Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgSender2Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgSender2.h
	$(compiler)DvAvOpenhomeOrgSender2Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgSender2Std.cpp
$(objdir)DvAvOpenhomeOrgSender2C.$(objext) : $(deviceC)DvAvOpenhomeOrgSender2C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgSender2.h
	$(compiler)DvAvOpenhomeOrgSender2C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgSender2C.cpp
...
$(objdir)DvAvOpenhomeOrgDebug2.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgDebug2.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgDebug2.h
	$(compiler)DvAvOpenhomeOrgDebug2.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgDebug2.cpp
$(objdir)DvAvOpenhomeOrgDebug2Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgDebug2Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgDebug2.h
	$(compiler)DvAvOpenhomeOrgDebug2Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgDebug2Std.cpp
$(objdir)DvAvOpenhomeOrgDebug2C.$(objext) : $(deviceC)DvAvOpenhomeOrgDebug2C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgDebug2.h
	$(compiler)DvAvOpenhomeOrgDebug2C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgDebug2C.cpp
$(objdir)DvAvOpenhomeOrgPins1.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgPins1.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgPins1.h
	$(compiler)DvAvOpenhomeOrgPins1.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgPins1.cpp
$(objdir)DvAvOpenhomeOrgPins1Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgPins1Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgPins1.h
	$(compiler)DvAvOpenhomeOrgPins1Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgPins1Std.cpp
$(objdir)DvAvOpenhomeOrgPins1C.$(objext) : $(deviceC)DvAvOpenhomeOrgPins1C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgPins1.h
	$(compiler)DvAvOpenhomeOrgPins1C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgPins1C.cpp
...
$(objdir)DvAvOpenhomeOrgOAuth1.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgOAuth1.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgOAuth1.h
	$(compiler)DvAvOpenhomeOrgOAuth1.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgOAuth1.cpp
$(objdir)DvAvOpenhomeOrgOAuth1Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgOAuth1Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgOAuth1.h
	$(compiler)DvAvOpenhomeOrgOAuth1Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgOAuth1Std.cpp
$(objdir)DvAvOpenhomeOrgOAuth1C.$(objext) : $(deviceC)DvAvOpenhomeOrgOAuth1C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgOAuth1.h
	$(compiler)DvAvOpenhomeOrgOAuth1C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgOAuth1C.cpp
$(objdir)DvAvOpenhomeOrgReaction1.$(objext) : $(deviceCppCore)DvAvOpenhomeOrgReaction1.cpp $(headers_device) OpenHome/Net/Device/Providers/DvAvOpenhomeOrgReaction1.h
	$(compiler)DvAvOpenhomeOrgReaction1.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvAvOpenhomeOrgReaction1.cpp
$(objdir)DvAvOpenhomeOrgReaction1Std.$(objext) : $(deviceCppStd)DvAvOpenhomeOrgReaction1Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvAvOpenhomeOrgReaction1.h
	$(compiler)DvAvOpenhomeOrgReaction1Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvAvOpenhomeOrgReaction1Std.cpp
$(objdir)DvAvOpenhomeOrgReaction1C.$(objext) : $(deviceC)DvAvOpenhomeOrgReaction1C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvAvOpenhomeOrgReaction1.h
	$(compiler)DvAvOpenhomeOrgReaction1C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvAvOpenhomeOrgReaction1C.cpp
...
$(objdir)DvLinnCoUkUpdate1Std.$(objext) : $(deviceCppStd)DvLinnCoUkUpdate1Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvLinnCoUkUpdate1.h
	$(compiler)DvLinnCoUkUpdate1Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvLinnCoUkUpdate1Std.cpp
$(objdir)DvLinnCoUkUpdate1C.$(objext) : $(deviceC)DvLinnCoUkUpdate1C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvLinnCoUkUpdate1.h
	$(compiler)DvLinnCoUkUpdate1C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvLinnCoUkUpdate1C.cpp
$(objdir)DvLinnCoUkUpdate2.$(objext) : $(deviceCppCore)DvLinnCoUkUpdate2.cpp $(headers_device) OpenHome/Net/Device/Providers/DvLinnCoUkUpdate2.h
	$(compiler)DvLinnCoUkUpdate2.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvLinnCoUkUpdate2.cpp
$(objdir)DvLinnCoUkUpdate2Std.$(objext) : $(deviceCppStd)DvLinnCoUkUpdate2Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvLinnCoUkUpdate2.h
...
$(objdir)DvLinnCoUkExakt21.$(objext) : $(deviceCppCore)DvLinnCoUkExakt21.cpp $(headers_device) OpenHome/Net/Device/Providers/DvLinnCoUkExakt21.h
	$(compiler)DvLinnCoUkExakt21.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvLinnCoUkExakt21.cpp
$(objdir)DvLinnCoUkExakt21Std.$(objext) : $(deviceCppStd)DvLinnCoUkExakt21Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvLinnCoUkExakt21.h
...
$(objdir)DvLinnCoUkZones1.$(objext) : $(deviceCppCore)DvLinnCoUkZones1.cpp $(headers_device) OpenHome/Net/Device/Providers/DvLinnCoUkZones1.h
	$(compiler)DvLinnCoUkZones1.$(objext) -c $(cppflags) $(includes) $(deviceCppCore)DvLinnCoUkZones1.cpp
$(objdir)DvLinnCoUkZones1Std.$(objext) : $(deviceCppStd)DvLinnCoUkZones1Std.cpp $(headers_device) OpenHome/Net/Bindings/Cpp/Device/Providers/DvLinnCoUkZones1.h
	$(compiler)DvLinnCoUkZones1Std.$(objext) -c $(cppflags) $(includes) $(deviceCppStd)DvLinnCoUkZones1Std.cpp
$(objdir)DvLinnCoUkZones1C.$(objext) : $(deviceC)DvLinnCoUkZones1C.cpp $(headers_device) OpenHome/Net/Bindings/C/Device/Providers/DvLinnCoUkZones1.h
	$(compiler)DvLinnCoUkZones1C.$(objext) -c $(cppflags) $(includes) $(deviceC)DvLinnCoUkZones1C.cpp
...
$(objdir)DvUpnpOrgAVTransport2.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvUpnpOrgAVTransport2.cs
	$(dotnetsdk) build $(proxyCs)CpUpnpOrgAVTransport2.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvUpnpOrgConnectionManager1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvUpnpOrgConnectionManager1.cs
...
$(objdir)DvUpnpOrgConnectionManager2.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvUpnpOrgConnectionManager2.cs
...
$(objdir)DvUpnpOrgContentDirectory1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvUpnpOrgContentDirectory1.cs
	$(dotnetsdk) build $(proxyCs)CpUpnpOrgContentDirectory1.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvUpnpOrgContentDirectory2.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvUpnpOrgContentDirectory2.cs
	$(dotnetsdk) build $(proxyCs)CpUpnpOrgContentDirectory2.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvUpnpOrgContentDirectory3.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvUpnpOrgContentDirectory3.cs
	$(dotnetsdk) build $(proxyCs)CpUpnpOrgContentDirectory3.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvUpnpOrgRenderingControl1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvUpnpOrgRenderingControl1.cs
	$(dotnetsdk) build $(proxyCs)CpUpnpOrgRenderingControl1.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvUpnpOrgRenderingControl2.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvUpnpOrgRenderingControl2.cs
	$(dotnetsdk) build $(proxyCs)CpUpnpOrgRenderingControl2.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvUpnpOrgScheduledRecording1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvUpnpOrgScheduledRecording1.cs
...
$(objdir)DvUpnpOrgScheduledRecording2.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvUpnpOrgScheduledRecording2.cs
...
$(objdir)DvUpnpOrgSwitchPower1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvUpnpOrgSwitchPower1.cs
	$(dotnetsdk) build $(proxyCs)CpUpnpOrgSwitchPower1.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvUpnpOrgDimming1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvUpnpOrgDimming1.cs
...
$(objdir)DvAvOpenhomeOrgExakt1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgExakt1.cs
	$(dotnetsdk) build $(proxyCs)CpAvOpenhomeOrgExakt1.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvAvOpenhomeOrgExakt2.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgExakt2.cs
	$(dotnetsdk) build $(proxyCs)CpAvOpenhomeOrgExakt2.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvAvOpenhomeOrgExakt3.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgExakt3.cs
	$(dotnetsdk) build $(proxyCs)CpAvOpenhomeOrgExakt3.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvAvOpenhomeOrgExakt4.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgExakt4.cs
...
$(objdir)DvAvOpenhomeOrgSender1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgSender1.cs
	$(dotnetsdk) build $(proxyCs)CpAvOpenhomeOrgSender1.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvAvOpenhomeOrgSender2.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgSender2.cs
...
$(objdir)DvAvOpenhomeOrgDebug2.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgDebug2.cs
	$(dotnetsdk) build $(proxyCs)CpAvOpenhomeOrgDebug2.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvAvOpenhomeOrgPins1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgPins1.cs
...
$(objdir)DvAvOpenhomeOrgMediaServer1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgMediaServer1.cs
...
$(objdir)DvAvOpenhomeOrgNetworkMonitor1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgNetworkMonitor1.cs
...
$(objdir)DvOpenhomeOrgTestBasic1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvOpenhomeOrgTestBasic1.cs
	$(dotnetsdk) build $(proxyCs)CpOpenhomeOrgTestBasic1.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvOpenhomeOrgTestLights1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvOpenhomeOrgTestLights1.cs
	$(dotnetsdk) build $(proxyCs)CpOpenhomeOrgTestLights1.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvOpenhomeOrgSubscriptionLongPoll1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvOpenhomeOrgSubscriptionLongPoll1.cs
...
$(objdir)DvAvOpenhomeOrgOAuth1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgOAuth1.cs
	$(dotnetsdk) build $(proxyCs)CpAvOpenhomeOrgOAuth1.csproj --framework $(dotnetFramework) --output $(objdir) -p:ohNetDepDir=$(depDirCs)
$(objdir)DvAvOpenhomeOrgReaction1.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvAvOpenhomeOrgReaction1.cs
...
$(objdir)DvLinnCoUkUpdate2.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvLinnCoUkUpdate2.cs
...
$(objdir)DvLinnCoUkExakt21.net.dll: $(depDirCs)ohNet.net.dll $(deviceCs)DvLinnCoUkExakt21.cs
...
$(objdir)org/openhome/net/device/providers/DvProviderUpnpOrgAVTransport1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderUpnpOrgAVTransport1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderUpnpOrgAVTransport1.java
$(objdir)org/openhome/net/device/providers/DvProviderUpnpOrgAVTransport2.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderUpnpOrgAVTransport2.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderUpnpOrgAVTransport2.java
$(objdir)org/openhome/net/device/providers/DvProviderUpnpOrgConnectionManager1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderUpnpOrgConnectionManager1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderUpnpOrgConnectionManager1.java
$(objdir)org/openhome/net/device/providers/DvProviderUpnpOrgConnectionManager2.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderUpnpOrgConnectionManager2.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderUpnpOrgConnectionManager2.java
$(objdir)org/openhome/net/device/providers/DvProviderUpnpOrgContentDirectory1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderUpnpOrgContentDirectory1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderUpnpOrgContentDirectory1.java
$(objdir)org/openhome/net/device/providers/DvProviderUpnpOrgContentDirectory2.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderUpnpOrgContentDirectory2.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderUpnpOrgContentDirectory2.java
$(objdir)org/openhome/net/device/providers/DvProviderUpnpOrgContentDirectory3.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderUpnpOrgContentDirectory3.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderUpnpOrgContentDirectory3.java
$(objdir)org/openhome/net/device/providers/DvProviderUpnpOrgRenderingControl1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderUpnpOrgRenderingControl1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderUpnpOrgRenderingControl1.java
$(objdir)org/openhome/net/device/providers/DvProviderUpnpOrgRenderingControl2.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderUpnpOrgRenderingControl2.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderUpnpOrgRenderingControl2.java
$(objdir)org/openhome/net/device/providers/DvProviderUpnpOrgScheduledRecording1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderUpnpOrgScheduledRecording1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderUpnpOrgScheduledRecording1.java
$(objdir)org/openhome/net/device/providers/DvProviderUpnpOrgScheduledRecording2.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderUpnpOrgScheduledRecording2.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderUpnpOrgScheduledRecording2.java
$(objdir)org/openhome/net/device/providers/DvProviderUpnpOrgSwitchPower1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderUpnpOrgSwitchPower1.java
...
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgExakt1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgExakt1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgExakt1.java
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgExakt2.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgExakt2.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgExakt2.java
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgExakt3.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgExakt3.java
...
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgTime1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgTime1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgTime1.java
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgPlaylist1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgPlaylist1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgPlaylist1.java
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgVolume1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgVolume1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgVolume1.java
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgVolume2.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgVolume2.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgVolume2.java
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgVolume3.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgVolume3.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgVolume3.java
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgVolume4.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgVolume4.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgVolume4.java
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgProduct1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgProduct1.java
...
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgSender2.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgSender2.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgSender2.java
...
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgDebug2.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgDebug2.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgDebug2.java
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgPins1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgPins1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgPins1.java
...
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgMediaServer1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgMediaServer1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgMediaServer1.java
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgNetworkMonitor1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgNetworkMonitor1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgNetworkMonitor1.java
$(objdir)org/openhome/net/device/providers/DvProviderOpenhomeOrgTestBasic1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderOpenhomeOrgTestBasic1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderOpenhomeOrgTestBasic1.java
$(objdir)org/openhome/net/device/providers/DvProviderOpenhomeOrgTestLights1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderOpenhomeOrgTestLights1.java
...
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgOAuth1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgOAuth1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgOAuth1.java
$(objdir)org/openhome/net/device/providers/DvProviderAvOpenhomeOrgReaction1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderAvOpenhomeOrgReaction1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderAvOpenhomeOrgReaction1.java
...
$(objdir)org/openhome/net/device/providers/DvProviderLinnCoUkZones1.class : $(ohNetLibDir)ohnet.jar $(deviceJava)DvProviderLinnCoUkZones1.java
	$(javac) -classpath $(ohNetLibDir)ohnet.jar -d $(objdir) $(deviceJava)DvProviderLinnCoUkZones1.java
