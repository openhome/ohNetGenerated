...
CpCppCore:   $(proxyCppCore)CpUpnpOrgAVTransport1.cpp $(proxyCppCore)CpUpnpOrgAVTransport2.cpp $(proxyCppCore)CpUpnpOrgConnectionManager1.cpp $(proxyCppCore)CpUpnpOrgConnectionManager2.cpp $(proxyCppCore)CpUpnpOrgContentDirectory1.cpp $(proxyCppCore)CpUpnpOrgContentDirectory2.cpp $(proxyCppCore)CpUpnpOrgContentDirectory3.cpp $(proxyCppCore)CpUpnpOrgRenderingControl1.cpp $(proxyCppCore)CpUpnpOrgRenderingControl2.cpp $(proxyCppCore)CpUpnpOrgScheduledRecording1.cpp $(proxyCppCore)CpUpnpOrgScheduledRecording2.cpp $(proxyCppCore)CpUpnpOrgSwitchPower1.cpp $(proxyCppCore)CpUpnpOrgDimming1.cpp $(proxyCppCore)CpAvOpenhomeOrgCredentials1.cpp $(proxyCppCore)CpAvOpenhomeOrgExakt1.cpp $(proxyCppCore)CpAvOpenhomeOrgExakt2.cpp $(proxyCppCore)CpAvOpenhomeOrgExakt3.cpp $(proxyCppCore)CpAvOpenhomeOrgInfo1.cpp $(proxyCppCore)CpAvOpenhomeOrgTime1.cpp $(proxyCppCore)CpAvOpenhomeOrgPlaylist1.cpp $(proxyCppCore)CpAvOpenhomeOrgVolume1.cpp $(proxyCppCore)CpAvOpenhomeOrgVolume2.cpp $(proxyCppCore)CpAvOpenhomeOrgVolume3.cpp $(proxyCppCore)CpAvOpenhomeOrgProduct1.cpp $(proxyCppCore)CpAvOpenhomeOrgProduct2.cpp $(proxyCppCore)CpAvOpenhomeOrgTransport1.cpp $(proxyCppCore)CpAvOpenhomeOrgRadio1.cpp $(proxyCppCore)CpAvOpenhomeOrgReceiver1.cpp $(proxyCppCore)CpAvOpenhomeOrgSender1.cpp $(proxyCppCore)CpAvOpenhomeOrgSender2.cpp $(proxyCppCore)CpAvOpenhomeOrgDebug1.cpp $(proxyCppCore)CpAvOpenhomeOrgPins1.cpp $(proxyCppCore)CpAvOpenhomeOrgPlaylistManager1.cpp $(proxyCppCore)CpAvOpenhomeOrgMediaServer1.cpp $(proxyCppCore)CpAvOpenhomeOrgNetworkMonitor1.cpp $(proxyCppCore)CpOpenhomeOrgTestBasic1.cpp $(proxyCppCore)CpOpenhomeOrgTestLights1.cpp $(proxyCppCore)CpOpenhomeOrgSubscriptionLongPoll1.cpp $(proxyCppCore)CpLinnCoUkFlash1.cpp $(proxyCppCore)CpLinnCoUkVolkano1.cpp $(proxyCppCore)CpLinnCoUkPrivacy1.cpp $(proxyCppCore)CpLinnCoUkExaktInputs1.cpp $(proxyCppCore)CpLinnCoUkCloud1.cpp $(proxyCppCore)CpLinnCoUkUpdate1.cpp $(proxyCppCore)CpLinnCoUkConfiguration1.cpp $(proxyCppCore)CpLinnCoUkLipSync1.cpp $(proxyCppCore)CpLinnCoUkExakt1.cpp
...
$(proxyCppCore)CpLinnCoUkExakt1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/Linn/Exakt1.xml
	echo CpLinnCoUkExakt1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/Linn/Exakt1.xml" --output=$(proxyCppCore) --domain=linn.co.uk --type=Exakt --version=1

CpCppStd:   $(proxyCppStd)CpUpnpOrgAVTransport1Std.cpp $(proxyCppStd)CpUpnpOrgAVTransport2Std.cpp $(proxyCppStd)CpUpnpOrgConnectionManager1Std.cpp $(proxyCppStd)CpUpnpOrgConnectionManager2Std.cpp $(proxyCppStd)CpUpnpOrgContentDirectory1Std.cpp $(proxyCppStd)CpUpnpOrgContentDirectory2Std.cpp $(proxyCppStd)CpUpnpOrgContentDirectory3Std.cpp $(proxyCppStd)CpUpnpOrgRenderingControl1Std.cpp $(proxyCppStd)CpUpnpOrgRenderingControl2Std.cpp $(proxyCppStd)CpUpnpOrgScheduledRecording1Std.cpp $(proxyCppStd)CpUpnpOrgScheduledRecording2Std.cpp $(proxyCppStd)CpUpnpOrgSwitchPower1Std.cpp $(proxyCppStd)CpUpnpOrgDimming1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgCredentials1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgExakt1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgExakt2Std.cpp $(proxyCppStd)CpAvOpenhomeOrgExakt3Std.cpp $(proxyCppStd)CpAvOpenhomeOrgInfo1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgTime1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgPlaylist1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgVolume1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgVolume2Std.cpp $(proxyCppStd)CpAvOpenhomeOrgVolume3Std.cpp $(proxyCppStd)CpAvOpenhomeOrgProduct1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgProduct2Std.cpp $(proxyCppStd)CpAvOpenhomeOrgTransport1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgRadio1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgReceiver1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgSender1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgSender2Std.cpp $(proxyCppStd)CpAvOpenhomeOrgDebug1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgPins1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgPlaylistManager1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgMediaServer1Std.cpp $(proxyCppStd)CpAvOpenhomeOrgNetworkMonitor1Std.cpp $(proxyCppStd)CpOpenhomeOrgTestBasic1Std.cpp $(proxyCppStd)CpOpenhomeOrgTestLights1Std.cpp $(proxyCppStd)CpOpenhomeOrgSubscriptionLongPoll1Std.cpp $(proxyCppStd)CpLinnCoUkFlash1Std.cpp $(proxyCppStd)CpLinnCoUkVolkano1Std.cpp $(proxyCppStd)CpLinnCoUkPrivacy1Std.cpp $(proxyCppStd)CpLinnCoUkExaktInputs1Std.cpp $(proxyCppStd)CpLinnCoUkCloud1Std.cpp $(proxyCppStd)CpLinnCoUkUpdate1Std.cpp $(proxyCppStd)CpLinnCoUkConfiguration1Std.cpp $(proxyCppStd)CpLinnCoUkLipSync1Std.cpp $(proxyCppStd)CpLinnCoUkExakt1Std.cpp
...
$(proxyCppStd)CpLinnCoUkExakt1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/Linn/Exakt1.xml
	echo CpLinnCoUkExakt1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/Linn/Exakt1.xml" --output=$(proxyCppStd) --domain=linn.co.uk --type=Exakt --version=1

CpC:   $(proxyC)CpUpnpOrgAVTransport1C.cpp $(proxyC)CpUpnpOrgAVTransport2C.cpp $(proxyC)CpUpnpOrgConnectionManager1C.cpp $(proxyC)CpUpnpOrgConnectionManager2C.cpp $(proxyC)CpUpnpOrgContentDirectory1C.cpp $(proxyC)CpUpnpOrgContentDirectory2C.cpp $(proxyC)CpUpnpOrgContentDirectory3C.cpp $(proxyC)CpUpnpOrgRenderingControl1C.cpp $(proxyC)CpUpnpOrgRenderingControl2C.cpp $(proxyC)CpUpnpOrgScheduledRecording1C.cpp $(proxyC)CpUpnpOrgScheduledRecording2C.cpp $(proxyC)CpUpnpOrgSwitchPower1C.cpp $(proxyC)CpUpnpOrgDimming1C.cpp $(proxyC)CpAvOpenhomeOrgCredentials1C.cpp $(proxyC)CpAvOpenhomeOrgExakt1C.cpp $(proxyC)CpAvOpenhomeOrgExakt2C.cpp $(proxyC)CpAvOpenhomeOrgExakt3C.cpp $(proxyC)CpAvOpenhomeOrgInfo1C.cpp $(proxyC)CpAvOpenhomeOrgTime1C.cpp $(proxyC)CpAvOpenhomeOrgPlaylist1C.cpp $(proxyC)CpAvOpenhomeOrgVolume1C.cpp $(proxyC)CpAvOpenhomeOrgVolume2C.cpp $(proxyC)CpAvOpenhomeOrgVolume3C.cpp $(proxyC)CpAvOpenhomeOrgProduct1C.cpp $(proxyC)CpAvOpenhomeOrgProduct2C.cpp $(proxyC)CpAvOpenhomeOrgTransport1C.cpp $(proxyC)CpAvOpenhomeOrgRadio1C.cpp $(proxyC)CpAvOpenhomeOrgReceiver1C.cpp $(proxyC)CpAvOpenhomeOrgSender1C.cpp $(proxyC)CpAvOpenhomeOrgSender2C.cpp $(proxyC)CpAvOpenhomeOrgDebug1C.cpp $(proxyC)CpAvOpenhomeOrgPins1C.cpp $(proxyC)CpAvOpenhomeOrgPlaylistManager1C.cpp $(proxyC)CpAvOpenhomeOrgMediaServer1C.cpp $(proxyC)CpAvOpenhomeOrgNetworkMonitor1C.cpp $(proxyC)CpOpenhomeOrgTestBasic1C.cpp $(proxyC)CpOpenhomeOrgTestLights1C.cpp $(proxyC)CpOpenhomeOrgSubscriptionLongPoll1C.cpp $(proxyC)CpLinnCoUkFlash1C.cpp $(proxyC)CpLinnCoUkVolkano1C.cpp $(proxyC)CpLinnCoUkPrivacy1C.cpp $(proxyC)CpLinnCoUkExaktInputs1C.cpp $(proxyC)CpLinnCoUkCloud1C.cpp $(proxyC)CpLinnCoUkUpdate1C.cpp $(proxyC)CpLinnCoUkConfiguration1C.cpp $(proxyC)CpLinnCoUkLipSync1C.cpp $(proxyC)CpLinnCoUkExakt1C.cpp
...
$(proxyC)CpLinnCoUkExakt1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/Linn/Exakt1.xml
	echo CpLinnCoUkExakt1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/Linn/Exakt1.xml" --output=$(proxyC) --domain=linn.co.uk --type=Exakt --version=1

CpCs:   $(proxyCs)CpUpnpOrgAVTransport1.cs $(proxyCs)CpUpnpOrgAVTransport2.cs $(proxyCs)CpUpnpOrgConnectionManager1.cs $(proxyCs)CpUpnpOrgConnectionManager2.cs $(proxyCs)CpUpnpOrgContentDirectory1.cs $(proxyCs)CpUpnpOrgContentDirectory2.cs $(proxyCs)CpUpnpOrgContentDirectory3.cs $(proxyCs)CpUpnpOrgRenderingControl1.cs $(proxyCs)CpUpnpOrgRenderingControl2.cs $(proxyCs)CpUpnpOrgScheduledRecording1.cs $(proxyCs)CpUpnpOrgScheduledRecording2.cs $(proxyCs)CpUpnpOrgSwitchPower1.cs $(proxyCs)CpUpnpOrgDimming1.cs $(proxyCs)CpAvOpenhomeOrgCredentials1.cs $(proxyCs)CpAvOpenhomeOrgExakt1.cs $(proxyCs)CpAvOpenhomeOrgExakt2.cs $(proxyCs)CpAvOpenhomeOrgExakt3.cs $(proxyCs)CpAvOpenhomeOrgInfo1.cs $(proxyCs)CpAvOpenhomeOrgTime1.cs $(proxyCs)CpAvOpenhomeOrgPlaylist1.cs $(proxyCs)CpAvOpenhomeOrgVolume1.cs $(proxyCs)CpAvOpenhomeOrgVolume2.cs $(proxyCs)CpAvOpenhomeOrgVolume3.cs $(proxyCs)CpAvOpenhomeOrgProduct1.cs $(proxyCs)CpAvOpenhomeOrgProduct2.cs $(proxyCs)CpAvOpenhomeOrgTransport1.cs $(proxyCs)CpAvOpenhomeOrgRadio1.cs $(proxyCs)CpAvOpenhomeOrgReceiver1.cs $(proxyCs)CpAvOpenhomeOrgSender1.cs $(proxyCs)CpAvOpenhomeOrgSender2.cs $(proxyCs)CpAvOpenhomeOrgDebug1.cs $(proxyCs)CpAvOpenhomeOrgPins1.cs $(proxyCs)CpAvOpenhomeOrgPlaylistManager1.cs $(proxyCs)CpAvOpenhomeOrgMediaServer1.cs $(proxyCs)CpAvOpenhomeOrgNetworkMonitor1.cs $(proxyCs)CpOpenhomeOrgTestBasic1.cs $(proxyCs)CpOpenhomeOrgTestLights1.cs $(proxyCs)CpOpenhomeOrgSubscriptionLongPoll1.cs $(proxyCs)CpLinnCoUkFlash1.cs $(proxyCs)CpLinnCoUkVolkano1.cs $(proxyCs)CpLinnCoUkPrivacy1.cs $(proxyCs)CpLinnCoUkExaktInputs1.cs $(proxyCs)CpLinnCoUkCloud1.cs $(proxyCs)CpLinnCoUkUpdate1.cs $(proxyCs)CpLinnCoUkConfiguration1.cs $(proxyCs)CpLinnCoUkLipSync1.cs $(proxyCs)CpLinnCoUkExakt1.cs
...
$(proxyCs)CpLinnCoUkExakt1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/Linn/Exakt1.xml
	echo CpLinnCoUkExakt1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/Linn/Exakt1.xml" --output=$(proxyCs) --domain=linn.co.uk --type=Exakt --version=1

CpJava:   $(proxyJava)CpProxyUpnpOrgAVTransport1.java $(proxyJava)CpProxyUpnpOrgAVTransport2.java $(proxyJava)CpProxyUpnpOrgConnectionManager1.java $(proxyJava)CpProxyUpnpOrgConnectionManager2.java $(proxyJava)CpProxyUpnpOrgContentDirectory1.java $(proxyJava)CpProxyUpnpOrgContentDirectory2.java $(proxyJava)CpProxyUpnpOrgContentDirectory3.java $(proxyJava)CpProxyUpnpOrgRenderingControl1.java $(proxyJava)CpProxyUpnpOrgRenderingControl2.java $(proxyJava)CpProxyUpnpOrgScheduledRecording1.java $(proxyJava)CpProxyUpnpOrgScheduledRecording2.java $(proxyJava)CpProxyUpnpOrgSwitchPower1.java $(proxyJava)CpProxyUpnpOrgDimming1.java $(proxyJava)CpProxyAvOpenhomeOrgCredentials1.java $(proxyJava)CpProxyAvOpenhomeOrgExakt1.java $(proxyJava)CpProxyAvOpenhomeOrgExakt2.java $(proxyJava)CpProxyAvOpenhomeOrgExakt3.java $(proxyJava)CpProxyAvOpenhomeOrgInfo1.java $(proxyJava)CpProxyAvOpenhomeOrgTime1.java $(proxyJava)CpProxyAvOpenhomeOrgPlaylist1.java $(proxyJava)CpProxyAvOpenhomeOrgVolume1.java $(proxyJava)CpProxyAvOpenhomeOrgVolume2.java $(proxyJava)CpProxyAvOpenhomeOrgVolume3.java $(proxyJava)CpProxyAvOpenhomeOrgProduct1.java $(proxyJava)CpProxyAvOpenhomeOrgProduct2.java $(proxyJava)CpProxyAvOpenhomeOrgTransport1.java $(proxyJava)CpProxyAvOpenhomeOrgRadio1.java $(proxyJava)CpProxyAvOpenhomeOrgReceiver1.java $(proxyJava)CpProxyAvOpenhomeOrgSender1.java $(proxyJava)CpProxyAvOpenhomeOrgSender2.java $(proxyJava)CpProxyAvOpenhomeOrgDebug1.java $(proxyJava)CpProxyAvOpenhomeOrgPins1.java $(proxyJava)CpProxyAvOpenhomeOrgPlaylistManager1.java $(proxyJava)CpProxyAvOpenhomeOrgMediaServer1.java $(proxyJava)CpProxyAvOpenhomeOrgNetworkMonitor1.java $(proxyJava)CpProxyOpenhomeOrgTestBasic1.java $(proxyJava)CpProxyOpenhomeOrgTestLights1.java $(proxyJava)CpProxyOpenhomeOrgSubscriptionLongPoll1.java $(proxyJava)CpProxyLinnCoUkFlash1.java $(proxyJava)CpProxyLinnCoUkVolkano1.java $(proxyJava)CpProxyLinnCoUkPrivacy1.java $(proxyJava)CpProxyLinnCoUkExaktInputs1.java $(proxyJava)CpProxyLinnCoUkCloud1.java $(proxyJava)CpProxyLinnCoUkUpdate1.java $(proxyJava)CpProxyLinnCoUkConfiguration1.java $(proxyJava)CpProxyLinnCoUkLipSync1.java $(proxyJava)CpProxyLinnCoUkExakt1.java
...
$(proxyJava)CpProxyLinnCoUkExakt1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/Linn/Exakt1.xml
	echo CpProxyLinnCoUkExakt1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/Linn/Exakt1.xml" --output=$(proxyJava) --domain=linn.co.uk --type=Exakt --version=1

CpJs:   $(proxyJs)CpUpnpOrgAVTransport1.js $(proxyJs)CpUpnpOrgAVTransport2.js $(proxyJs)CpUpnpOrgConnectionManager1.js $(proxyJs)CpUpnpOrgConnectionManager2.js $(proxyJs)CpUpnpOrgContentDirectory1.js $(proxyJs)CpUpnpOrgContentDirectory2.js $(proxyJs)CpUpnpOrgContentDirectory3.js $(proxyJs)CpUpnpOrgRenderingControl1.js $(proxyJs)CpUpnpOrgRenderingControl2.js $(proxyJs)CpUpnpOrgScheduledRecording1.js $(proxyJs)CpUpnpOrgScheduledRecording2.js $(proxyJs)CpUpnpOrgSwitchPower1.js $(proxyJs)CpUpnpOrgDimming1.js $(proxyJs)CpAvOpenhomeOrgCredentials1.js $(proxyJs)CpAvOpenhomeOrgExakt1.js $(proxyJs)CpAvOpenhomeOrgExakt2.js $(proxyJs)CpAvOpenhomeOrgExakt3.js $(proxyJs)CpAvOpenhomeOrgInfo1.js $(proxyJs)CpAvOpenhomeOrgTime1.js $(proxyJs)CpAvOpenhomeOrgPlaylist1.js $(proxyJs)CpAvOpenhomeOrgVolume1.js $(proxyJs)CpAvOpenhomeOrgVolume2.js $(proxyJs)CpAvOpenhomeOrgVolume3.js $(proxyJs)CpAvOpenhomeOrgProduct1.js $(proxyJs)CpAvOpenhomeOrgProduct2.js $(proxyJs)CpAvOpenhomeOrgTransport1.js $(proxyJs)CpAvOpenhomeOrgRadio1.js $(proxyJs)CpAvOpenhomeOrgReceiver1.js $(proxyJs)CpAvOpenhomeOrgSender1.js $(proxyJs)CpAvOpenhomeOrgSender2.js $(proxyJs)CpAvOpenhomeOrgDebug1.js $(proxyJs)CpAvOpenhomeOrgPins1.js $(proxyJs)CpAvOpenhomeOrgPlaylistManager1.js $(proxyJs)CpAvOpenhomeOrgMediaServer1.js $(proxyJs)CpAvOpenhomeOrgNetworkMonitor1.js $(proxyJs)CpOpenhomeOrgTestBasic1.js $(proxyJs)CpOpenhomeOrgTestLights1.js $(proxyJs)CpOpenhomeOrgSubscriptionLongPoll1.js $(proxyJs)CpLinnCoUkFlash1.js $(proxyJs)CpLinnCoUkVolkano1.js $(proxyJs)CpLinnCoUkPrivacy1.js $(proxyJs)CpLinnCoUkExaktInputs1.js $(proxyJs)CpLinnCoUkCloud1.js $(proxyJs)CpLinnCoUkUpdate1.js $(proxyJs)CpLinnCoUkConfiguration1.js $(proxyJs)CpLinnCoUkLipSync1.js $(proxyJs)CpLinnCoUkExakt1.js
...
$(proxyJs)CpLinnCoUkExakt1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/Linn/Exakt1.xml
	echo CpLinnCoUkExakt1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/Linn/Exakt1.xml" --output=$(proxyJs) --domain=linn.co.uk --type=Exakt --version=1

DvCppCore :   $(deviceCppCore)DvUpnpOrgAVTransport1.cpp $(deviceCppCore)DvUpnpOrgAVTransport2.cpp $(deviceCppCore)DvUpnpOrgConnectionManager1.cpp $(deviceCppCore)DvUpnpOrgConnectionManager2.cpp $(deviceCppCore)DvUpnpOrgContentDirectory1.cpp $(deviceCppCore)DvUpnpOrgContentDirectory2.cpp $(deviceCppCore)DvUpnpOrgContentDirectory3.cpp $(deviceCppCore)DvUpnpOrgRenderingControl1.cpp $(deviceCppCore)DvUpnpOrgRenderingControl2.cpp $(deviceCppCore)DvUpnpOrgScheduledRecording1.cpp $(deviceCppCore)DvUpnpOrgScheduledRecording2.cpp $(deviceCppCore)DvUpnpOrgSwitchPower1.cpp $(deviceCppCore)DvUpnpOrgDimming1.cpp $(deviceCppCore)DvAvOpenhomeOrgCredentials1.cpp $(deviceCppCore)DvAvOpenhomeOrgExakt1.cpp $(deviceCppCore)DvAvOpenhomeOrgExakt2.cpp $(deviceCppCore)DvAvOpenhomeOrgExakt3.cpp $(deviceCppCore)DvAvOpenhomeOrgInfo1.cpp $(deviceCppCore)DvAvOpenhomeOrgTime1.cpp $(deviceCppCore)DvAvOpenhomeOrgPlaylist1.cpp $(deviceCppCore)DvAvOpenhomeOrgVolume1.cpp $(deviceCppCore)DvAvOpenhomeOrgVolume2.cpp $(deviceCppCore)DvAvOpenhomeOrgVolume3.cpp $(deviceCppCore)DvAvOpenhomeOrgProduct1.cpp $(deviceCppCore)DvAvOpenhomeOrgProduct2.cpp $(deviceCppCore)DvAvOpenhomeOrgTransport1.cpp $(deviceCppCore)DvAvOpenhomeOrgRadio1.cpp $(deviceCppCore)DvAvOpenhomeOrgReceiver1.cpp $(deviceCppCore)DvAvOpenhomeOrgSender1.cpp $(deviceCppCore)DvAvOpenhomeOrgSender2.cpp $(deviceCppCore)DvAvOpenhomeOrgDebug1.cpp $(deviceCppCore)DvAvOpenhomeOrgPins1.cpp $(deviceCppCore)DvAvOpenhomeOrgPlaylistManager1.cpp $(deviceCppCore)DvAvOpenhomeOrgMediaServer1.cpp $(deviceCppCore)DvAvOpenhomeOrgNetworkMonitor1.cpp $(deviceCppCore)DvOpenhomeOrgTestBasic1.cpp $(deviceCppCore)DvOpenhomeOrgTestLights1.cpp $(deviceCppCore)DvOpenhomeOrgSubscriptionLongPoll1.cpp $(deviceCppCore)DvLinnCoUkFlash1.cpp $(deviceCppCore)DvLinnCoUkVolkano1.cpp $(deviceCppCore)DvLinnCoUkPrivacy1.cpp $(deviceCppCore)DvLinnCoUkExaktInputs1.cpp $(deviceCppCore)DvLinnCoUkCloud1.cpp $(deviceCppCore)DvLinnCoUkUpdate1.cpp $(deviceCppCore)DvLinnCoUkConfiguration1.cpp $(deviceCppCore)DvLinnCoUkLipSync1.cpp $(deviceCppCore)DvLinnCoUkExakt1.cpp
...
$(deviceCppCore)DvLinnCoUkExakt1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/Linn/Exakt1.xml
	echo DvLinnCoUkExakt1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/Linn/Exakt1.xml" --output=$(deviceCppCore) --domain=linn.co.uk --type=Exakt --version=1

DvCppStd :   $(deviceCppStd)DvUpnpOrgAVTransport1Std.cpp $(deviceCppStd)DvUpnpOrgAVTransport2Std.cpp $(deviceCppStd)DvUpnpOrgConnectionManager1Std.cpp $(deviceCppStd)DvUpnpOrgConnectionManager2Std.cpp $(deviceCppStd)DvUpnpOrgContentDirectory1Std.cpp $(deviceCppStd)DvUpnpOrgContentDirectory2Std.cpp $(deviceCppStd)DvUpnpOrgContentDirectory3Std.cpp $(deviceCppStd)DvUpnpOrgRenderingControl1Std.cpp $(deviceCppStd)DvUpnpOrgRenderingControl2Std.cpp $(deviceCppStd)DvUpnpOrgScheduledRecording1Std.cpp $(deviceCppStd)DvUpnpOrgScheduledRecording2Std.cpp $(deviceCppStd)DvUpnpOrgSwitchPower1Std.cpp $(deviceCppStd)DvUpnpOrgDimming1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgCredentials1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgExakt1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgExakt2Std.cpp $(deviceCppStd)DvAvOpenhomeOrgExakt3Std.cpp $(deviceCppStd)DvAvOpenhomeOrgInfo1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgTime1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgPlaylist1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgVolume1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgVolume2Std.cpp $(deviceCppStd)DvAvOpenhomeOrgVolume3Std.cpp $(deviceCppStd)DvAvOpenhomeOrgProduct1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgProduct2Std.cpp $(deviceCppStd)DvAvOpenhomeOrgTransport1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgRadio1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgReceiver1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgSender1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgSender2Std.cpp $(deviceCppStd)DvAvOpenhomeOrgDebug1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgPins1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgPlaylistManager1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgMediaServer1Std.cpp $(deviceCppStd)DvAvOpenhomeOrgNetworkMonitor1Std.cpp $(deviceCppStd)DvOpenhomeOrgTestBasic1Std.cpp $(deviceCppStd)DvOpenhomeOrgTestLights1Std.cpp $(deviceCppStd)DvOpenhomeOrgSubscriptionLongPoll1Std.cpp $(deviceCppStd)DvLinnCoUkFlash1Std.cpp $(deviceCppStd)DvLinnCoUkVolkano1Std.cpp $(deviceCppStd)DvLinnCoUkPrivacy1Std.cpp $(deviceCppStd)DvLinnCoUkExaktInputs1Std.cpp $(deviceCppStd)DvLinnCoUkCloud1Std.cpp $(deviceCppStd)DvLinnCoUkUpdate1Std.cpp $(deviceCppStd)DvLinnCoUkConfiguration1Std.cpp $(deviceCppStd)DvLinnCoUkLipSync1Std.cpp $(deviceCppStd)DvLinnCoUkExakt1Std.cpp
...
$(deviceCppStd)DvLinnCoUkExakt1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/Linn/Exakt1.xml
	echo DvLinnCoUkExakt1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/Linn/Exakt1.xml" --output=$(deviceCppStd) --domain=linn.co.uk --type=Exakt --version=1

DvC :   $(deviceC)DvUpnpOrgAVTransport1C.cpp $(deviceC)DvUpnpOrgAVTransport2C.cpp $(deviceC)DvUpnpOrgConnectionManager1C.cpp $(deviceC)DvUpnpOrgConnectionManager2C.cpp $(deviceC)DvUpnpOrgContentDirectory1C.cpp $(deviceC)DvUpnpOrgContentDirectory2C.cpp $(deviceC)DvUpnpOrgContentDirectory3C.cpp $(deviceC)DvUpnpOrgRenderingControl1C.cpp $(deviceC)DvUpnpOrgRenderingControl2C.cpp $(deviceC)DvUpnpOrgScheduledRecording1C.cpp $(deviceC)DvUpnpOrgScheduledRecording2C.cpp $(deviceC)DvUpnpOrgSwitchPower1C.cpp $(deviceC)DvUpnpOrgDimming1C.cpp $(deviceC)DvAvOpenhomeOrgCredentials1C.cpp $(deviceC)DvAvOpenhomeOrgExakt1C.cpp $(deviceC)DvAvOpenhomeOrgExakt2C.cpp $(deviceC)DvAvOpenhomeOrgExakt3C.cpp $(deviceC)DvAvOpenhomeOrgInfo1C.cpp $(deviceC)DvAvOpenhomeOrgTime1C.cpp $(deviceC)DvAvOpenhomeOrgPlaylist1C.cpp $(deviceC)DvAvOpenhomeOrgVolume1C.cpp $(deviceC)DvAvOpenhomeOrgVolume2C.cpp $(deviceC)DvAvOpenhomeOrgVolume3C.cpp $(deviceC)DvAvOpenhomeOrgProduct1C.cpp $(deviceC)DvAvOpenhomeOrgProduct2C.cpp $(deviceC)DvAvOpenhomeOrgTransport1C.cpp $(deviceC)DvAvOpenhomeOrgRadio1C.cpp $(deviceC)DvAvOpenhomeOrgReceiver1C.cpp $(deviceC)DvAvOpenhomeOrgSender1C.cpp $(deviceC)DvAvOpenhomeOrgSender2C.cpp $(deviceC)DvAvOpenhomeOrgDebug1C.cpp $(deviceC)DvAvOpenhomeOrgPins1C.cpp $(deviceC)DvAvOpenhomeOrgPlaylistManager1C.cpp $(deviceC)DvAvOpenhomeOrgMediaServer1C.cpp $(deviceC)DvAvOpenhomeOrgNetworkMonitor1C.cpp $(deviceC)DvOpenhomeOrgTestBasic1C.cpp $(deviceC)DvOpenhomeOrgTestLights1C.cpp $(deviceC)DvOpenhomeOrgSubscriptionLongPoll1C.cpp $(deviceC)DvLinnCoUkFlash1C.cpp $(deviceC)DvLinnCoUkVolkano1C.cpp $(deviceC)DvLinnCoUkPrivacy1C.cpp $(deviceC)DvLinnCoUkExaktInputs1C.cpp $(deviceC)DvLinnCoUkCloud1C.cpp $(deviceC)DvLinnCoUkUpdate1C.cpp $(deviceC)DvLinnCoUkConfiguration1C.cpp $(deviceC)DvLinnCoUkLipSync1C.cpp $(deviceC)DvLinnCoUkExakt1C.cpp
...
$(deviceC)DvLinnCoUkExakt1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/Linn/Exakt1.xml
	echo DvLinnCoUkExakt1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/Linn/Exakt1.xml" --output=$(deviceC) --domain=linn.co.uk --type=Exakt --version=1

DvCs:   $(deviceCs)DvUpnpOrgAVTransport1.cs $(deviceCs)DvUpnpOrgAVTransport2.cs $(deviceCs)DvUpnpOrgConnectionManager1.cs $(deviceCs)DvUpnpOrgConnectionManager2.cs $(deviceCs)DvUpnpOrgContentDirectory1.cs $(deviceCs)DvUpnpOrgContentDirectory2.cs $(deviceCs)DvUpnpOrgContentDirectory3.cs $(deviceCs)DvUpnpOrgRenderingControl1.cs $(deviceCs)DvUpnpOrgRenderingControl2.cs $(deviceCs)DvUpnpOrgScheduledRecording1.cs $(deviceCs)DvUpnpOrgScheduledRecording2.cs $(deviceCs)DvUpnpOrgSwitchPower1.cs $(deviceCs)DvUpnpOrgDimming1.cs $(deviceCs)DvAvOpenhomeOrgCredentials1.cs $(deviceCs)DvAvOpenhomeOrgExakt1.cs $(deviceCs)DvAvOpenhomeOrgExakt2.cs $(deviceCs)DvAvOpenhomeOrgExakt3.cs $(deviceCs)DvAvOpenhomeOrgInfo1.cs $(deviceCs)DvAvOpenhomeOrgTime1.cs $(deviceCs)DvAvOpenhomeOrgPlaylist1.cs $(deviceCs)DvAvOpenhomeOrgVolume1.cs $(deviceCs)DvAvOpenhomeOrgVolume2.cs $(deviceCs)DvAvOpenhomeOrgVolume3.cs $(deviceCs)DvAvOpenhomeOrgProduct1.cs $(deviceCs)DvAvOpenhomeOrgProduct2.cs $(deviceCs)DvAvOpenhomeOrgTransport1.cs $(deviceCs)DvAvOpenhomeOrgRadio1.cs $(deviceCs)DvAvOpenhomeOrgReceiver1.cs $(deviceCs)DvAvOpenhomeOrgSender1.cs $(deviceCs)DvAvOpenhomeOrgSender2.cs $(deviceCs)DvAvOpenhomeOrgDebug1.cs $(deviceCs)DvAvOpenhomeOrgPins1.cs $(deviceCs)DvAvOpenhomeOrgPlaylistManager1.cs $(deviceCs)DvAvOpenhomeOrgMediaServer1.cs $(deviceCs)DvAvOpenhomeOrgNetworkMonitor1.cs $(deviceCs)DvOpenhomeOrgTestBasic1.cs $(deviceCs)DvOpenhomeOrgTestLights1.cs $(deviceCs)DvOpenhomeOrgSubscriptionLongPoll1.cs $(deviceCs)DvLinnCoUkFlash1.cs $(deviceCs)DvLinnCoUkVolkano1.cs $(deviceCs)DvLinnCoUkPrivacy1.cs $(deviceCs)DvLinnCoUkExaktInputs1.cs $(deviceCs)DvLinnCoUkCloud1.cs $(deviceCs)DvLinnCoUkUpdate1.cs $(deviceCs)DvLinnCoUkConfiguration1.cs $(deviceCs)DvLinnCoUkLipSync1.cs $(deviceCs)DvLinnCoUkExakt1.cs
...
$(deviceCs)DvLinnCoUkExakt1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/Linn/Exakt1.xml
	echo DvLinnCoUkExakt1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/Linn/Exakt1.xml" --output=$(deviceCs) --domain=linn.co.uk --type=Exakt --version=1

DvJava:   $(deviceJava)DvProviderUpnpOrgAVTransport1.java $(deviceJava)DvProviderUpnpOrgAVTransport2.java $(deviceJava)DvProviderUpnpOrgConnectionManager1.java $(deviceJava)DvProviderUpnpOrgConnectionManager2.java $(deviceJava)DvProviderUpnpOrgContentDirectory1.java $(deviceJava)DvProviderUpnpOrgContentDirectory2.java $(deviceJava)DvProviderUpnpOrgContentDirectory3.java $(deviceJava)DvProviderUpnpOrgRenderingControl1.java $(deviceJava)DvProviderUpnpOrgRenderingControl2.java $(deviceJava)DvProviderUpnpOrgScheduledRecording1.java $(deviceJava)DvProviderUpnpOrgScheduledRecording2.java $(deviceJava)DvProviderUpnpOrgSwitchPower1.java $(deviceJava)DvProviderUpnpOrgDimming1.java $(deviceJava)DvProviderAvOpenhomeOrgCredentials1.java $(deviceJava)DvProviderAvOpenhomeOrgExakt1.java $(deviceJava)DvProviderAvOpenhomeOrgExakt2.java $(deviceJava)DvProviderAvOpenhomeOrgExakt3.java $(deviceJava)DvProviderAvOpenhomeOrgInfo1.java $(deviceJava)DvProviderAvOpenhomeOrgTime1.java $(deviceJava)DvProviderAvOpenhomeOrgPlaylist1.java $(deviceJava)DvProviderAvOpenhomeOrgVolume1.java $(deviceJava)DvProviderAvOpenhomeOrgVolume2.java $(deviceJava)DvProviderAvOpenhomeOrgVolume3.java $(deviceJava)DvProviderAvOpenhomeOrgProduct1.java $(deviceJava)DvProviderAvOpenhomeOrgProduct2.java $(deviceJava)DvProviderAvOpenhomeOrgTransport1.java $(deviceJava)DvProviderAvOpenhomeOrgRadio1.java $(deviceJava)DvProviderAvOpenhomeOrgReceiver1.java $(deviceJava)DvProviderAvOpenhomeOrgSender1.java $(deviceJava)DvProviderAvOpenhomeOrgSender2.java $(deviceJava)DvProviderAvOpenhomeOrgDebug1.java $(deviceJava)DvProviderAvOpenhomeOrgPins1.java $(deviceJava)DvProviderAvOpenhomeOrgPlaylistManager1.java $(deviceJava)DvProviderAvOpenhomeOrgMediaServer1.java $(deviceJava)DvProviderAvOpenhomeOrgNetworkMonitor1.java $(deviceJava)DvProviderOpenhomeOrgTestBasic1.java $(deviceJava)DvProviderOpenhomeOrgTestLights1.java $(deviceJava)DvProviderOpenhomeOrgSubscriptionLongPoll1.java $(deviceJava)DvProviderLinnCoUkFlash1.java $(deviceJava)DvProviderLinnCoUkVolkano1.java $(deviceJava)DvProviderLinnCoUkPrivacy1.java $(deviceJava)DvProviderLinnCoUkExaktInputs1.java $(deviceJava)DvProviderLinnCoUkCloud1.java $(deviceJava)DvProviderLinnCoUkUpdate1.java $(deviceJava)DvProviderLinnCoUkConfiguration1.java $(deviceJava)DvProviderLinnCoUkLipSync1.java $(deviceJava)DvProviderLinnCoUkExakt1.java
...
$(deviceJava)DvProviderLinnCoUkExakt1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/Linn/Exakt1.xml
	echo DvProviderLinnCoUkExakt1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/Linn/Exakt1.xml" --output=$(deviceJava) --domain=linn.co.uk --type=Exakt --version=1
