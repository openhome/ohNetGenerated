...
$(proxyCppCore)CpOpenhomeOrgOAuth1.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppBufferSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml
	echo CpOpenhomeOrgOAuth1.cpp
	$(ohNetGen) --language=cppcore --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml" --output=$(proxyCppCore) --domain=openhome.org --type=OAuth --version=1
...
$(proxyCppStd)CpOpenhomeOrgOAuth1Std.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCppStringSource.tt OpenHome/Net/T4/Templates/CpUpnpCppHeader.tt OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml
	echo CpOpenhomeOrgOAuth1Std.cpp
	$(ohNetGen) --language=cpp --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml" --output=$(proxyCppStd) --domain=openhome.org --type=OAuth --version=1
...
$(proxyC)CpOpenhomeOrgOAuth1C.cpp : $(tt) OpenHome/Net/T4/Templates/CpUpnpCSource.tt OpenHome/Net/T4/Templates/CpUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml
	echo CpOpenhomeOrgOAuth1C.cpp
	$(ohNetGen) --language=c --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml" --output=$(proxyC) --domain=openhome.org --type=OAuth --version=1
...
$(proxyCs)CpOpenhomeOrgOAuth1.cs : $(tt) OpenHome/Net/T4/Templates/CpUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml
	echo CpOpenhomeOrgOAuth1.cs
	$(ohNetGen) --language=cs --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml" --output=$(proxyCs) --domain=openhome.org --type=OAuth --version=1
...
$(proxyJava)CpProxyOpenhomeOrgOAuth1.java : $(tt) OpenHome/Net/T4/Templates/CpUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml
	echo CpProxyOpenhomeOrgOAuth1.java
	$(ohNetGen) --language=java --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml" --output=$(proxyJava) --domain=openhome.org --type=OAuth --version=1
...
$(proxyJs)CpOpenhomeOrgOAuth1.js : $(tt) OpenHome/Net/T4/Templates/CpUpnpJs.tt OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml
	echo CpOpenhomeOrgOAuth1.js
	$(ohNetGen) --language=js --stack=cp "--xml=OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml" --output=$(proxyJs) --domain=openhome.org --type=OAuth --version=1
...
$(deviceCppCore)DvOpenhomeOrgOAuth1.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppCoreSource.tt OpenHome/Net/T4/Templates/DvUpnpCppCoreHeader.tt OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml
	echo DvOpenhomeOrgOAuth1.cpp
	$(ohNetGen) --language=cppcore --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml" --output=$(deviceCppCore) --domain=openhome.org --type=OAuth --version=1
...
$(deviceCppStd)DvOpenhomeOrgOAuth1Std.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCppStdSource.tt OpenHome/Net/T4/Templates/DvUpnpCppStdHeader.tt OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml
	echo DvOpenhomeOrgOAuth1Std.cpp
	$(ohNetGen) --language=cpp --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml" --output=$(deviceCppStd) --domain=openhome.org --type=OAuth --version=1
...
$(deviceC)DvOpenhomeOrgOAuth1C.cpp : $(tt) OpenHome/Net/T4/Templates/DvUpnpCSource.tt OpenHome/Net/T4/Templates/DvUpnpCHeader.tt OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml
	echo DvOpenhomeOrgOAuth1C.cpp
	$(ohNetGen) --language=c --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml" --output=$(deviceC) --domain=openhome.org --type=OAuth --version=1
...
DvCs:   $(deviceCs)DvUpnpOrgAVTransport1.cs $(deviceCs)DvUpnpOrgAVTransport2.cs $(deviceCs)DvUpnpOrgConnectionManager1.cs $(deviceCs)DvUpnpOrgConnectionManager2.cs $(deviceCs)DvUpnpOrgContentDirectory1.cs $(deviceCs)DvUpnpOrgContentDirectory2.cs $(deviceCs)DvUpnpOrgContentDirectory3.cs $(deviceCs)DvUpnpOrgRenderingControl1.cs $(deviceCs)DvUpnpOrgRenderingControl2.cs $(deviceCs)DvUpnpOrgScheduledRecording1.cs $(deviceCs)DvUpnpOrgScheduledRecording2.cs $(deviceCs)DvUpnpOrgSwitchPower1.cs $(deviceCs)DvUpnpOrgDimming1.cs $(deviceCs)DvAvOpenhomeOrgConfigApp1.cs $(deviceCs)DvAvOpenhomeOrgCredentials1.cs $(deviceCs)DvAvOpenhomeOrgExakt1.cs $(deviceCs)DvAvOpenhomeOrgExakt2.cs $(deviceCs)DvAvOpenhomeOrgExakt3.cs $(deviceCs)DvAvOpenhomeOrgExakt4.cs $(deviceCs)DvAvOpenhomeOrgInfo1.cs $(deviceCs)DvAvOpenhomeOrgTime1.cs $(deviceCs)DvAvOpenhomeOrgPlaylist1.cs $(deviceCs)DvAvOpenhomeOrgVolume1.cs $(deviceCs)DvAvOpenhomeOrgVolume2.cs $(deviceCs)DvAvOpenhomeOrgVolume3.cs $(deviceCs)DvAvOpenhomeOrgVolume4.cs $(deviceCs)DvAvOpenhomeOrgProduct1.cs $(deviceCs)DvAvOpenhomeOrgProduct2.cs $(deviceCs)DvAvOpenhomeOrgProduct3.cs $(deviceCs)DvAvOpenhomeOrgTransport1.cs $(deviceCs)DvAvOpenhomeOrgRadio1.cs $(deviceCs)DvAvOpenhomeOrgReceiver1.cs $(deviceCs)DvAvOpenhomeOrgSender1.cs $(deviceCs)DvAvOpenhomeOrgSender2.cs $(deviceCs)DvAvOpenhomeOrgDebug1.cs $(deviceCs)DvAvOpenhomeOrgDebug2.cs $(deviceCs)DvAvOpenhomeOrgPins1.cs $(deviceCs)DvAvOpenhomeOrgPlaylistManager1.cs $(deviceCs)DvAvOpenhomeOrgMediaServer1.cs $(deviceCs)DvAvOpenhomeOrgNetworkMonitor1.cs $(deviceCs)DvOpenhomeOrgTestBasic1.cs $(deviceCs)DvOpenhomeOrgTestLights1.cs $(deviceCs)DvOpenhomeOrgSubscriptionLongPoll1.cs $(deviceCs)DvOpenhomeOrgOAuth1.cs $(deviceCs)DvLinnCoUkFlash1.cs $(deviceCs)DvLinnCoUkVolkano1.cs $(deviceCs)DvLinnCoUkPrivacy1.cs $(deviceCs)DvLinnCoUkExaktInputs1.cs $(deviceCs)DvLinnCoUkCloud1.cs $(deviceCs)DvLinnCoUkUpdate1.cs $(deviceCs)DvLinnCoUkUpdate2.cs $(deviceCs)DvLinnCoUkUpdate3.cs $(deviceCs)DvLinnCoUkConfiguration1.cs $(deviceCs)DvLinnCoUkLipSync1.cs $(deviceCs)DvLinnCoUkExakt21.cs $(deviceCs)DvLinnCoUkExakt22.cs $(deviceCs)DvLinnCoUkWifi1.cs $(deviceCs)DvLinnCoUkZoneReceiver1.cs $(deviceCs)DvLinnCoUkZones1.cs
...
$(deviceCs)DvOpenhomeOrgOAuth1.cs : $(tt) OpenHome/Net/T4/Templates/DvUpnpCs.tt OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml
	echo DvOpenhomeOrgOAuth1.cs
	$(ohNetGen) --language=cs --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml" --output=$(deviceCs) --domain=openhome.org --type=OAuth --version=1
...
$(deviceJava)DvProviderOpenhomeOrgOAuth1.java : $(tt) OpenHome/Net/T4/Templates/DvUpnpJava.tt OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml
	echo DvProviderOpenhomeOrgOAuth1.java
	$(ohNetGen) --language=java --stack=dv "--xml=OpenHome/Net/Service/Upnp/OpenHome/OAuth1.xml" --output=$(deviceJava) --domain=openhome.org --type=OAuth --version=1
