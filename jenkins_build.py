...
class JenkinsBuild():
    def get_options(self):
        ...
        parser.add_option("-p", "--platform", dest="platform",
            help="Linux-x86, Linux-x64, Windows-x86, Windows-x64, Windows10-x86, Linux-ARM, Linux-armhf, Linux-rpi, Linux-ppc32, Mac-x64, Core-ppc32, Core-armv5, Core-armv6, iOs-arm64, iOs-x64, Qnap-x86")
    ...
    def set_platform_args(self):
        ...
        if os_platform == 'linux' and arch == 'armhf':
            os.environ['CROSS_COMPILE'] = '/opt/gcc-linaro-7.3.1-2018.05-x86_64_arm-linux-gnueabihf/bin/arm-linux-gnueabihf-'
